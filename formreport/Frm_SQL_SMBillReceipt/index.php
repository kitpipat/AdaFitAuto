...
<head>
	...
	<title>Frm_SQL_SMBillReceipt.mrt - Viewer</title>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_SQL_SMBillReceipt.mrt?=v04.00.00");
			...
			// report.dictionary.variables.getByName("SP_tDocNo").valueObject = "SP220000700001000002";
			...
			// report.dictionary.variables.getByName("SP_tGrdStr").valueObject = "หนึ่งพีนบาทถ้วน";

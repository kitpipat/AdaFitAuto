...
<head>
	<?php
		if(isset($_GET["infor"])){
			$aParamiterMap = array(
				"Lang","ComCode","BranchCode","DocCode","DocBchCode","tGrdStr"
			);
		...
		if($aDataMQ){
	?>
	<title>Frm_PSWhTaxBill.mrt - Viewer</title>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_PSWhTaxBill.mrt");
			...
			report.dictionary.variables.getByName("SP_tGrdStr").valueObject 	= "<?=$aDataMQ["tGrdStr"];?>";

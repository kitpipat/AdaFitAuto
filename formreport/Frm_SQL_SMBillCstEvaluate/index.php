...
<head>
	<?php
		if(isset($_GET["infor"])){
			$aParamiterMap	= array(
				"Lang","ComCode","BranchCode","DocCode","DocBchCode","DocDate","DocTime"
			);
	...
	<title>Frm_SQL_SMBillCstEvaluate.mrt - Viewer</title>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_SQL_SMBillCstEvaluate.mrt");
			...
			report.dictionary.variables.getByName("SP_tDocDate").valueObject 	= "<?=$aDataMQ["DocDate"];?>";
			report.dictionary.variables.getByName("SP_tDocTime").valueObject 	= "<?=$aDataMQ["DocTime"];?>";

...
<head>
	...
	<?php
		...
		if($aDataMQ){
	?>
	<title>Frm_SQL_FCBnkDeposit_Fit.mrt - Viewer</title>
	...
	<script type="text/javascript" src="<?=BASE_URL?>/formreport/AdaCoreFrmReport/scripts_year_2022/stimulsoft.reports.js"></script>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_SQL_FCBnkDeposit_Fit.mrt");

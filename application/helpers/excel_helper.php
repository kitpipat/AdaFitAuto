            ...
            foreach($aResult as $nKey => $aValue){
                switch ($paParam['tName']){
                    ...
                    case 'StandCard';
                        ...
                        //ประเภท		
                        if(!empty($aValue[$aCoulmn[9]])){
                            if($aValue[$aCoulmn[9]] == 1){
                                $aValue[$aCoulmn[9]] = language('sale/salemonitor/salemonitor', 'tBCMBatTabStdType1'); 
                            }else if($aValue[$aCoulmn[9]] == 4){
                                $aValue[$aCoulmn[9]] = language('sale/salemonitor/salemonitor', 'tBCMBatTabStdType4'); 
                            }else{
                                $aValue[$aCoulmn[9]] = language('sale/salemonitor/salemonitor', 'tBCMBatTabStdType2'); 
                            }
                        }else{
                            $aValue[$aCoulmn[9]] = '-'; 
                        }
                        ...
                        if(!empty($aValue[$aCoulmn[10]])){
                            if($aValue[$aCoulmn[10]] == 1){
                                $aValue[$aCoulmn[10]] = language('sale/salemonitor/salemonitor', 'tBCMBatTabStdMode1'); 
                            }else{
                                $aValue[$aCoulmn[10]] = language('sale/salemonitor/salemonitor', 'tBCMBatTabStdMode2'); 
                            }
                        }else{
                            $aValue[$aCoulmn[10]] = '-'; 
                        }
                        ...
                        //สถานะส่งยอด		
                        if(!empty($aValue[$aCoulmn[11]])){
                            if($aValue[$aCoulmn[11]] == 1){
                                $aValue[$aCoulmn[11]] = language('sale/salemonitor/salemonitor', 'tBCMBatTabStdUpd1'); 
                            }else{
                                $aValue[$aCoulmn[11]] = language('sale/salemonitor/salemonitor', 'tBCMBatTabStdUpd2'); 
                            }
                        }else{
                            $aValue[$aCoulmn[11]] = '-'; 
                        }
                        ...
                        //หมายเหตุ		
                        if(!empty($aValue[$aCoulmn[12]])){
                            $aValue[$aCoulmn[12]] = $aValue[$aCoulmn[12]]; 
                        }else{
                            $aValue[$aCoulmn[12]] = '-'; 
                        }
                    break;
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(@$aValue[@$aCoulmn[12]])
                ];

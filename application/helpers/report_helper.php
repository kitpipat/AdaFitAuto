        ...
        if($pnRowPartID == 1){
            ...
            for($i = 0;$i<FCNnHSizeOf($paGrouppingData);$i++){
                if($paGrouppingData[$i] !== 'N'){
                    echo "<td class='xCNRptDetail' nowrap style='padding: 5px;'>".$paGrouppingData[$i]."</td>";
                }else{
                    echo "<td></td>";
                }
            }
...
function FCNoHDOCClearRptTmp()
{
    ...
    $aTableReportTmpCreateOn = [
        "TRPTSalInstallmentTmp"
    ];
    ...
    foreach ($aTableReportTmpCreateOn as $tItem) {

...
<div class="row">
		<div class="col-lg-4 col-md-6 col-xs-12 col-sm-8">
			<div class="form-group">
				<label class="xCNLabelFrm"><?php echo language('service/message/message','tMSGTBCSearch')?></label>
				<div class="input-group">
					<input type="text" class="form-control xCNInputWithoutSingleQuote" id="oetSearchAll" onkeypress="Javascript:if(event.keyCode==13) JSvMessageDataTable()" autocomplete="off" name="oetSearchAll" placeholder="<?php echo language('common/main/main','tPlaceholder')?>">
					<span class="input-group-btn">
						<button id="oimSearchCard" class="btn xCNBtnSearch" type="button">
							<img onclick="JSvMessageDataTable()" class="xCNIconBrowse" src="<?= base_url().'/application/modules/common/assets/images/icons/search-24.png'?>">
						</button>
					</span>
				</div>
			</div>
			...
			<div id="odvMngTableList" class="btn-group xCNDropDrownGroup">
				...
				<ul class="dropdown-menu" role="menu">
					<li id="oliBtnDeleteAll" class="disabled">
						<a data-toggle="modal" data-target="#odvModalDelMessage"><?= language('common/main/main','tDelAll')?></a>
					</li>
				</ul>
				</div>
			</div>
...
<div class="panel-body">
	<section id="ostDataMessage"></section>
</div>

<div class="modal fade" id="odvModalDelMessageChoose">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button id="osmConfirm" type="button" class="btn xCNBTNPrimery" onClick="JSnMessageDelChoose()">

...
if (isset($nStaAddOrEdit) && $nStaAddOrEdit == 1) {
    ...
    $dCreateOn  = $aSgpData['raItems']['rDCreateOn'];
} else {
...
<form class="contact100-form validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddGroupSupplier">
    ...
    <input type="hidden" id="ohdSgpCreateOn" name="ohdSgpCreateOn" value="<?=$dCreateOn?>">
    <div>
        <!-- เพิ่มมาใหม่ -->
            ...
            <div class="row">
                <div class="col-xs-12 col-md-5 col-lg-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control " maxlength="50" id="oetSgpCode" name="oetSgpCode" value="<?= $tSgpCode ?>"> <!-- เปลี่ยนชื่อ Class เพิ่ม DataValidate -->

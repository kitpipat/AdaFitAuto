                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input 
                                                        ...
                                                        id="oemtSplEmail"
                                                        name="oemtSplEmail" 
                                                        placeholder="<?php echo language('supplier/supplier/supplier','tEmail')?>" 
                                                        value="<?php echo $tSplEmail;?>"
                                                        data-validate-email="<?php echo language('supplier/supplier/supplier','tValidEmail')?>"
                                                    >
                                                </div>
                                            </div>
                                        </div>

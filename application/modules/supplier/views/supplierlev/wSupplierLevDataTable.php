                            ...
                            <tr class="text-center xCNTextDetail2 otrSupplierLevel" id="otrSupplierLevel<?=$nKey?>" data-code="<?=$aValue['rtSlvCode']?>" data-name="<?=$aValue['rtSlvName']?>">
                                ...
                                <td class="text-center">
                                  <label class="fancy-checkbox">
                                    ...
                                    data-checkrowid="<?php echo $aValue['rtSlvCode'].$aValue['rtAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                                ...
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtSlvCode'].$aValue['rtAgnCode']?>">
                                    <img id="oimDel<?php echo $aValue['rtSlvCode'].$aValue['rtAgnCode']; ?>" class="xCNIconTable <?php echo $tDisableImg; ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"   onClick="JSoSupplierLevelDel('<?=$nCurrentPage?>','<?=$aValue['rtSlvName']?>','<?=$aValue['rtSlvCode']?>')" title="<?php echo language('pos/slipMessage/slipmessage', 'tSMGTBDelete'); ?>">
                                </td>
                                <?php endif; ?>
                                <?php if($aAlwEventSupplierLevel['tAutStaFull'] == 1 || ($aAlwEventSupplierLevel['tAutStaEdit'] == 1 || $aAlwEventSupplierLevel['tAutStaRead'] == 1)) : ?>

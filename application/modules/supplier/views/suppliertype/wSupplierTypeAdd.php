<?php
    if(isset($nStaAddOrEdit) && $nStaAddOrEdit == 1){
        ...
        $dCreateOn  = $aStyData['raItems']['rDStyCreateOn'];
    }else{
...
<form class="contact100-form validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddSty">
    ...
    <input type="hidden" id="ohdStyCreateOn" name=" " value="<?=$dCreateOn?>">
    <div><!-- เพิ่มมาใหม่ --> 
            ...
            <div class="row">
                <div class="col-xs-12 col-md-5 col-lg-5"> <!-- เปลี่ยน Col Class -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control " maxlength="50" id="oetStyCode" name="oetStyCode" value="<?= $tStyCode ?>">
                        <input type="text"
                        class="form-control"

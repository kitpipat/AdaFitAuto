            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <button type="button" class="btn xCNBtnBrowseAddOn" onclick="JSxInsertPDT();" style="margin: 10px auto; display: block; width: 50%; background-color:#1866ae !important; color: #FFF !important; font-size: 17px;">
...
<script>
    ...
    function JSxInsertRow(tRow) {
        ...
        //alert('INSERT =>  ใช้ช่องไปแล้วทั้งหมด : ' + tCNRowWidth + ' อนุญาตใช้ทั้งหมด : ' + tColHD);
    ...
    function JSxChangePDT(tRow, tStartWidth) {
        ...
        //alert('EDIT => ถูกใช้งานไปแล้ว : ' + tCNRowWidth + ' อนุญาตใช้ทั้งหมด : ' + tColHD + ' ตัวมันเองใช้อยู่ : ' + tUseRow);

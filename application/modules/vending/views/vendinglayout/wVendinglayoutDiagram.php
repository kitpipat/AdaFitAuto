            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <button type="button" class="btn xCNBtnBrowseAddOn" onclick="JSxSelectPDTintoDiagram('','','EDIT')" style="margin: 10px auto; display: block; width: 50%; background-color:#1866ae !important; color: #FFF !important; font-size: 17px;">
...
<script>
    ...
    function JSxSelectPDTintoDiagram(pnFloor, pnColumn, ptType) {
        ...
        if (ptType == 'EDIT') {
            ...
            //อนุญาตให้เลือกสินค้าได้อีกครัง
            ...
            if (oElm == 'true') {
                ...
                //ไม่อนุญาตให้เลือกสินค้า แค่โชว์รายละเอียด

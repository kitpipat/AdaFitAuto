            ...
            <table class="table table-striped" style="width:100%">
                ...
                <td class="text-center">
                  <label class="fancy-checkbox">
                    ...
                    data-checkrowid="<?php echo $aValue['rtBbkCode'].$aValue['rtAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                ...
                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtBbkCode'].$aValue['rtAgnCode']?>">
                    <img id="oimDel<?php echo $aValue['rtBbkCode'].$aValue['rtAgnCode']; ?>"
                    class="xCNIconTable <?php echo $tDisableImg; ?>"
                     src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                     onClick="JSnBookBankDel(<?php echo $nCurrentPage; ?>,'<?=$aValue['rtBbkName']?>','<?php echo $aValue['rtBbkCode']?>','<?php echo $aValue['rtBchName']?>','<?php echo $aValue['rtBchCode']?>')"

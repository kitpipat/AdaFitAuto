			...
			<div class="row xCNavRow" style="width:inherit;">
				...
				<div class="demo-button xCNBtngroup" style="width:100%;">
					<div id="odvBtnPadAddEdit">
							...
							<button type="submit" class="btn xCNBTNSubSave" id="obtGpShopBySHPSave" onclick="JSxPADAddEditPermissionApproveDoc()"> <?php echo  language('common/main/main', 'tSave')?></button>
					</div>
				</div>
			</div>
				</div>

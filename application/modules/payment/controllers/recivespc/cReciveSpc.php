...
class cReciveSpc extends MX_Controller
{
    ...
    public function FSvCReciveSpcPageEdit()
    {
        ...
        $aData              = [
            ...
            'FTObjCode'     => $aDataWhereEdit['ptObjCode'],
    ...
    public function FSaCReciveSpcAddEvent()
    {
        $aDataMaster    = array(
            ...
            'FTObjCode'         => $this->input->post('oetRcvSpcObjCode'),
    ...
    public function  FSaCReciveSpcEditEvent()
    {
        $aDataMaster    = array(
            ...
            'FTObjCodeold'         => $this->input->post('ohdRcvSpcObjCode'),
        ...
        if (
            ...
            $aDataMaster['FTObjCodeold'] == $aDataMaster['FTObjCode'] &&
    ...
    public function FSaCReciveSpcDeleteEvent()
    {
        ...
        $aDataMaster    = [
            ...
            'FTObjCode' => $aDataWhereDel['ptObjCode'],
        ...
        $this->mReciveSpc->FSnMRCVSpcDel($aDataMaster);
        if ($this->db->trans_status() == FALSE) {
            $this->db->trans_rollback();
            $aDataReturn    = array(
                'nStaEvent' => 500,
    ...
    public function FSoCReciveSpcDelMultipleEvent()
    {
        try {
            ...
            $aDataDelete    = [
                ...
                'FTObjCode' => $aDataWhereDel['paObjCode'],
            ...
            $this->mReciveSpc->FSaMRCVSPCDeleteMultiple($aDataDelete,$tRevCodeWhere);
            if ($this->db->trans_status() == FALSE) {
                $this->db->trans_rollback();
                $aDataReturn    = array(
                    'nStaEvent' => 500,

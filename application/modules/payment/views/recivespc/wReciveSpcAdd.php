...
if ($aResult['rtCode'] == 1) {
    $tRcvSpcObjCodeOld         = $aResult['raItems']['FTObjCode'];
    ...
    $tRcvSpcObjCode         = $aResult['raItems']['FTObjCode'];
    $tRcvSpcObjName         = $aResult['raItems']['FTObjName'];
...
<form class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddEditRcvSpc">
    ...
    <input type="hidden" id="ohdRcvSpcObjCode" name="ohdRcvSpcObjCode" value="<?php echo @$tRcvSpcObjCode ?>">
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
            ...
            <button type="submit" class="btn xCNBTNSubSave" id="obtCrdloginSave" onclick="JSxRcvSpvSaveAddEdit('<?= $tRoute ?>')"> <?php echo  language('common/main/main', 'tSave') ?></button>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-6 col-sm-6 col-md-6 col-lg-6">
            <!-- หน้าจอ TCNSListObj -->
            <div class="form-group">
                <label class="xCNLabelFrm"><?php echo language('payment/recivespc/recivespc', 'tRCVSpcObj'); ?></label>
                <div class="input-group">
                    <input type="text" class="form-control xCNHide" id="oetRcvSpcObjCode" name="oetRcvSpcObjCode" value="<?php echo @$tRcvSpcObjCode; ?>">
                    <input type="text" class="form-control xWPointerEventNone" id="oetRcvSpcObjName" name="oetRcvSpcObjName" placeholder="<?php echo language('payment/recivespc/recivespc', 'tRCVSpcObj'); ?>" value="<?php echo @$tRcvSpcObjName; ?>" readonly>
                    <span class="input-group-btn">
                        <button id="obtRcvSpcBrowseObj" type="button" class="btn xCNBtnBrowseAddOn"><img class="xCNIconFind"></button>
                    </span>
                </div>
            </div>
        </div>

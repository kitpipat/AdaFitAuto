            ...
            <table class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th nowrap class="xCNTextBold" style="width:10%;text-align:center;"><?php echo language('payment/recivespc/recivespc', 'tRCVSpcObj') ?></th>
                    ...
                    <?php if ($aDataList['rtCode'] == 1) : ?>
                        <?php if (!empty($aDataList['raItems'])) { ?>
                            <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                                <tr class="text-center xCNTextDetail2 xWRcvSpcItems" 
                                    ...
                                    data-objcode="<?php echo $aValue['FTObjCode']; ?>" 
                                    ...
                                    if ($aValue['FTObjCode'] == '' || $aValue['FTObjCode'] == null) {
                                        $tShowObjName =  language('payment/recivespc/recivespc', 'tRcvSpcAllObj');
                                    } else {
                                        $tShowObjName = $aValue['FTObjName'];
                                    }
                                    ...
                                    <td nowrap class="text-left xWTdBody"><?= $tShowObjName; ?></td>
                ...
                if (nRowData==1) {
                  ...
                  if (typeof(nStaSession) !== 'undefined' && nStaSession == 1) {
                      let aDataWhere = {
                          ...
                          'ptObjCode': $(this).parents('.xWRcvSpcItems').data('objcode'),

                ...
                <?php if($aDataList['rtCode'] == 1 ):?>
                    <?php foreach($aDataList['raItems'] AS $key=>$aValue){ ?>
                        <tr class="text-center xCNTextDetail2 otrRecive" id="otrRecive<?=$key?>" data-code="<?=$aValue['rtRcvCode']?>" data-name="<?=$aValue['rtRcvName']?>">
                            <?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
                              ...
                              <td class="text-center">
                                <label class="fancy-checkbox">
                                  ...
                                  data-checkrowid="<?php echo $aValue['rtRcvCode'].$aValue['rtAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                            ...
                            <?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
                              <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtRcvCode'].$aValue['rtAgnCode']?>">
                                  <img id="oimDel<?php echo $aValue['rtRcvCode'].$aValue['rtAgnCode']; ?>"
                                  class="xCNIconTable <?php echo $tDisableImg; ?>"
                                   src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                                   onClick="JSnReciveDel('<?=$nCurrentPage?>','<?=$aValue['rtRcvName']?>','<?=$aValue['rtRcvCode']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')"

...
if ($aResult['rtCode'] == "1") {
    ...
    $tRcvStaReqSign                = @$aResult['raItems']['FTRcvStaReqSign'];
    $nRcvQtyCopy                   = @$aResult['raItems']['FNRcvQtyCopy'];
    $nRcvPayMin                    = @$aResult['raItems']['FCRcvPayMin'];
    $nRcvPayMax                    = @$aResult['raItems']['FCRcvPayMax'];
    //Event Control
} else {
    $tRcvCode                   = "";
    $tRcvName                   = "";
                        ...
                        <div class="panel-body" style="padding-top:20px !important;">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-8 col-lg-8">
                                    ...
                                    <?php
                                        $tTextHideRcvReadCard   = "";
                                        if(isset($tFmtCode) && !empty($tFmtCode)){
                                            if($tFmtCode == '024' || $tFmtCode == '013' || $tFmtCode == '018' || $tFmtCode == '028'){
                                                $tTextHideRcvReadCard   = "";
                                            }else{
                                                if(isset($tEdtCode) && !empty($tEdtCode)){
                                                    $tTextHideRcvReadCard   = "";
                                                }else{
                                                    $tTextHideRcvReadCard   = 'style="display: none;"';
                                                }
                                            }
                                        }else{
                                            $tTextHideRcvReadCard   = 'style="display: none;"';
                                    ...
                                    ?>
                                    <div id="odvRcvReadCard" class="form-group" <?=$tTextHideRcvReadCard;?>>
                                ...
                                <div class="form-group">
                                    <div class="validate-input">
                                        <label class="xCNLabelFrm"><?= language('payment/recive/recive', 'tRcvQtyCopy') ?></label>
                                        <input type="text" class="form-control" maxlength="50" id="oetRcvQtyCopy" name="oetRcvQtyCopy" placeholder="<?= language('payment/recive/recive', 'tRcvQtyCopy') ?>" autocomplete="off" value="<?php echo @$nRcvQtyCopy;?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="validate-input">
                                        <label class="xCNLabelFrm">ยอดรับชำระขั้นต่ำ</label>
                                        <input type="text" class="form-control xCNInputNumericWithDecimal" maxlength="18" id="oetRcvPayMin" name="oetRcvPayMin" placeholder="0" autocomplete="off" value="<?php echo @number_format($nRcvPayMin,2);?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="validate-input">
                                        <label class="xCNLabelFrm">ยอดรับชำระสูงสุด</label>
                                        <input type="text" class="form-control xCNInputNumericWithDecimal" maxlength="18" id="oetRcvPayMax" name="oetRcvPayMax" placeholder="0" autocomplete="off" value="<?php echo @number_format($nRcvPayMax,2);?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" id="ocbRcvStaPayType" name="ocbRcvStaPayType" maxlength="1">
                                        ...
                                        <option value="3"<?php if ($tRcvStaCshOrCrd == 3) {
                                                                echo "selected";
                                                            } ?>><?= language('payment/recive/recive', 'tRCVFC') ?></option>
                                        <option value="4"<?php if ($tRcvStaCshOrCrd == 4) {
                                                                echo "selected";
                                ...
                                <!-- สถานะพิมพ์ลายเซ็นลูกค้า -->
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 row">
                                    <div class="form-group">
                                        <label class="fancy-checkbox">
                                            <input type="checkbox" id="ocbRcvStaReqSign" name="ocbRcvStaReqSign" <?=(@$tRcvStaReqSign == '1' ? 'checked' : '')?> >
                                            <span> <?php echo language('payment/recive/recive', 'tRcvStaReqSign'); ?></span>
                                        </label>
                                    </div>
                                </div>

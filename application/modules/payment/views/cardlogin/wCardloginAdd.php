...
<form class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddEditCrdLogin">
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxCrdloginGetContent();" ><?php echo language('payment/cardlogin/cardlogin','tDetailLogin')?></label>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
            ...
            <?php if($aAlwEventCrdlogin['tAutStaFull'] == 1 || ($aAlwEventCrdlogin['tAutStaAdd'] == 1 || $aAlwEventCrdlogin['tAutStaEdit'] == 1)) : ?>
                <button type="submit" class="btn xCNBTNSubSave" id="obtCrdloginSave" onclick="JSxCrdSaveAddEdit('<?=$tRoute?>')"> <?php echo  language('common/main/main', 'tSave')?></button>
            <?php endif; ?>
        </div>

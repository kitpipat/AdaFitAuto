                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-5 col-lg-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-right" maxlength="18" placeholder="<?php echo language('payment/installmentterms/installmentterms', 'tSTMMinimumBalance') ?>" id="oetStmLimit" name="oetStmLimit" value="<?=number_format($cStmLimit,$nOptDecimalShow)?>" autocomplete="off" >
                            </div>

                            <div class="form-group">
                                <label class="xCNLabelFrm"><?php echo language('payment/installmentterms/installmentterms', 'tSTMNumInstallments') ?></label>
                                <input type="text" class="form-control text-right" maxlength="18" placeholder="<?php echo language('payment/installmentterms/installmentterms', 'tSTMNumInstallments') ?>" id="oetStmQty" name="oetStmQty" value="<?=number_format($nStmQty,$nOptDecimalShow)?>" autocomplete="off" >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-right" maxlength="18" placeholder="<?php echo language('payment/installmentterms/installmentterms', 'tSTMRate') ?>" id="oetStmRate" name="oetStmRate" value="<?=number_format($cStmRate,$nOptDecimalShow)?>" autocomplete="off" >
                            </div>

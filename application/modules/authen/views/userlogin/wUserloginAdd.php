...
<form class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddEditUserLogin">
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxUsrloginGetContent();" ><?php echo language('authen/user/user','tDetailLogin')?></label>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
            <button type="button" onclick="JSxUsrloginGetContent();" class="btn" style="background-color: #D4D4D4; color: #000000;">
                ...
                <button type="submit" class="btn xCNBTNSubSave" id="obtUsrloginSave" onclick="JSxUSRLSaveAddEdit('<?=$tRoute?>')"> <?php echo  language('common/main/main', 'tSave')?></button>
            </div>

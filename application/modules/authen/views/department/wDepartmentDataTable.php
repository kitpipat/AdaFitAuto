                    ...
                    <?php if($aDptDataList['rtCode'] == 1 ):?>
                        <?php foreach($aDptDataList['raItems'] AS $nKey => $aValue):?>
                            ...
                            <?php if($aAlwEventDepartment['tAutStaFull'] == 1 || ($aAlwEventDepartment['tAutStaAdd'] == 1 || $aAlwEventDepartment['tAutStaEdit'] == 1)) : ?>
                              ...
                              ?>
                                ...
                                <td class="text-center">
                                    ...
                                    data-checkrowid="<?php echo $aValue['rtDptCode'].$aValue['rtAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                            ...
                            <?php endif;?>
                                ...
                                <?php if($aAlwEventDepartment['tAutStaFull'] == 1 || ($aAlwEventDepartment['tAutStaAdd'] == 1 || $aAlwEventDepartment['tAutStaEdit'] == 1)) : ?>
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtDptCode'].$aValue['rtAgnCode']?>">
                                    <img id="oimDel<?php echo $aValue['rtDptCode'].$aValue['rtAgnCode']; ?>" class="xCNIconTable <?php echo $tDisableImg; ?>"
                                    src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                                     onClick="JSoDptDel('<?=$nCurrentPage?>','<?=$aValue['rtDptName']?>','<?php echo $aValue['rtDptCode']?>')"

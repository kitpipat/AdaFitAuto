...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TRPTReprintDocTmp]') AND type in (N'U'))
BEGIN
...
/****** Object:  Table [dbo].[TRPTPremRedemTmp]    Script Date: 16/11/2565 11:41:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TRPTPremRedemTmp]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[TRPTPremRedemTmp](
	[FTRptRowSeq] [bigint] IDENTITY(1,1) NOT NULL,
	...
	[FTCarRegNo] [varchar](100) NULL,
	[FTPdtCode] [varchar](20) NULL,
	[FTPdtName] [varchar](255) NULL,
	[FCXsdQtyAll] [numeric](18, 4) NULL,
	[FTXshRefExt] [varchar](50) NULL,
...
ALTER TABLE [dbo].[TRPTPdtBalByPdtGrpTmp] DROP CONSTRAINT IF EXISTS [DF__TRPTPdtBa__FDTmp__749945B9]
GO
/****** Object:  Table [dbo].[TRPTPdtBalByPdtGrpTmp]    Script Date: 2/12/2565 18:06:41 ******/
DROP TABLE IF EXISTS [dbo].[TRPTPdtBalByPdtGrpTmp]
GO
/****** Object:  Table [dbo].[TRPTPdtBalByPdtGrpTmp]    Script Date: 2/12/2565 18:06:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[TRPTPdtBalByPdtGrpTmp](
	[FTRptRowSeq] [bigint] IDENTITY(1,1) NOT NULL,
	[FNRowPartID] [bigint] NULL,
	...
	[FCPdtCostStdFC] [numeric](18, 4) NULL,
	[FCPdtCostStdTotalFC] [numeric](18, 4) NULL,
	[FTPdtCatName1] [varchar](255) NULL,
	[FTPdtCatName2] [varchar](255) NULL,
	[FTAgnName] [varchar](150) NULL,
	[FTPdtCostStdAmt] [numeric](18, 4) NULL,
PRIMARY KEY CLUSTERED 
(
	[FTRptRowSeq] ASC
...
GO
ALTER TABLE [dbo].[TRPTPdtBalByPdtGrpTmp] ADD  DEFAULT (getdate()) FOR [FDTmpTxnDate]
GO


IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TRPTPSTaxHDTmp]') AND type in (N'U'))
ALTER TABLE [dbo].[TRPTPSTaxHDTmp] DROP CONSTRAINT IF EXISTS [DF__TRPTPSTax__FDTmp__52B9FAC2]
GO
/****** Object:  Table [dbo].[TRPTPSTaxHDTmp]    Script Date: 2/12/2565 18:11:25 ******/
DROP TABLE IF EXISTS [dbo].[TRPTPSTaxHDTmp]
GO
/****** Object:  Table [dbo].[TRPTPSTaxHDTmp]    Script Date: 2/12/2565 18:11:25 ******/
SET ANSI_NULLS ON
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TRPTPSTaxHDDateTmp]') AND type in (N'U'))
ALTER TABLE [dbo].[TRPTPSTaxHDDateTmp] DROP CONSTRAINT IF EXISTS [DF__TRPTPSTax__FDTmp__50D1B250]
GO
/****** Object:  Table [dbo].[TRPTPSTaxHDDateTmp]    Script Date: 2/12/2565 18:12:33 ******/
DROP TABLE IF EXISTS [dbo].[TRPTPSTaxHDDateTmp]
GO
/****** Object:  Table [dbo].[TRPTPSTaxHDDateTmp]    Script Date: 2/12/2565 18:12:33 ******/
SET ANSI_NULLS ON
GO
...
----------- End Script Structure 07.01.05 -------------
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TPSTWhTaxHD' AND COLUMN_NAME = 'FCXshPaid') BEGIN
	ALTER TABLE TPSTWhTaxHD ADD FCXshPaid NUMERIC(18,4)
END
GO
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TPSTWhTaxHD' AND COLUMN_NAME = 'FCXshLeft') BEGIN
	ALTER TABLE TPSTWhTaxHD ADD FCXshLeft NUMERIC(18,4)
END
GO
IF NOT EXISTS(SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TPSTWhTaxHD' AND COLUMN_NAME = 'FTXshStaPaid') BEGIN
	ALTER TABLE TPSTWhTaxHD ADD FTXshStaPaid VARCHAR(1)
END
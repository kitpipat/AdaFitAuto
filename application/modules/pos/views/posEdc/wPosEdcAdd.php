        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="col-xs-8 col-sm-8">
                    ...
                    <div class="form-group">
                        <label class="xCNLabelFrm"><span class="text-danger">*</span> <?php echo  language('pos/posedc/posedc', 'tPosEdcSysModel'); ?></label>
                        <div class="input-group">
                            <input type="text" class="form-control xCNHide" id="oetPosEdcSedCode" name="oetPosEdcSedCode" value="<?php echo @$tPosEdcSedCode; ?>">
                            <input type="text" class="form-control xWPointerEventNone" id="oetPosEdcSedName" name="oetPosEdcSedName" value="<?php echo @$tPosEdcSedModel; ?>" data-validate-required="<?php echo language('pos/posedc/posedc', 'tPosEdcValidatePosEdcSedCode'); ?>" readonly>
                            <span class="input-group-btn">

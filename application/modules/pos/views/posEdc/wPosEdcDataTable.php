                    ...
                    <?php if(isset($aDataList) && $aDataList['rtCode'] == 1):?>
                        <?php foreach($aDataList['raItems'] AS $key => $aValue):?>
                            <tr class="xCNTextDetail2 xCNPoeEdc" id="otrPosEdc<?php echo $key?>" data-code="<?php echo $aValue['FTEdcCode']?>" data-name="<?php echo $aValue['FTEdcName']?>">
                                  ...
                                  ?>
                                    <td nowrap class="text-center">
                                        <label class="fancy-checkbox">
                                            ...
                                            data-checkrowid="<?php echo $aValue['FTEdcCode']?>" checked="false" class="ocbListItem" name="ocbListItem[]">
                                ...
                                <td nowrap class="text-left"><?php echo ($aValue['FTSedModel'] == '') ? '-' : $aValue['FTSedModel'];?></td>
                                <td nowrap class="text-left"><?php echo ($aValue['FTBnkName'] == '') ? '-' : $aValue['FTBnkName'];?></td>
                                <?php if ($aAlwEvent['tAutStaFull'] == 1 || ($aAlwEvent['tAutStaAdd'] == 1 || $aAlwEvent['tAutStaEdit'] == 1)) : ?>

                                   <td class="<?=$tDisableTD?> text-center" id="otdDel<?php echo $aValue['FTEdcCode']?>">
                                        <img
                                            class="xCNIconTable xCNIconDel <?php echo $tDisableImg; ?>"
                                            ...
                                            id="oimDel<?php echo $aValue['FTEdcCode']; ?>"
                                        >
                                    </td>
                                <?php endif; ?>
                                <?php if ($aAlwEvent['tAutStaFull'] == 1 || ($aAlwEvent['tAutStaAdd'] == 1 || $aAlwEvent['tAutStaEdit'] == 1)) : ?>

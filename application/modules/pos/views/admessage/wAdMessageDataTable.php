        ...
        <div class="table-responsive">
            <table class="table table-striped" style="width:100%">
                ...
                ?>
                   ...
                   data-checkrowid="<?php echo $aValue['rtAdvCode']?>"
                   >
                   <span class="<?php echo $tDisabledItem2; ?>">&nbsp;</span>
							...
							<?php if($aAlwEventAdMessage['tAutStaFull'] == 1 || $aAlwEventAdMessage['tAutStaDelete'] == 1) : ?>
								<td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtAdvCode']?>">
                  <img class="xCNIconTable xCNIconDel" src="<?= base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                  id="oimDel<?php echo $aValue['rtAdvCode']; ?>"
                  onClick="JSaAdMessageDelete('<?=$nCurrentPage?>','<?=$aValue['rtAdvName']?>','<?=$aValue['rtAdvCode']?>')">
                </td>
              <?php endif; ?>
							<?php if($aAlwEventAdMessage['tAutStaFull'] == 1 || $aAlwEventAdMessage['tAutStaRead'] == 1) : ?>

<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <label id="olbSalemachineAddressInfo"  class="xCNLinkClick"><?php echo language('pos/salemachine/salemachine','tPOSAddressTitle');?></label>
        ...
        <div class="demo-button xCNBtngroup" style="width:100%;">
            ...
            <div id="odvSalemachineAddressBtnGrpAddEdit">
                <div class="demo-button xCNBtngroup" style="width:100%;">
                    ...
                    <?php if($aAlwSalemachineAddress['tAutStaFull'] == 1 || ($aAlwSalemachineAddress['tAutStaAdd'] == 1 || $aAlwSalemachineAddress['tAutStaEdit'] == 1)) : ?>
                        <button id="obtSalemachineAddressSave" type="button" class="btn xCNBTNSubSave">

...
if (isset($nStaAddOrEdit) && $nStaAddOrEdit == 1) {
    ...
    $tPosIP = $aPosData['raItems']['rtPosIP'];
    ...
    $tPosStaFranchise = $aPosData['raItems']['rtPosStaFranchise'];
                    ...
                    <form class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddSaleMachine">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-5 col-lg-5">
                                ...
                                <div class="form-group">
                                    <label class="xCNLabelFrm"><?= language('pos/salemachine/salemachine', 'tPOSIp') ?></label>
                                    <input type="text" class="form-control text-left xCNInputNumericWithDecimal" maxlength="125" id="oetPosIP" name="oetPosIP" placeholder="<?= language('pos/salemachine/salemachine', 'tPOSIp') ?>" value="<?php echo $tPosIP;?>">
                                ...
                                <div class="form-group" id="odvWarehouseForm" <?php
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control xWPointerEventNone" type="text" id="oetBchWahName" name="oetBchWahName" value="<?php echo $tWahName ?>" placeholder="<?=language('company/branch/branch', 'tBCHWarehouse') ?>" readonly data-validate-required="<?php echo  language('company/branch/branch', 'tPOSValidWahName') ?>">
                                        <span class="input-group-btn">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control xWPointerEventNone" id="oetPosChanelName" name="oetPosChanelName" placeholder="<?=language('pos/poschannel/poschannel', 'tCHNLabelTitle') ?>" value="<?= $tChnName; ?>" readonly>
                                        <span class="input-group-btn">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control xCNInputWithoutSpcNotThai" id="oetSmgTitle" name="oetSmgTitle" placeholder="<?=language('pos/slipMessage/slipmessage', 'tSMGTitle') ?>" value="<?php echo $tSlipMsgName; ?>" data-validate="<?php echo  language('pos/salemachine/salemachine', 'tSMGValiSlipMessageName'); ?>" readonly>
                                        <span class="input-group-btn">
                                ...
                                <div class="form-group">
                                    <label class="fancy-checkbox">
                                        <input type="checkbox" name="ocbPosStaSaleFC" <?php
                                                                                    if ($tRoute == "salemachineEventAdd") {
                                                                                        echo "checked";
                                                                                    } else {
                                                                                        echo ($tPosStaFranchise == '1') ? "checked" : '';
                                                                                    } ?> value="1">
                                        <span> <?php echo language('pos/salemachine/salemachine', 'tPosStaSaleFC'); ?></span>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-8 text-right">
                                    ...
                                    <div id="odvBtnMacAddEdit">
                                        ...
                                        <button type="submit" class="btn xCNBTNSubSave" onclick="JSxSetStatusClickPhwSubmit();$('#obtSubmitSaleMachineDevice').click()">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-8 text-right">
                                    <div class="text-right" style="width:100%;">
                                        <div id="odvMngTableList" class="btn-group xCNDropDrownGroup" style="margin-top:25px;">
...
<script>
    ...
    <?php //if ($tRoute == "salemachineEventAdd") { ?>

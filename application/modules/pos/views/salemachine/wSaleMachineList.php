			...
			<div class="col-xs-8 col-md-4 col-lg-4">
				<div class="form-group"> <!-- เปลี่ยน From Imput Class -->
					...
					<div class="input-group">
						<input type="text" class="form-control" id="oetSearchSaleMachine" name="oetSearchSaleMachine" placeholder="<?php echo language('pos/salemachine/salemachine','tPOSSearchData')?>">

            ...
            <div class="col-xs-12 col-md-5 col-lg-5">
                ...
                <div class="form-group xCNHide">
                    ...
                    <select class="selectpicker form-control" id="ocmSelectSrcType" name="ocmSelectSrcType">
                        ...
                        <option value="2" selected ><?php echo language('pos/setprinter/Setprinter', 'tSprSetprinterPrinter')?></option> -->
                    </select>
                </div>
                <!--Application-->
                <div class="form-group xCNHide" id="ocmFTPrnSrcTypeApplication">
                ...
                <!--End Application-->
                <!--OS-->
                <div class="form-group xCNHide" id="ocmFTPrnSrcTypeOS">
                    <label class="xCNLabelFrm"><?php echo language('pos/setprinter/Setprinter','tSprSetprinterDriver')?></label>
                    <div class="input-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="ocmSelectTypePrinter" name="ocmSelectTypePrinter">
                        <option value="1" <?php echo ($tFTPrnType == 1)? 'selected':''?>><?php echo language('pos/setprinter/Setprinter', 'tSprSetprinterTypePrinter0')?></option>
                        <option value="2" <?php echo ($tFTPrnType == 2)? 'selected':''?>><?php echo language('pos/setprinter/Setprinter', 'tSprSetprinterTypePrinter1')?></option>
                        <option value="3" <?php echo ($tFTPrnType == 3)? 'selected':''?>><?php echo language('pos/setprinter/Setprinter', 'tSprSetprinterTypePrinter2')?></option>
                        <option value="4" <?php echo ($tFTPrnType == 4)? 'selected':''?>><?php echo language('pos/setprinter/Setprinter', 'tSprSetprinterTypePrinter3')?></option>
                    </select>
                </div>
                <div class="form-group">
                    <!-- <div class="validate-input">

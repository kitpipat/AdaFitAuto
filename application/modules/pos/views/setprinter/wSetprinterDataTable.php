            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="xCNTextBold text-left" style="width:20%;"><?php echo language('pos/setprinter/Setprinter','tSprName'); ?></th>
                        <th class="xCNTextBold text-left" style="width:20%;"><?php echo language('pos/setprinter/Setprinter','tSprTypePrint'); ?></th>
                        <th class="xCNTextBold text-left" style="width:20%;"><?php echo language('pos/setprinter/Setprinter','tSprNReason'); ?></th>
                              ...
                              ?>
                                <td class="text-center">
                                    <label class="fancy-checkbox">
                                        ...
                                        data-checkrowid="<?php echo $aValue['FTPrnCode']?>"
                                       >
                                ...
                                <td class="text-left"><?php echo $aValue['FTPrnRmk']; ?></td>
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['FTPrnCode']?>">
                                    <img class="xCNIconTable" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                                    onClick="JSaSetprinterDelete('<?=$nCurrentPage?>','<?=$aValue['FTPrnName'];?>','<?=$aValue['FTPrnCode']?>')"
                                      id="oimDel<?php echo $aValue['FTPrnCode']; ?>"
                                    title="<?php echo language('pos/Setprinter/Setprinter', 'tSprBTNDelete'); ?>"
                                    >
                                </td>
                                <td>

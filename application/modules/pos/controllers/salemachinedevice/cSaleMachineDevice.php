...
class cSaleMachineDevice extends MX_Controller{
    ...
    public function FSoCPHWAddEvent()
    {
        ...
        $tStatusUpdate = $this->mSaleMachineDevice->FSaMPHUpdateLastUpdate($aDataSaleMachineDevice['FTPosCode'],$aDataSaleMachineDevice['FTBchCode']);
    ...
    public function FSoCPHWEditEvent()
    {
        ...
        $this->mSaleMachineDevice->FSaMPHUpdateLastUpdate($tPosCode,$tPosbch);
        // print_r($aDataSaleMachineDevice);
        // exit;
        $this->db->trans_begin();
        $this->mSaleMachineDevice->FSaMPHWAddUpdateMaster($aDataSaleMachineDevice);
    ...
    public function FSoCPHWDeleteEvent()
    {
        ...
        $tStatusUpdate = $this->mSaleMachineDevice->FSaMPHUpdateLastUpdate($tPosCode,$tBchCode);

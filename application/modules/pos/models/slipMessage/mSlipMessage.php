...
class mSlipMessage extends CI_Model {
    ...
    public function FSaMSMGSearchByID($ptAPIReq, $ptMethodReq, $paData){
        ...
        $tHDSQL     = "
            SELECT
                ...
                SMGHD.FTMshCode AS rtMshCode,
                THD_L.FTMshName AS rtMshName
            ...
            LEFT JOIN [TCNMMsgHD] THD  ON SMGHD.FTMshCode       = THD.FTMshCode
            LEFT JOIN [TCNMMsgHD_L] THD_L  ON THD_L.FTMshCode   = THD.FTMshCode
            WHERE 1=1
    ...
    public function FSaMSMGAddUpdateHD($paData){
        try{
            ...
            $this->db->set('FTMshCode', $paData['FTMshCode']);

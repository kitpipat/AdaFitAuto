                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 text-right">
                                        <div id="odvASTButtonGroup">
                                            ...
                                            <!-- สแกนค้นหาจากบาร์โค๊ด -->
                                            <div class="btn-group" style="margin-left: 5px;">
                                                <input <?php if(!empty($tASTStaApv) || $tASTStaDoc == 3){ echo "disabled style='display:none;'"; }?> type="text" class="form-control xWASTDisabledOnApv" id="oetAdjStkScan" name="oetAdjStkScan" autocomplete="off" maxlength="50" onkeypress="Javascript:if(event.keyCode==13) JSxASTEventScan(event,this);"  placeholder="เพิ่มสินค้าด้วยบาร์โค้ด หรือ รหัสสินค้า" style="width: 205px;" >
                                            </div>

                                            <div class="btn-group" style="margin-left: 5px;">
                                                <button <?php if(!empty($tASTStaApv) || $tASTStaDoc == 3){ echo "disabled style='display:none;'"; }?> id="obtAdjStkFilterDataCondition" type="button" class="btn btn-primary xWASTDisabledOnApv" style="font-size: 16px;">กรองข้อมูลตามเงื่อนไข</button>
                                            </div>
...
<div class="modal fade" id="odvASTPopupCancel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?php echo language('document/adjuststock/adjuststock', 'กรุณาเลือกเหตุผลในการยกเลิกใบตรวจนับ - ยืนยันสินค้าคงคลัง'); ?></p>
                <div class="form-group">
                    <label class="xCNLabelFrm"><span style = "color:red">*</span><?php echo language('document/adjuststock/adjuststock', 'tASTReason'); ?></label>
                    <div class="input-group">
...
<!-- ======================================================================== Modal หาว่าเอกสารมีเอกสารค้างอนุมัติ ======================================================================== -->
<div id="odvASTModalDocNotApv" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>ไม่สามารถอนุมัติเอกสารได้ เนื่องจาก มีเอกสารที่มีผลกับสต็อกค้างอนุมัติ กรุณากลับไปตรวจสอบเอกสาร และทำการอนุมัติเอกสาร หรือยกเลิกเอกสาร สามารถตรวจสอบเอกสารค้างอนุมัติได้ที่ การแจ้งเตือน</p>
            </div>
            <div class="modal-footer">

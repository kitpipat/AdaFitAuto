<div class="panel panel-headline">
	<div class="panel-body">
		<section id="ostSearchPCK">
			<div class="row">
				<div class="col-xs-3 col-md-3">
					<div class="form-group">
						<div class="input-group">
							...
							onkeyup="Javascript:if(event.keyCode==13) JSvPCKCallPageDataTable()" 
							autocomplete="off">
							<span class="input-group-btn">
								<button type="button" class="btn xCNBtnDateTime" onclick="JSvPCKCallPageDataTable()">
				...
				<a id="oahPCKAdvanceSearch" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;"><?php echo language('common/main/main', 'tAdvanceSearch'); ?></a>
				<a id="oahTFWSearchReset" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;" onclick="JSxPCKClearSearchData()"><?php echo language('common/main/main', 'tClearSearch'); ?></a>
			</div>

			<div class="row hidden" id="odvPCKAdvanceSearchContainer" style="margin-bottom:20px;">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-right-15">
						<div class="form-group">
							...
							<div class="input-group">
								...
								name="oetBchNameFrom" 
								placeholder="<?php echo language('document/topupVending/topupVending', 'จากสาขา'); ?>" 
								readonly
								value="<?= $tBCHName; ?>"
								>
								<span class="input-group-btn">
									<button id="obtPCKBrowseBchFrom" type="button" class="btn xCNBtnBrowseAddOn">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
						<div class="form-group">
							...
							<div class="input-group">
								...
								id="oetBchNameTo" 
								name="oetBchNameTo" 
								placeholder="<?php echo language('document/topupVending/topupVending', 'ถึงสาขา'); ?>" 
								readonly
								value="<?= $tBCHName; ?>">
								<span class="input-group-btn">
									<button id="obtPCKBrowseBchTo" type="button" class="btn xCNBtnBrowseAddOn">
										<img src="<?php echo  base_url() . 'application/modules/common/assets/images/icons/find-24.png' ?>">
									</button>
								</span>
							</div>
						...
						<div class="col-lg-6 col-md-6 col-xs-6">
							...
							<div class="form-group">
								<div class="input-group">
									...
									placeholder="<?php echo language('document/topupVending/topupVending', 'จากวันที่เอกสาร'); ?>">
									<span class="input-group-btn">
						...
						<div class="col-lg-6 col-md-6 col-xs-6">
							...
							<div class="form-group">
								<div class="input-group">
									...
									placeholder="<?php echo language('document/topupVending/topupVending', 'ถึงวันที่เอกสาร'); ?>">
									<span class="input-group-btn">
				...
				<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group" style="width: 60%;">
                        ...
                        <button id="oahTFWAdvanceSearchSubmit" class="btn xCNBTNPrimery" style="width:100%" onclick="JSvPCKCallPageDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></button>
                    </div>
                </div>
			</div>
		</section>
	...
	<div class="panel-body">
		<section id="odvPCKContent"></section>
	</div>
</div>
...
<?php include('script/jProductPickList.php') ?>
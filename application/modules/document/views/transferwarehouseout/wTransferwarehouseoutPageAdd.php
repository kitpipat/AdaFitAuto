...
<?php
    ...
    if (isset($aDataDocHD) && $aDataDocHD['rtCode'] == "1") {
        ...
        $nStaUploadFile         = 2;
        $tTWOCheckIn            = $aDataCheckIn['rtCode'];  // ค่าที่ได้จากการเชคเอกสารอ้่างอิงภายใน

        $tTWOCustomerCode       = $aDataDocHD['raItems']['FTCstCode'];
        $tTWOCustomerName       = $aDataDocHD['raItems']['FTCstName'];
...
<form id="ofmTransferwarehouseoutFormAdd" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" id="ohdTWORefInType"       name="ohdTWORefInType"      value="<?=@$tRefInType;?>">
    <input type="hidden" id="ohdTWOAutStaCancel"    name="ohdTWOAutStaCancel"   value="<?=@$aAlwEvent['tAutStaCancel'];?>">
    <input type="hidden" id="ohdTWODocDateCreate"   name="ohdTWODocDateCreate"  value="<?=date("m", strtotime(@$dTWODocDate))?>">
    <input type="hidden" id="ohdTWODateNowToday"    name="ohdTWODateNowToday"   value="<?=date('m');?>">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <?php
                                    ...
                                    } else if ($tTWOStaPrcStk == 2) {
                                        $tClassPrcStk = 'text-warning';
                                    } else if ($tTWOStaPrcStk == '') {
                                        $tClassPrcStk = 'text-warning';
                                    } else {
                                        $tClassPrcStk = "";
                                    }
                                ...
                                <div class="form-group" style="margin:0">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
                                            ...
                                            <?php }else{ ?>
                                                <label class="<?=$tClassPrcStk?> xCNTDTextStatus <?php echo $tClassPrcStk; ?>"><?= language('document/transferwarehouseout/transferwarehouseout', 'tTWOStaPrcStk' . $tTWOStaPrcStk); ?></label>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                ...
                <div id="odvTWODataConditionDoc" class="panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div id="odvTRNOut" class="row" style="margin-top: 10px;" >
                                    <div class="col-lg-12">
                                            ...
                                            <div id="odvDocType_2">
                                                ...
                                                <div id="odvINWhereETC" style="display:none">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control " id="oetTWOINEtc" name="oetTWOINEtc" value="<?= $tTWOOther ?>" maxlength="100">
                                                    </div>
                                                ...
                                                <div id="odvINWhereCUS" style="display:none;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input name="oetTranferOutCusCode" id="oetTranferOutCusCode" value="<?=@$tTWOCustomerCode?>" class="form-control xCNHide xCNClearValue" type="text">
                                                            <input name="oetTranferOutCusName" id="oetTranferOutCusName" class="form-control" value="<?=@$tTWOCustomerName?>" type="text" readonly="" placeholder="<?= language('document/topupVending/topupVending', 'tINCUS') ?>">
                                                            <span class="input-group-btn">
                                                                <button class="btn xCNBtnBrowseAddOn xCNApvOrCanCelDisabled" id="obtBrowseTranferOutCus" type="button">
                                                                    <img src="<?= base_url() . '/application/modules/common/assets/images/icons/find-24.png' ?>">
                                                                </button>
                                                            </span>
                                                        </div>
                ...
                <div id="odvTWODataConditionETC" class="xCNMenuPanelData panel-collapse collapse" role="tabpanel">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control xControlRmk xWConditionSearchPdt" id="otaTWOFrmInfoOthRmk" name="otaTWOFrmInfoOthRmk" rows="10" maxlength="200" style="resize: none;height:86px;"><?= $tTWORmk; ?></textarea>
                        </div>
                                ...
                                <div style="margin-top: 10px;">
                                    ...
                                    <div class="row p-t-10">
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" maxlength="100" id="oetTWOFrmFilterPdtHTML" name="oetTWOFrmFilterPdtHTML" placeholder="<?php echo language('document/purchaseinvoice/purchaseinvoice', 'tPIFrmFilterTablePdt'); ?>" onkeyup="javascript:if(event.keyCode==13) JSvTWODOCFilterPdtInTableTemp()">
                                                    <span class="input-group-btn">
                                                        <button id="obtTWOMngPdtIconSearch" type="button" class="btn xCNBtnDateTime" onclick="JSvTWODOCFilterPdtInTableTemp()">

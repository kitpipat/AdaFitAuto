...
<input id="oetTWOJumpDocNo" type="hidden" value="<?php echo $aParams['tDocNo'] ?>">
<input id="oetTWOJumpBchCode" type="hidden" value="<?php echo $aParams['tBchCode'] ?>">
<input id="oetTWOJumpAgnCode" type="hidden" value="<?php echo $aParams['tAgnCode'] ?>">

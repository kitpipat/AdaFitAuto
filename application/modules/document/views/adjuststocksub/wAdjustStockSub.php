...
<input id="oetAdjJumpDocNo" type="hidden" value="<?php echo $aParams['tDocNo'] ?>">
<input id="oetAdjJumpBchCode" type="hidden" value="<?php echo $aParams['tBchCode'] ?>">
<input id="oetAdjJumpAgnCode" type="hidden" value="<?php echo $aParams['tAgnCode'] ?>">

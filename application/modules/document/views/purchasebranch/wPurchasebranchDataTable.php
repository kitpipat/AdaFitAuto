            ...
            <table id="otbPRBTblDataDocHDList" class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        ...
                        <?php endif; ?>
                        <th nowrap class="xCNTextBold" style="width:10%;"><?php echo language('document/purchasebranch/purchasebranch','tPRBBchName')?></th>
                        <th nowrap class="xCNTextBold" style="width:12%;"><?php echo language('document/purchasebranch/purchasebranch','tPRBDocNo')?></th>
                        <th nowrap class="xCNTextBold" style="width:8%;"><?php echo language('document/purchasebranch/purchasebranch','tPRBDocDate')?></th>
                        <th nowrap class="xCNTextBold" style="width:12%;"><?php echo language('document/purchasebranch/purchasebranch','tPRBDocRefIntNo')?></th>
                        <th nowrap class="xCNTextBold" style="width:8%;"><?php echo language('document/purchasebranch/purchasebranch','tPRBDocRefIntDate')?></th>
                        <th nowrap class="xCNTextBold" style="width:10%;"><?php echo language('document/purchasebranch/purchasebranch','tPRBStaApv')?></th>
                        <th nowrap class="xCNTextBold" style="width:10%;"><?php echo language('document/purchasebranch/purchasebranch','tPRBCreateBy')?></th>
                        <?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
                    ...
                    <?php if($aDataList['rtCode'] == 1 ):?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            <?php
                                ...
                                $tTRBRefInCode  = $aValue['FTXphRefInt'];
                                ...
                                if(!empty($aValue['FTXphStaApv']) || $aValue['FTXphStaDoc'] == 3){
                                    ...
                                    $tClassDisabled = '';
                                    $tTitle = '';
                                    $tOnclick = "onclick=JSoPRBDelDocSingle('".$nCurrentPage."','".$tTRBDocNo."','".$tTRBAgnCode."','".$tTRBBchCode."','".$tTRBRefInCode."')";
                                }
                            ...
                            data-name="<?php echo $aValue['FTXphDocNo']?>"
                            >
                                <?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
                                ...
                                <td nowrap class="text-left"><?php echo (!empty($aValue['FTXphRefInt']))? $aValue['FTXphRefInt'] : '-' ?></td>
                                ...
                                <?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaRead'] == 1) : ?>
                                    ...
                                    <?php if($bIsApvOrCancel) { ?>
                                            <img class="xCNIconTable" style="width: 17px;" src="<?= base_url('application/modules/common/assets/images/icons/view2.png'); ?>" onClick="JSvPRBCallPageEdit('<?php echo $aValue['FTBchCode']?>','<?php echo $aValue['FTAgnCode']?>','<?= $aValue['FTXphDocNo'] ?>')">
                                        <?php }else{ ?>
                                            <img class="xCNIconTable xCNIconEdit" onClick="JSvPRBCallPageEdit('<?php echo $aValue['FTBchCode']?>','<?php echo $aValue['FTAgnCode']?>','<?php echo $aValue['FTXphDocNo']?>')">
                                        <?php } ?>
                                    </td>
                                <?php endif; ?>
                            </tr>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="xWPIPageDataTable btn-toolbar pull-right">
            ...
            <button onclick="JSvPRBClickPageList('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
            ...
            <?php for($i=max($nPage-2, 1); $i<=max(0, min($aDataList['rnAllPage'],$nPage+2)); $i++){?>
                ...
                ?>
                <button onclick="JSvPRBClickPageList('<?php echo $i?>')" type="button" class="btn xCNBTNNumPagenation <?php echo $tActive ?>" <?php echo $tDisPageNumber ?>><?php echo $i?></button>
            <?php } ?>

            <?php if($nPage >= $aDataList['rnAllPage']){  $tDisabledRight = 'disabled'; }else{  $tDisabledRight = '-';  } ?>
            <button onclick="JSvPRBClickPageList('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>
...
<div id="odvPRBModalDelDocSingle" class="modal fade" tabindex="-1" role="dialog">
...
<div id="odvPRBModalDelDocMultiple" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header xCNModalHead">
                <label class="xCNTextModalHeard"><?php echo language('common/main/main','tModalDelete')?></label>
...
<?php include('script/jPurchasebranchDataTable.php')?>

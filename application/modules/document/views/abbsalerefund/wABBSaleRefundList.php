...
<div class="panel panel-headline">
    <div class="panel-heading">
        <div class="row">
            ...
            <!-- START Sta Apv -->
            <!-- FTXshStaPrcDoc 1:รออนุมัติ 2:รอจัดสินค้า 3:รอจัดส่ง 4:ยืนยันจัดส่ง -->
            <!-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
                <div class="form-group">
                    <label class="xCNLabelFrm"><?=language('document/abbsalerefund/abbsalerefund','tABBStaApv');?></label> 
                    <select class="selectpicker form-control" id="ocmABBStaPrcDoc" name="ocmABBStaPrcDoc"> 
                        <option value=""><?=language('common/main/main','tAll');?></option>
                        <option value="5"><?=language('document/document/document', 'tDocStaProApv1');?></option>
                        <option value="1-4"><?=language('document/document/document', 'tDocStaProApv');?></option>
                    </select>
                    <script>
                        $('.selectpicker').selectpicker('refresh');
                    </script>

            ...
            <table class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        ...
                        <!-- <th nowrap class="xCNTextBold"><?= language('document/abbsalerefund/abbsalerefund', 'tABBTBStaDownloadABB') ?></th> -->
                    ...
                    ?>
                                <tr class="text-center xCNTextDetail2">
                                    ...
                                    <td nowrap class="text-left">
                                        ...
                                        echo '<span class="xWABBStatusColor ' . $tSpanClass . '">' . $tLabel . '</span>';
                                        ?>
                                    </td>
                                    <!-- <td nowrap class="text-left">

                        ...
                        $.ajax({
                            ...
                            success: function(oResult) {
                                ...
                                if ( aReturnData['tReturnCode'] == '1' ) {
                                    ...
                                    var tABBFullTaxTextBtn = '<?=language('document/abbsalerefund/abbsalerefund', 'tABBBtnDownload'.$tXshDocType.'FullTax');?>';
                    ...
                    $.ajax({
                        ...
                        success: function(oResult) {
                            ...
                            if ( aReturnData['tReturnCode'] == '1' ) {
                                ...
                                var tABBABBTextBtn = '<?=language('document/abbsalerefund/abbsalerefund', 'tABBBtnDownload'.$tXshDocType.'ABB');?>';

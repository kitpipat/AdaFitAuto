    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header xCNModalHead">
                <label class="xCNTextModalHeard"><?= language('document/document/document', 'tDocPdtS/N') ?></label>
            </div>
...
<script>
    ...
    //ค้นหาสินค้าใน temp
    function JSvABBDOCSearchPdtHTML() {
        var value = $("#oetABBFilterPdt").val().toLowerCase();
        $("#otbABBPdtTableList tbody tr ").filter(function () {

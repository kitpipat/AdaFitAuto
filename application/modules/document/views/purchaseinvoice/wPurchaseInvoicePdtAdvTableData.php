                        ...
                        >
                            ...
                            <td class="otdQty" align="right">
                                ...
                                <?php if( $aDataTableVal['FTTmpStatus'] != 5 ){ ?>
                                    ...
                                    ?>
                                    <label class="<?=$tClassName?> xCNPdtFont xWShowInLine"  onclick='JSxUpdateProductSerialandFashion(<?=$aOption?>)' ><span class="xCNQtyFhn"><?=number_format($aDataTableVal['FCXtdQty'],$nOptDecimalShow)?></span> <?=$tIconEdit?></label>

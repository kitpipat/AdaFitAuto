                        ...
                        if (FCNnHSizeOf($aDataList['raItems']) != 0) {
                            foreach ($aDataList['raItems'] as $nKey => $aValue) : ?>
                                ...
                                <tr id="otrAdjustmentcost<?php echo $nKey ?>" class="text-center xCNTextDetail2 otrAdjustmentcost" data-code="<?php echo $aValue['FTXchDocNo'] ?>" data-name="<?php echo $aValue['FTXchDocNo'] ?>">
                                    ...
                                    <td class="text-left">
                                        <label class="xCNTDTextStatus <?php echo $tClassPrcStk; ?>"><?php echo language('document/adjustmentcost/adjustmentcost', 'tADCStaPrcStk' . $aValue['FTXchStaPrcDoc']) ?></label>
                                    </td>
                                    <td class="text-left">
                                    ...
                                    <?php if ($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaRead'] == 1) : ?>
                                        <td>
                                            <?php if ($aValue['FTXchStaApv'] == 1 || $aValue['FTXchStaDoc'] == 3) { ?>
                                                <img class="xCNIconTable" style="width: 17px;" src="<?php echo  base_url() . '/application/modules/common/assets/images/icons/view2.png' ?>" onClick="JSvADCCallPageEdit('<?php echo $aValue['FTXchDocNo'] ?>','<?php echo $aValue['FNXchDocType'] ?>','<?php echo $aValue['FTXchStaPrcDoc'] ?>')">
                                            <?php } else { ?>
                                                <img class="xCNIconTable" src="<?php echo  base_url() . '/application/modules/common/assets/images/icons/edit.png' ?>" onClick="JSvADCCallPageEdit('<?php echo $aValue['FTXchDocNo'] ?>','<?php echo $aValue['FNXchDocType'] ?>','<?php echo $aValue['FTXchStaPrcDoc'] ?>')">
                                            <?php } ?>
                                        </td>
                                    <?php endif; ?>
                                </tr>

<div class="panel panel-headline">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <input
                            ...
                            type="text"
                            id="oetJOBSearchAllDocument"
                            name="oetJOBSearchAllDocument"
                            placeholder="<?php echo language('document/deliveryorder/deliveryorder','tDOFillTextSearch')?>"
                            autocomplete="off"
                        >
                        <span class="input-group-btn">
                            <button id="obtJOBSerchAllDocument" type="button" class="btn xCNBtnDateTime"><img class="xCNIconSearch"></button>
                        </span>
                    </div>
                </div>
            </div>
            <button id="obtJOBAdvanceSearch" class="btn xCNBTNDefult xCNBTNDefult1Btn"><?php echo language('common/main/main', 'tAdvanceSearch'); ?></button>
            <button id="obtJOBSearchReset" class="btn xCNBTNDefult xCNBTNDefult1Btn"><?php echo language('common/main/main', 'tClearSearch'); ?></button>
        </div>
        <div id="odvJOBAdvanceSearchContainer" class="hidden" style="margin-bottom:20px;">
            <form id="ofmJOBFromSerchAdv" class="validate-form" action="javascript:void(0)" method="post">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control xCNHide" type="text" id="oetJOBAdvSearchBchCodeFrom" name="oetJOBAdvSearchBchCodeFrom" maxlength="5" value="<?= $tBCHCode; ?>">
                                <input
                                    class="form-control xWPointerEventNone"
                                    type="text"
                                    id="oetJOBAdvSearchBchNameFrom"
                                    name="oetJOBAdvSearchBchNameFrom"
                                    placeholder="<?php echo language('document/deliveryorder/deliveryorder','tDOAdvSearchFrom'); ?>"
                                    readonly
                                    value="<?= $tBCHName; ?>"
                                >
                                <span class="input-group-btn">
                                    <button id="obtJOBAdvSearchBrowseBchFrom" type="button" class="btn xCNBtnBrowseAddOn" ><img class="xCNIconFind"></button>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control xCNHide" id="oetJOBAdvSearchBchCodeTo"name="oetJOBAdvSearchBchCodeTo" maxlength="5" value="<?= $tBCHCode; ?>">
                                <input
                                    class="form-control xWPointerEventNone"
                                    type="text"
                                    id="oetJOBAdvSearchBchNameTo"
                                    name="oetJOBAdvSearchBchNameTo"
                                    placeholder="<?php echo language('document/deliveryorder/deliveryorder','tDOAdvSearchTo'); ?>"
                                    readonly
                                    value="<?= $tBCHName; ?>"
                                >
                                <span class="input-group-btn">
                                    <button id="obtJOBAdvSearchBrowseBchTo" type="button" class="btn xCNBtnBrowseAddOn" ><img class="xCNIconFind"></button>
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input
                                    ...
                                    type="text"
                                    id="oetJOBAdvSearcDocDateFrom"
                                    name="oetJOBAdvSearcDocDateFrom"
                                    placeholder="<?php echo language('document/deliveryorder/deliveryorder', 'tDOAdvSearchDateFrom'); ?>"
                                >
                                <span class="input-group-btn" >
                                    <button id="obtJOBAdvSearchDocDateForm" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        ...
                        <div class="input-group">
                            <input
                                class="form-control xCNDatePicker"
                                type="text"
                                id="oetJOBAdvSearcDocDateTo"
                                name="oetJOBAdvSearcDocDateTo"
                                placeholder="<?php echo language('document/deliveryorder/deliveryorder', 'tDOAdvSearchDateTo'); ?>"
                            >
                            <span class="input-group-btn" >
                                <button id="obtJOBAdvSearchDocDateTo" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="selectpicker form-control" id="ocmJOBAdvSearchStaDoc" name="ocmJOBAdvSearchStaDoc">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group" style="width:60%;float:left;">
                            ...
                            <button id="obtJOBAdvSearchSubmitForm" class="btn xCNBTNPrimery" style="width:100%"><?php echo language('common/main/main', 'tSearch'); ?></button>
                        </div>
                    </div>
                </div>
            </form>
                ...
                <div id="odvMngTableList" class="btn-group xCNDropDrownGroup">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li id="oliBtnDeleteAll" class="disabled">
                            <a data-toggle="modal" data-target="#odvJOBModalDelDocMultiple"><?= language('common/main/main','tDelAll')?></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="panel-body">
        <section id="ostJOBDataTableDocument"></section>
    </div>
</div>
<script src="<?php echo  base_url('application/modules/common/assets/js/jquery.mask.js')?>"></script>
<script src="<?php echo  base_url('application/modules/common/assets/src/jFormValidate.js')?>"></script>
<?php include('script/jJoborderFormSearchList.php')?>
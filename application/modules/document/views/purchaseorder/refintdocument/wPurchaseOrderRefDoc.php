...
<section>
                                ...
                                <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPOLabelFrmBranch')?></label>
                                    <div class="input-group">
                                        <input
                                            ...
                                            id="oetPORefIntBchCode"
                                            name="oetPORefIntBchCode"
                                            maxlength="5"
                                            value="<?=$tBCHCode?>"
                                            data-bchcodeold = ""
                                        >
                                        <input
                                            ...
                                            id="oetPORefIntBchName"
                                            name="oetPORefIntBchName"
                                            maxlength="100"
                                            value="<?=$tBCHName?>"
                                            readonly
                                        >
                                        <span class="input-group-btn xWConditionSearchPdt">
                                            <button id="obtPOBrowseBchRefIntDoc" type="button" class="btn xCNBtnBrowseAddOn "    >
                    ...
                    <div class="form-group">
                                <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateFrm')?></label>
                                        ...
                                        <input
                                            ...
                                            id="oetPORefIntDocDateFrm"
                                            name="oetPORefIntDocDateFrm"
                                            placeholder="YYYY-MM-DD"
                                            value=""
                                        >
                                        <span class="input-group-btn">
                                            <button id="obtPOBrowseRefExtDocDateFrm" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                                        </span>
                                    </div>
                                </div>
                    </div>
                                ...
                                <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateTo')?></label>
                                    <div class="input-group">
                                        <input
                                            type="text"
                                            class="form-control xCNDatePicker xCNInputMaskDate"
                                            id="oetPORefIntDocDateTo"
                                            name="oetPORefIntDocDateTo"
                                            placeholder="YYYY-MM-DD"
                                            value=""
                                        >
                                        <span class="input-group-btn">
                                            <button id="obtPOBrowseRefExtDocDateTo" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                                        </span>
                                    </div>
                            </div>
                    </div>
                ...
                <div class="col-md-2 col-xs-2 col-sm-2">
                    <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control  " id="oetPORefIntStaDoc" name="oetPORefIntStaDoc" maxlength="1" value="<?php echo $tPOSplPayMentType;?>">
...
<?php include('script/jPurchaseOrderRefDoc.php');?>
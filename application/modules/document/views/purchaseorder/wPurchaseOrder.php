                        ...
                        <div id="odvPOBtnGrpAddEdit">
                            <div class="demo-button xCNBtngroup" style="width:100%;">
                                ...
                                <?php if ($aAlwEvent['tAutStaFull'] == 1 || ($aAlwEvent['tAutStaAdd'] == 1 || $aAlwEvent['tAutStaEdit'] == 1)): ?>
                                    ...
                                    <button id="obtPOExportDoc" class="btn xCNBTNPrimery xCNBTNPrimery2Btn" type="button" onclick="JSxPOSendEmail()">ส่งอีเมล์</button>    
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="selectpicker form-control" id="ocmPOFilterExport" name="ocmPOFilterExport" maxlength="1">
                        <option value="" >ตามการตั้งค่าระบบ</option>

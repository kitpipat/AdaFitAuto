            ...
            <table class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        ...
                        <th class="xCNTextBold"><?= language('document/producttransferbranch/producttransferbranch','สาขาต้นทาง')?></th>
                        <th class="xCNTextBold"><?= language('document/producttransferbranch/producttransferbranch','สาขาปลายทาง')?></th>
                ...
                <?php if($aDataList['rtCode'] == 1 ):?>
                    <?php foreach($aDataList['raItems'] AS $key=>$aValue){ ?>
                        ...
                        <tr class="text-center xCNTextDetail2 otrTBDataTable" id="otrTBDataTable<?=$key?>" data-code="<?=$aValue['FTXthDocNo']?>" data-name="<?=$aValue['FTXthDocNo']?>">
                            ...
                            <td class="text-left"><?php echo $aValue['rtBCHNameFrm'] != '' ? $aValue['rtBCHNameFrm'] : '-' ?></td>
                            <td class="text-left"><?php echo $aValue['rtBCHNameTo'] != '' ? $aValue['rtBCHNameTo'] : '-' ?></td>
...
<div class="row">
    ...
    <!-- <div class="col-md-6">
        <div class="xWPage btn-toolbar pull-right">
            ...
            <button onclick="JSvTBClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
            ...
            <button onclick="JSvTBClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>> 

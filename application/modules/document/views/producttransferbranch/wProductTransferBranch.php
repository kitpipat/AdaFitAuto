...
<input id="oetTBJumpDocNo" type="hidden" value="<?php echo $aParams['tDocNo'] ?>">
<input id="oetTBJumpBchCode" type="hidden" value="<?php echo $aParams['tBchCode'] ?>">
<input id="oetTBJumpAgnCode" type="hidden" value="<?php echo $aParams['tAgnCode'] ?>">
                        ...
                        <div id="odvBtnAddEdit">
                            <div class="demo-button xCNBtngroup" style="width:100%;">
                                ...
                                <?php if ($aAlwEvent['tAutStaFull'] == 1 || ($aAlwEvent['tAutStaAdd'] == 1 || $aAlwEvent['tAutStaEdit'] == 1)) : ?>
                                    ...
                                    <div class="btn-group">
                                        <button id="obtTBSubmit" type="button" class="btn xWBtnGrpSaveLeft" onclick="JSxSetStatusClickTBSubmit(1);$('#obtSubmitTB').click()"> <?php echo language('common/main/main', 'tSave') ?></button>
                                        <?php echo $vBtnSave ?>
                                    </div>
                                <?php endif; ?>
                            </div>

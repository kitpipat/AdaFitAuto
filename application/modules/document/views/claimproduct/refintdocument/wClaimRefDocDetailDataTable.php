        ...
        <tr>
            <th class="xRefIntTh text-center">
                <!-- <label class="fancy-checkbox ">
                    <input id="ocbRefIntDocDTAll" type="checkbox" class="ocbRefIntDocDTAll" name="ocbListItem[]"  checked disabled>
                    <span class="">&nbsp;</span>
                </label> -->
                เลือก
            </th>
         ...
         <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
            <tr class="xCNTextDetail2" >
                <td class="xRefIntTd text-center">
                    <label class="fancy-checkbox ">
                        <input type="checkbox" class="ocbRefIntDocDT" name="ocbRefIntDocDT[]" value="<?=$aValue['FNXsdSeqNo']?>" <?=($nKey == '0') ? 'checked' : '' ?>>
                        <span class="">&nbsp;</span>
                    </label>
                </td>

<div class="panel panel-headline"> <!-- เพิ่ม -->
    <div class="panel-heading">
        <section id="ostSearchPromotion">
            <div class="row">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <input 
                                ...
                                name="oetSearchAll" 
                                placeholder="<?= language('document/purchasereturn/purchasereturn', 'tPNFillTextSearch') ?>" 
                                onkeyup="javascript: if(event.keyCode == 13) {JSvCallPagePNPdtDataTable()}" 
                                autocomplete="off">
                            <span class="input-group-btn">
                                <button type="button" class="btn xCNBtnDateTime" onclick="JSvCallPagePNPdtDataTable()">
                ...
                <a id="oahPNAdvanceSearch" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;"><?php echo language('common/main/main', 'tAdvanceSearch'); ?></a>
                <a id="oahPNSearchReset" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;" onclick="JSxPNClearSearchData()"><?php echo language('common/main/main', 'tClearSearch'); ?></a>
            </div>

            <div class="row hidden" id="odvPNAdvanceSearchContainer" style="margin-bottom:20px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input 
                                    ...
                                    value="<?= $tBCHName; ?>" >
                                <span class="input-group-btn" >
                                    <button id="obtPNBrowseBchFrom" type="button" class="btn xCNBtnBrowseAddOn" >
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-6 no-padding padding-left-15">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn" >
                                    <button id="obtPNBrowseBchTo" type="button" class="btn xCNBtnBrowseAddOn" >
                                        <img src="<?php echo base_url() . 'application/modules/common/assets/images/icons/find-24.png' ?>">
                                    </button>
                                </span>
                            </div>
                ...
                <div class="col-xs-12 col-md-2 col-lg-2">
                    <div class="col-lg-12 col-md-12 col-xs-12 no-padding">
                        <label class="xCNLabelFrm"><?php echo language('document/transferwarehouseout/transferwarehouseout', 'tPNTBStaDoc'); ?></label>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-xs-12 col-md-2 col-lg-2">
                    ...
                    <div class="form-group">
                        <select class="selectpicker form-control" id="ocmDocType" name="ocmDocType">
                            ...
                            <option value='1'><?php echo language('document/purchasereturn/purchasereturn', 'tPNSendAndReceive'); ?></option>
                            <option value='2'><?php echo language('document/purchasereturn/purchasereturn', 'tPNProductAmount'); ?></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-md-2 col-lg-2">
                    <div class="col-lg-12 col-md-12 col-xs-12 no-padding">
                        <label class="xCNLabelFrm"><?php echo language('document/transferwarehouseout/transferwarehouseout', 'tPNTBStaPrc'); ?></label>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group" style="width: 60%;">
                        ...
                        <button id="oahPNAdvanceSearchSubmit" class="btn xCNBTNPrimery" style="width:100%" onclick="JSvCallPagePNPdtDataTable()"><?php echo language('common/main/main', 'tSearch'); ?></button>
                    </div>
                </div>
    ...
    <div class="panel-heading"> <!-- เพิ่ม -->
        <div class="row">
            ...
            <div class="col-xs-4 col-md-8 col-lg-8 text-right" style="margin-top:-35px;">
                <div id="odvPNMngTableList" class="btn-group xCNDropDrownGroup">
    ...
    <div class="panel-body">
        <section id="odvContentPNList"></section>
    </div>
</div>

<script src="<?php echo base_url('application/modules/common/assets/js/jquery.mask.js') ?>"></script>
<script src="<?php echo base_url('application/modules/common/assets/src/jFormValidate.js') ?>"></script>
<?php include('script/jPurchasereturnFormSearchList.php'); ?>

                    ...
                    <?php if($aDataList['rtCode'] == 1 ):?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            <tr class="xWPNDisChgTrTag">
                                <input type="hidden" class="xWPNDisChgCreatedAt" value="<?php echo $aValue['FDXtdDateIns']; ?>">
                                <td nowrap class="text-center"><label class="xWPNDisChgIndex"><?php echo $aValue['FNRowID']; ?></label></td>
                                <td nowrap class="text-right"><label class="xWPNDisChgBeforeDisChg"></label></td>
                                <td nowrap class="text-right"><label class="xWPNDisChgValue"></label></td>
                                <td nowrap class="text-right"><label class="xWPNDisChgAfterDisChg"><?php echo $aValue['FNRowID']; ?></label></td>
                                <td nowrap style="padding-left: 5px !important;">
                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                        <select class="dischgselectpicker form-control xWPNDisChgType" onchange="JSxPNCalcDisChg(this);" value="<?php echo $aValue['FNRowID']; ?>">
                                ...
                                <td nowrap style="padding-left: 5px !important;">
                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                        <input 
                                            ...
                                            onchange="JSxPNCalcDisChg(this); JCNxPNDisChgSetCreateAt(this)"
                        ...
                        <?php endforeach;?>
                    <?php else:?>
                        <tr id="otrPNDisChgHDNotFound"><td class="text-center xCNTextDetail2" colspan='100%'><?php echo language('common/main/main','tCMNNotFoundData')?></td></tr>
                    <?php endif;?>
...
<?php if($aDataList['rnAllPage'] > 1) : ?>
    <div class="row" id="odvPNDisChgHDList">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <div class="xWPage btn-toolbar pull-right">
                ...
                <button onclick="JSvPNDisChgHDClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
                ...
                <?php for($i=max($nPage-2, 1); $i<=max(0, min($aDataList['rnAllPage'],$nPage+2)); $i++){?>
                    ...
                    ?>
                    <button onclick="JSvPNDisChgHDClickPage('<?php echo $i?>')" type="button" class="btn xCNBTNNumPagenation <?php echo $tActive ?>" <?php echo $tDisPageNumber ?>><?php echo $i?></button>
                <?php } ?>

                <?php if($nPage >= $aDataList['rnAllPage']){  $tDisabledRight = 'disabled'; }else{  $tDisabledRight = '-';  } ?>
                <button onclick="JSvPNDisChgHDClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>

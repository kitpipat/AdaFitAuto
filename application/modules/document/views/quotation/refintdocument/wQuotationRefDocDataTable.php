                    ...
                    <?php if($aDataList['rtCode'] == 1 ):?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            ...
                            <tr style="cursor:pointer;" class="text-center xCNTextDetail2 xWPIDocItems xDocuemntRefInt" 
                                    ...
                                    data-vatinroex="1"
                                    data-cstcode="<?=$aValue['FTCstCode']?>"
                                    data-cstname="<?=$aValue['FTCstName']?>"
                                    data-csttaxno="<?=$aValue['FTCstTaxNo']?>"
                                    data-csttel="<?=$aValue['FTCstTel']?>"
                                    data-cstemail="<?=$aValue['FTCstEmail']?>"
                                    data-cstaddl="<?=$aValue['FTAddV2Desc1']?>">
...
<?php include('script/jQuotationRefDocDataTable.php')?>

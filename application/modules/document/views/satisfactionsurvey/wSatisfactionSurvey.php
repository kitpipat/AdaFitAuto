<style>
            ...
            <div class="row xCNavRow" style="width:inherit;">
                <div class="col-xs-12 col-md-6">
                    <ol id="oliSatMenuNav" class="breadcrumb"> 
                        <?php FCNxHADDfavorite('docSatisfactionSurvey');?> 
                        <li id="oliSatTitle" class="active" style="cursor:pointer" onclick="JSvSatSvCallPageList()"><?= language('document/satisfactionsurvey/satisfactionsurvey','tSatSurveyTitle')?></li> 
                        <li id="oliSatTitleAdd" class="active"><a><?= language('document/satisfactionsurvey/satisfactionsurvey','tSatSurveyTitleAdd')?></a></li>
                        <li id="oliSatTitleViewData" class="active"><a><?= language('document/satisfactionsurvey/satisfactionsurvey','tSatSurveyViewData')?></a></li>
                        <li id="oliSatTitleEdit" class="active"><a><?php echo language('document/deliveryorder/deliveryorder', 'tDOTitleEdit'); ?></a></li>
                    </ol>
                </div>
                <div class="col-xs-12 col-md-6 text-right p-r-0"> 
                    ...
                    <div id="odvBtnAddEdit">
                        <div class="demo-button xCNBtngroup" style="width:100%;">
                            ...
                            <button id="obtSatSvPrintDoc" onclick="JSxSatSvPrintDoc()" class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button"> <?php echo language('common/main/main', 'tCMNPrint'); ?></button>
                            ...
                            <div  id="odvSatSvBtnGrpSave" class="btn-group">
                                <button id="obtSatSvSubmitFromDoc" type="button" class="btn xWBtnGrpSaveLeft"> <?php echo language('common/main/main', 'tSave'); ?></button>
                                <?php echo $vBtnSave ?>
                            </div>
                        </div>
                    </div>
    ...
    <div class="main-content">
        <div id="odvSatSvPageDocument">
        </div>
    </div>

<script type="text/javascript" src="<?php echo base_url(); ?>application/modules/document/assets/src/satisfactionsurvey/jSatisfactionsurvey.js"></script>
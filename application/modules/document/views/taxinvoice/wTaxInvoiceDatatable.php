            ...
            <table class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        ...
                        <th class="xCNTextBold"><?=language('document/taxinvoice/taxinvoice','ราคา / หน่วย')?></th>
                    ...
                    <?php if($aGetDT['rtCode'] == 1):?>
                        <?php foreach($aGetDT['raItems'] as $nKey => $aValue): ?>
                            <tr class="text-center xCNTextDetail2">  
                                ...
                                <td class="text-right"><label><?=number_format($aValue['FCXsdSetPrice'],$nOptDecimalShow)?></label></td>

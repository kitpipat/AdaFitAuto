                ...
                <div id="odvTWIDataConditionREF" class="xCNMenuPanelData panel-collapse collapse in" role="tabpanel">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="oetTAXRefIntDoc" name="oetTAXRefIntDoc" maxlength="20" readonly value="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control xCNDatePicker xCNInputMaskDate" id="oetTAXRefIntDocDate" name="oetTAXRefIntDocDate" placeholder="YYYY-MM-DD" readonly value="">
                        </div>

                        <!-- อ้างอิงเลขที่เอกสารภายนอก -->
                        <div class="form-group">
                            <label class="xCNLabelFrm"><?= language('document/taxinvoice/taxinvoice', 'tTAXLabelFrmRefExtDoc'); ?></label>
                            <input type="text" class="form-control" id="oetTAXRefExtDoc" name="oetTAXRefExtDoc" readonly value="">
                        </div>

                        <!-- วันที่เอกสารภายนอก -->
                        <div class="form-group">
                            <label class="xCNLabelFrm"><?= language('document/taxinvoice/taxinvoice', 'tTAXLabelFrmRefExtDocDate'); ?></label>
                            <input type="text" class="form-control xCNDatePicker xCNInputMaskDate" id="oetTAXRefExtDocDate" name="oetTAXRefExtDocDate" placeholder="YYYY-MM-DD" readonly value="">
                        </div>
                    </div>
                </div>
            </div>
...
<div id="odvTAXModalAddDocRef" class="modal fade" tabindex="-1" role="dialog" style="z-index: 1045;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="ofmTAXFormAddDocRef" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                <div class="modal-header xCNModalHead">
                    <label class="xCNTextModalHeard"><?php echo language('common/main/main', 'อ้างอิงเอกสาร') ?></label>
                </div>
                <div class="modal-body">
                    <input type="text" class="form-control xCNHide" id="oetTAXRefDocNoOld" name="oetTAXRefDocNoOld">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-xs-12">
                            <div class="form-group">
                                <label class="xCNLabelFrm"><?php echo language('common/main/main', 'ประเภทการอ้างอิงเอกสาร'); ?></label>
                                <select class="selectpicker form-control" id="ocbTAXRefType" name="ocbTAXRefType">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-xs-12 xWShowRefInt">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control xCNHide xCNInputWithoutSpcNotThai xCNInputWithoutSingleQuote" id="oetTAXDocRefInt" name="oetTAXDocRefInt" maxlength="20" value="">
                                    <input type="text" class="form-control xWPointerEventNone" id="oetTAXDocRefIntName" name="oetTAXDocRefIntName" maxlength="20" placeholder="<?php echo language('common/main/main', 'เลขที่เอกสารอ้างอิง') ?>" value="" readonly>
                                    <span class="input-group-btn">
                                        <button id="obtTAXBrowseRefDoc" type="button" class="btn xCNBtnBrowseAddOn">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-xs-12 xWShowRefExt">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="oetTAXRefDocNo" name="oetTAXRefDocNo" placeholder="<?php echo language('common/main/main', 'เลขที่เอกสารอ้างอิง'); ?>" maxlength="20" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control xCNDatePicker xCNInputMaskDate" id="oetTAXRefDocDate" name="oetTAXRefDocDate" placeholder="YYYY-MM-DD" autocomplete="off">
                                    <span class="input-group-btn">
                                        <button id="obtTAXRefDocDate" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-xs-12 xWShowRefExt">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="oetTAXRefKey" name="oetTAXRefKey" placeholder="<?php echo language('common/main/main', 'ค่าอ้างอิง'); ?>" maxlength="10" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button id="obtTAXConfirmAddDocRef" class="btn xCNBTNPrimery xCNBTNPrimery2Btn" type="submit"><?php echo language('common/main/main', 'tModalConfirm') ?></button>
...
<script>
    ...
    function JSxSelectABB(ptType, ptDocument, ptCustomer, ptCusName) {
        if (ptType == 'KEY') {
            ...
            var tDocDate        = $('#otbSelectABB tbody tr.xCNActive').attr('data-docdate');
            $('#oetTAXABBCode').val(tDocumentABB);

            //เอกสารอ้างอิง
            $('#oetTAXDocRefInt').val(tDocumentABB);
            $('#oetTAXDocRefIntName').val(tDocumentABB);
            $('#oetTAXRefDocDate').val(tDocDate);
...
<script>
    ...
    $('#obtSaveDocument').off('click').on('click', function() {
        ...
        $.ajax({
            ...
            success: function() {
                ...
                // หลังจากกดบันทึก ให้เพิ่มไฟล์แนบ
                var oDOCallDataTableFile = {
                    ptElementID : 'odvTAXShowDataTable',
                    ptBchCode   : tBrowseBchCode,
                    ptDocNo     : ptTaxNumberFull,
                    ptDocKey    : 'TPSTTaxHD'
                }
    ...
    $('#obtTAXAddDocRef').off('click').on('click',function(){
        JSxTAXEventClearValueInFormHDDocRef();
        $('#odvTAXModalAddDocRef').modal('show');
    });

    //เคลียร์ค่า
    function JSxTAXEventClearValueInFormHDDocRef(){
        $('#oetTAXRefDocNo').val('');
        $('#oetTAXRefDocDate').val('');
        $('#oetTAXDocRefInt').val('');
        $('#oetTAXDocRefIntName').val('');
        $('#oetTAXRefKey').val('');
    }

    //Default โชว์ panel ตามประเภท (ภายใน หรือ ภายนอก)
    JSxTAXEventCheckShowHDDocRef();
    function JSxTAXEventCheckShowHDDocRef(){
        var tTAXRefType = $('#ocbTAXRefType').val();
        if( tTAXRefType == '1' ){
            $('.xWShowRefExt').hide();
            $('.xWShowRefInt').show();
        }else{
    ...
    $('#ocbTAXRefType').off('change').on('change',function(){
        $(this).selectpicker('refresh');
        JSxTAXEventCheckShowHDDocRef();
    });

    //กดเลือกอ้างอิงเอกสารภายใน (ใบรับรถ , ใบสั่งาน)
    $('#obtTAXBrowseRefDoc').unbind().click(function(){
        var nStaSession = JCNxFuncChkSessionExpired();
        if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
            $('#odvTAXModalSelectABB').modal('show');
            JCNxSearchBrowseABB(1);

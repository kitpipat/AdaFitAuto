                    ...
                    <?php 
                        if(FCNnHSizeOf($aDataList['raItems'])!=0){
                            foreach($aDataList['raItems'] AS $nKey => $aValue):?>
                                <tr class="text-center xCNTextDetail2 xCNClickABB" data-docdate="<?=$aValue['FDXshDocDate'];?>" data-documentabb="<?=$aValue['FTXshDocNo'];?>" data-customer="<?=$aValue['FTCstCode'];?>" data-customername="<?=$aValue['FTCstName'];?>" >

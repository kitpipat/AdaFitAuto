                    ...
                    <?php if($aDataList['rtCode'] == 1 ) { ?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            <tr class="xWAPDDisChgTrTag">
                                ...
                                <td nowrap class="text-right"><label class="xWAPDDisChgValue"><?php echo $aValue['FCXtdValue']; ?></label></td>
                                <td nowrap class="text-right"><label class="xWAPDDisChgAfterDisChg"><?php echo $aValue['FCXtdNet']; ?></label></td>
...
<?php if($aDataList['rnAllPage'] > 1) : ?>
    <div class="row" id="odvAPDDisChgDTList">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <div class="xWPage btn-toolbar pull-right">
                ...
                <button onclick="JSvAPDDisChgDTClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
                ...
                <?php for($i=max($nPage-2, 1); $i<=max(0, min($aDataList['rnAllPage'],$nPage+2)); $i++){?>
                    ...
                    ?>
                    <button onclick="JSvAPDDisChgDTClickPage('<?php echo $i?>')" type="button" class="btn xCNBTNNumPagenation <?php echo $tActive ?>" <?php echo $tDisPageNumber ?>><?php echo $i?></button>
                <?php } ?>

                <?php if($nPage >= $aDataList['rnAllPage']){  $tDisabledRight = 'disabled'; }else{  $tDisabledRight = '-';  } ?>
                <button onclick="JSvAPDDisChgDTClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>

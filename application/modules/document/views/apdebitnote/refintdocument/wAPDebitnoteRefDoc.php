...
<section>
            ...
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPOLabelFrmBranch')?></label>
                <div class="input-group">
                    <input
                        ...
                        id="oetAPDRefIntBchCode"
                        name="oetAPDRefIntBchCode"
                        maxlength="5"
                        value="<?=$tBCHCode?>"
                        data-bchcodeold = ""
                    >
                    <input
                        ...
                        id="oetAPDRefIntBchName"
                        name="oetAPDRefIntBchName"
                        maxlength="100"
                        value="<?=$tBCHName?>"
                        readonly
                    >
                    ...
                    <span class="input-group-btn xWConditionSearchPdt">
                        <button id="obtAPDBrowseBchRefIntDoc" type="button" class="btn xCNBtnBrowseAddOn "    >
        ...
        <div class="form-group">
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPOTBDocNo')?></label>
                <input
                    type="text"
                    class="form-control"
                    id="oetAPDRefIntDocNo"
                    name="oetAPDRefIntDocNo"
                    maxlength="100"
                    value=""
    ...
    <div class="col-md-2 col-xs-2 col-sm-2">
        <div class="form-group">
                    <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateFrm')?></label>
                            ...
                            <input
                                type="text"
                                class="form-control xCNDateAPDcker xCNInputMaskDate"
                                id="oetAPDRefIntDocDateFrm"
                                name="oetAPDRefIntDocDateFrm"
                                placeholder="YYYY-MM-DD"
                                value=""
                            >
                            <span class="input-group-btn">
                                <button id="obtAPDBrowseRefExtDocDateFrm" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                            </span>
                        </div>
                    </div>
        </div>
            ...
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateTo')?></label>
                <div class="input-group">
                    <input
                        type="text"
                        class="form-control xCNDateAPDcker xCNInputMaskDate"
                        id="oetAPDRefIntDocDateTo"
                        name="oetAPDRefIntDocDateTo"
                        placeholder="YYYY-MM-DD"
                        value=""
                    >
                    <span class="input-group-btn">
                        <button id="obtAPDBrowseRefExtDocDateTo" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-2 col-xs-2 col-sm-2">
        <div class="form-group">
            ...
            <select class="selectpicker form-control  " id="oetAPDRefIntStaDoc" name="oetAPDRefIntStaDoc" maxlength="1" value="<?php echo $tAPDSplPayMentType;?>">
...
<?php include('script/jAPDebitnoteRefDoc.php');?>
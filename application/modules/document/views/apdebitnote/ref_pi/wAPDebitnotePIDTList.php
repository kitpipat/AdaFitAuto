...
<div class="row">
                    ...
                    <?php if($aDataList['rtCode'] == 1 ):?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            <tr 
                                ...
                                id="otrAPDPIDTDoc<?php echo $aValue['FNRowID']; ?>" 
                                ...
                                <td>
                                    <div class="form-group" style="margin-bottom: 0px !important;">
                                        <label class="fancy-checkbox">
                                            <input type="checkbox" checked="true" class="xWAPDSelectPIDTItem">
                                            <span>&nbsp;</span>
                                        </label>
                                    </div>
                                </td>
    ...
    <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
        ...
        <div class="form-group">
            <label class="fancy-checkbox">
                <input type="checkbox" value="1" id="ocbAPDSelectAll" name="ocbAPDSelectAll" maxlength="1" checked="true" onclick="JSxAPDSelectPIDTAll(this)">
                <span>&nbsp;</span>
...
<?php if($aDataList['rnAllPage'] > 1) : ?>
    <div class="row" id="odvAPDPIDTList">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <div class="xWPage btn-toolbar pull-right">
                ...
                <button onclick="JSvAPDPIDTClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>>
                ...
                <?php for($i=max($nPage-2, 1); $i<=max(0, min($aDataList['rnAllPage'],$nPage+2)); $i++){?>
                    ...
                    ?>
                    <button onclick="JSvAPDPIDTClickPage('<?php echo $i?>')" type="button" class="btn xCNBTNNumPagenation <?php echo $tActive ?>" <?php echo $tDisPageNumber ?>><?php echo $i?></button>
                <?php } ?>

                <?php if($nPage >= $aDataList['rnAllPage']){  $tDisabledRight = 'disabled'; }else{  $tDisabledRight = '-';  } ?>
                <button onclick="JSvAPDPIDTClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>>

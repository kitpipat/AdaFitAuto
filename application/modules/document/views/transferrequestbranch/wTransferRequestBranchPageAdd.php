<?php
    ...
    if(isset($aDataDocHD) && $aDataDocHD['rtCode'] == '1'){
        ...
        $tTRBAgnCode             = $this->session->userdata("tSesUsrAgnCode");
        $tTRBAgnName             = $this->session->userdata("tSesUsrAgnName");
        $tTRBAgnCodeTo           = $this->session->userdata("tSesUsrAgnCode");
        $tTRBAgnNameTo           = $this->session->userdata("tSesUsrAgnName");
        $tTRBBchCodeTo           = "";
        $tTRBBchNameTo           = "";
        $tTRBWahCodeTo           = "";
        $tTRBWahNameTo           = "";
        $tTRBAgnCodeShip         = $this->session->userdata("tSesUsrAgnCode");
        $tTRBAgnNameShip         = $this->session->userdata("tSesUsrAgnName");
        $tTRBBchCodeShip         = "";
        $tTRBBchNameShip         = "";
        $tTRBWahCodeShip         = "";
        $tTRBWahNameShip         = "";
                                ...
                                <script type="text/javascript">
                                    ...
                                    if( tUsrLevel != "HQ" ){
                                        ...
                                        if(tAgnCode != ""){
                                            ...
                                            $('#oimTRBBrowseAgnTo').attr("disabled", true);
                                            $('#oimTRBBrowseAgnShip').attr("disabled", true);
                                        }

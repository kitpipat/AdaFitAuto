            ...
            <div class="row xCNavRow" style="width:inherit;">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <ol id="oliTRBMenuNav" class="breadcrumb">
                        ...
                        <li id="oliTRBTitle" style="cursor:pointer;"><?=language('document/transferrequestbranch/transferrequestbranch', 'tTRBTitleMenu'); ?></li>
                        <li id="oliTRBTitleAdd" class="active"><a><?=language('document/transferrequestbranch/transferrequestbranch', 'tTRBTitleAdd'); ?></a></li>
                        <li id="oliTRBTitleEdit" class="active"><a><?=language('document/transferrequestbranch/transferrequestbranch', 'tTRBTitleEdit'); ?></a></li>
                        <li id="oliTRBTitleDetail" class="active"><a><?=language('document/transferrequestbranch/transferrequestbranch', 'tTRBTitleDetail'); ?></a></li>
                        <li id="oliTRBTitleAprove" class="active"><a><?=language('document/transferrequestbranch/transferrequestbranch', 'tTRBTitleAprove'); ?></a></li>
                    </ol>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right p-r-0">
                    <div class="demo-button xCNBtngroup" style="width:100%;">
                        ...
                        <div id="odvTRBBtnGrpAddEdit">
                            <div class="demo-button xCNBtngroup" style="width:100%;">
                                <button id="obtTRBJumpToPageTBO" onclick="JSxTRBJumpToPageTBO()" class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button"> <?=language('common/main/main', 'จ่ายโอนสินค้า'); ?></button>
                                ...
                                <?php if ($aAlwEvent['tAutStaFull'] == 1 || ($aAlwEvent['tAutStaAdd'] == 1 || $aAlwEvent['tAutStaEdit'] == 1)): ?>
                                    <button id="obtTRBPrintDoc" onclick="JSxTRBPrintDoc()" class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button"> <?=language('common/main/main', 'tCMNPrint'); ?></button>

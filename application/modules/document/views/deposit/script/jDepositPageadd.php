<script>
    $(document).ready(function() {
        ...
        $("#obtDEPSubmitFromDoc").removeAttr("disabled");
     ...
     * Return Type : -
     */
    function JSxDepositSave(ptType = '') {
        var nStaSession = JCNxFuncChkSessionExpired();
        $("#obtDEPSubmitFromDoc").attr('disabled','true');
        if (typeof nStaSession !== "undefined" && nStaSession == 1) {
    ...
    function JSxDepositPrintDoc(){
        ...
        window.open('<?=base_url()?>'+"formreport/Frm_SQL_FCBnkDeposit_New?infor="+JCNtEnCodeUrlParameter(aInfor), '_blank');
    }
</script>

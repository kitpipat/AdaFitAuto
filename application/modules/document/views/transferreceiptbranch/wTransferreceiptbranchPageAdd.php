...
<form id="ofmTransferreceiptFormAdd" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" id="ohdTBIAutStaCancel"    name="ohdTBIAutStaCancel" value="<?=@$aAlwEvent['tAutStaCancel'];?>">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control xCNDatePicker xCNInputMaskDate xControlForm" id="oetTBIDocDate" name="oetTBIDocDate" value="<?= $dTBIDocDate; ?>" data-validate-required="<?= language('document/transferreceiptbranch/transferreceiptbranch', 'tASTPlsEnterDocDate'); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control xCNTimePicker xControlForm" id="oetTBIDocTime" name="oetTBIDocTime" value="<?= $dTBIDocTime; ?>" data-validate-required="<?= language('document/transferreceiptbranch/transferreceiptbranch', 'tTBIPlsEnterDocTime'); ?>">
                                        <span class="input-group-btn">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control xWPointerEventNone" id="oetTBIBchName" name="oetTBIBchName" placeholder="<?= language('document/transferreceiptbranch/transferreceiptbranch', 'tTBIBranch') ?>" value="<?php echo @$tTBIBchName ?>" readonly>
                                        <span class="input-group-btn">
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div id="odvTBI_5" class="row" style="display:none;">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        <label class="xCNLabelFrm"><span style="color:red">*</span><?= language('document/transferreceiptbranch/transferreceiptbranch', 'tTBIBrowsDocTBO') ?></label>
                                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control xWPointerEventNone" id="oetTBIBchNameTo" name="oetTBIBchNameTo" placeholder="<?= language('document/transferreceiptbranch/transferreceiptbranch', 'tTBIBranch') ?>" value="<?php echo @$tTBIBchNameTo ?>" readonly>
                                                        <span class="input-group-btn">
                ...
                <div id="odvTBIDataConditionREF" class="xCNMenuPanelData panel-collapse collapse" role="tabpanel">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="20" class="form-control xControlForm" id="oetTBIRefExtDoc" placeholder="<?= language('document/saleorder/saleorder', 'tSOLabelFrmRefExtDoc'); ?>"  name="oetTBIRefExtDoc" value="<?= $tTBIRefExt ?>">
                        </div>
                        <!-- วันที่เอกสารภายนอก -->
                        <div class="form-group">
                            <label class="xCNLabelFrm"><?= language('document/saleorder/saleorder', 'tSOLabelFrmRefExtDocDate'); ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control xCNDatePicker xCNInputMaskDate xControlForm" id="oetTBIRefExtDocDate" name="oetTBIRefExtDocDate" placeholder="YYYY-MM-DD" value="<?= $tTBIRefExtDate ?>">
                                <span class="input-group-btn">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control xCNInputWOthoutSpc xCNApvOrCanCelDisabled" maxlength="100" id="oetTBITransportCtrName" name="oetTBITransportCtrName" value="<?= $tTBICtrName; ?>" placeholder="<?= language('document/producttransferwahouse/producttransferwahouse', 'tTFWCtrName'); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control xCNInputWOthoutSpc xCNApvOrCanCelDisabled" maxlength="20" id="oetTBITransportRefTnfID" name="oetTBITransportRefTnfID" value="<?= $tTBIRefTnfID; ?>" placeholder="<?= language('document/producttransferwahouse/producttransferwahouse', 'tTFWRefTnfID'); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control xCNInputWOthoutSpc xCNApvOrCanCelDisabled" maxlength="50" id="oetTBITransportRefVehID" name="oetTBITransportRefVehID" value="<?= $tTBIRefVehID; ?>" placeholder="<?= language('document/producttransferwahouse/producttransferwahouse', 'tTFWRefVehID'); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control xCNInputWOthoutSpc xCNApvOrCanCelDisabled" maxlength="30" id="oetTBITransportQtyAndTypeUnit" name="oetTBITransportQtyAndTypeUnit" value="<?= $tTBIQtyAndTypeUnit; ?>" placeholder="<?= language('document/producttransferwahouse/producttransferwahouse', 'tTFWQtyAndTypeUnit'); ?>">
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel panel-default" style="margin-bottom: 25px;">
                ...
                <div id="odvTBIDataConditionETC" class="xCNMenuPanelData panel-collapse collapse" role="tabpanel">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="fancy-checkbox">
                                <input class="xCNApvOrCanCelDisabled" type="checkbox" id="ocbTBIStaDocAct" name="ocbTBIStaDocAct" maxlength="1" value="1" 
                                <?php echo $nTBIStaDocAct == '' ? 'checked' : $nTBIStaDocAct == '1' ? 'checked' : '0'; ?>
                                >
                                <span>&nbsp;</span>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button type="button" class="btn xCNBtnDateTime" onclick="JSvTBIDOCFilterPdtInTableTemp()">
...
<script type="text/javascript">
    $(function(){var e=$("#ocmSelectTransTypeIN").val();3==e?($("#odvINWhereSPL").css("display","block"),$("#odvINWhereETC").css("display","none")):4==e&&($("#odvINWhereSPL").css("display","none"),$("#odvINWhereETC").css("display","block"))});
</script>

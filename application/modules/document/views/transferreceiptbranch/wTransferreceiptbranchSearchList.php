                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                        <div class="form-group" style="width: 60%;">
                            ...
                            <button id="obtTWISubmitFrmSearchAdv" class="btn xCNBTNPrimery" style="width:100%" onclick="JSvTBICallPageTransferReceiptDataTable(1)"><?php echo language('common/main/main', 'tSearch'); ?></button>
                        </div>
                    </div>

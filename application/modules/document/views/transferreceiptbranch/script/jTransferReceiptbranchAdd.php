<script type="text/javascript">
    ...
    var oBrowseTBIBPdtIntBranchBrows = {
        ...
        Join: {
            Table: ['TCNMBranch_L', 'TCNMWaHouse_L', 'TCNTPdtTboHDRef', 'TCNTPdtTbiHD'],
            On: [
                ...
                'TCNTPdtIntDTBch.FTXthDocNo = TCNTPdtTbiHD.FTXthRefInt '
            ]
        },
        Where: {
            Condition: []
    ...
    $('#oetTBIDocReferBrows').unbind().click(function() {
        ...
        oBrowseTBIBPdtIntBranchBrows.Where.Condition = ["AND TCNTPdtIntDTBch.FTXthBchTo = '" + tTBIBchCode + "' AND  ISNULL(TCNTPdtIntDTBch.FTXtdRvtRef,'') = '' AND ISNULL( TCNTPdtTbiHD.FTXthRefInt, '' ) = '' AND TCNTPdtIntDTBch.FNXtdSeqNo = 1 "];

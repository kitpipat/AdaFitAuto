                    ...
                    <?php if($aDataList['rtCode'] == 1 ):?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            ...
                            <tr style="cursor:pointer;" class="text-center xCNTextDetail2 xWPIDocItems xPurchaseInvoiceRefInt" 
                                    ...
                                    data-cashorcrd="<?php echo $aValue['FTXphCshOrCrd']?>"
                                    data-vatinroex="<?php echo $aValue['FTXphVATInOrEx']?>"
                                    data-crtrem="<?php echo $aValue['FNXphCrTerm']?>"
                                    data-duedate="<?php echo $aValue['FDXphDueDate']?>"
                                    data-ctrname="<?php echo $aValue['FTXphCtrName']?>"
                                    data-reftno="<?php echo $aValue['FTXphRefTnfID']?>"
                                    data-reftdate="<?php echo $aValue['FDXphTnfDate']?>"
                                    data-billdate="<?php echo $aValue['FDXshRefDocDate']?>"
                                    data-vehid="<?php echo $aValue['FTXphRefVehID']?>"
...
<?php include('script/jCreditNoteRefDocDataTable.php')?>

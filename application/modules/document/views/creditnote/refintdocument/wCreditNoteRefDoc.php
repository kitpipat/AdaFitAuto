...
<section>
            ...
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPOLabelFrmBranch')?></label>
                <div class="input-group">
                    <input
                        ...
                        id="oetPiRefIntBchCode"
                        name="oetPiRefIntBchCode"
                        maxlength="5"
                        value="<?=$tBCHCode?>"
                        data-bchcodeold = ""
                    >
                    <input
                        ...
                        id="oetPiRefIntBchName"
                        name="oetPiRefIntBchName"
                        maxlength="100"
                        value="<?=$tBCHName?>"
                        readonly
                    >
                    <span class="input-group-btn xWConditionSearchPdt">
                        <button id="obtPiBrowseBchRefIntDoc" type="button" class="btn xCNBtnBrowseAddOn "    >
        ...
        <div class="form-group">
                    <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateFrm')?></label>
                            ...
                            <input
                                ...
                                id="oetPiRefIntDocDateFrm"
                                name="oetPiRefIntDocDateFrm"
                                placeholder="YYYY-MM-DD"
                                value=""
                            >
                            <span class="input-group-btn">
                                <button id="obtPiBrowseRefExtDocDateFrm" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                            </span>
                        </div>
                    </div>
        </div>
            ...
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateTo')?></label>
                <div class="input-group">
                    <input
                        type="text"
                        class="form-control xCNDatePicker xCNInputMaskDate"
                        id="oetPiRefIntDocDateTo"
                        name="oetPiRefIntDocDateTo"
                        placeholder="YYYY-MM-DD"
                        value=""
                    >
                    <span class="input-group-btn">
                        <button id="obtPiBrowseRefExtDocDateTo" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-2 col-xs-2 col-sm-2">
        <div class="form-group">
            ...
            <select class="selectpicker form-control  " id="oetPiRefIntStaDoc" name="oetPiRefIntStaDoc" maxlength="1" value="<?php echo $tPiSplPayMentType;?>">
...
<?php include('script/jCreditNoteRefDoc.php');?>
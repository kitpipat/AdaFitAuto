...
<input id="oetCRPJumpDocNo"             type="hidden" value="<?= $tDocNo ?>">
<input id="oetCRPJumpBchCode"           type="hidden" value="<?= $tBchCode ?>">
<input id="oetCRPJumpAgnCode"           type="hidden" value="<?= $tAgnCode ?>">
            ...
            <div class="xCNCreditNoteVMaster">
                <div class="col-xs-12 col-md-5">
                    <ol id="oliMenuNav" class="breadcrumb">
                        ...
                        <li id="oliCreditNoteTitleDetail" class="active"><a href="javascript:;"><?= language('document/creditnote/creditnote', 'tCreditNoteTitleDetail') ?></a></li>
                    </ol>
                </div>

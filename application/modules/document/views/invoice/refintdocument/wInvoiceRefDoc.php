...
<section>
            ...
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPOLabelFrmBranch')?></label>
                <div class="input-group">
                    <input
                        ...
                        id="oetIVRefIntBchCode"
                        name="oetIVRefIntBchCode"
                        maxlength="5"
                        value="<?=$tBCHCode?>"
                    >
                    <input
                        ...
                        id="oetIVRefIntBchName"
                        name="oetIVRefIntBchName"
                        maxlength="100"
                        value="<?=$tBCHName?>"
                        readonly
                    >
                    <span class="input-group-btn xWConditionSearchPdt">
                        <button id="obtIVBrowseBchRefIntDoc" type="button" class="btn xCNBtnBrowseAddOn">
        ...
        <div class="form-group">
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateFrm')?></label>
                    ...
                    <input
                        ...
                        id="oetIVRefIntDocDateFrm"
                        name="oetIVRefIntDocDateFrm"
                        placeholder="YYYY-MM-DD"
                        value=""
                    >
                    <span class="input-group-btn">
                        <button id="obtIVBrowseRefExtDocDateFrm" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                    </span>
                </div>
            </div>
        </div>
            ...
            <label class="xCNLabelFrm"><?php echo language('document/purchaseorder/purchaseorder', 'tPORefIntDocDateTo')?></label>
                <div class="input-group">
                    <input
                        type="text"
                        class="form-control xCNDatePicker xCNInputMaskDate"
                        id="oetIVRefIntDocDateTo"
                        name="oetIVRefIntDocDateTo"
                        placeholder="YYYY-MM-DD"
                        value=""
                    >
                    <span class="input-group-btn">
                        <button id="obtIVBrowseRefExtDocDateTo" type="button" class="btn xCNBtnDateTime"><img class="xCNIconCalendar"></button>
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-2 col-xs-2 col-sm-2">
        <div class="form-group">
            ...
            <select class="selectpicker form-control  " id="oetIVRefIntStaDoc" name="oetIVRefIntStaDoc" maxlength="1" value="<?php echo $tDOSplPayMentType;?>">
...
<?php include('script/jInvoiceRefDoc.php');?>
  ...
  <table class="table xRefIntTable" >
    <thead >
        <tr>
            ...
            <?php if($tIVSPLStaLocal == 1){ //อ้างอิงเอกสารใบรับของ ?>
                <th class="xRefIntTh text-right"><?php echo language('document/purchaseorder/purchaseorder','จำนวน');?></th>
            <?php }else{ //อ้างอิงเอกสารใบสั่งซื้อ ?>
                <?php if($tIVTypeRefDoc == 2){ ?>
                    <th class="xRefIntTh text-right"><?php echo language('document/purchaseorder/purchaseorder','tPOTable_qty');?></th>
                <?php }else{ ?>
                    <th class="xRefIntTh text-right">จำนวนขาย</th>
                <?php } ?>
            <?php } ?>
        </tr>
    </thead>

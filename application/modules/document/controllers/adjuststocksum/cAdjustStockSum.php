...
class cAdjustStockSum extends MX_Controller {
    ...
    public function FSoCSMEventCallPdtStkSum(){
        ...
        $aDataWhere = array(
            ...
            'FTAjhCountType'    => $this->input->post('ptCountType'),
            'FTSessionID'  => $this->session->userdata('tSesSessionID'),
            'FTXthDocKey'  => 'TCNTPdtAdjStkHD',
        );
    ...
    public function FSoCSMEventAdd(){
        try{
            ...
            $aUpdateRefDocSub = array(
                ...
                'FTAjhDocNo'     => $tAjhDocNo,
                'FTAjhCountType' => $this->input->post('oetAdjStkSumBchCode'), 
            );
    ...
    public function FSaCSMEventAppove(){
        ...
        try{
            ...
            $aDataGetDataHD     =   $this->mAdjustStockSum->FSaMAdjStkSumGetHD(array(
                ...
                "params"    => [
                                 ...
                                 "oaTCNTNoti_L" => array(
                                                    0 => array(
                                                        "FNNotID"       => $tNotiID,
                                                        "FNLngID"       => 1,
                                                        "FTNotDesc1"    => 'เอกสารใบตรวจนับรวม #'.$aDataGetDataHD['raItems']['FTAjhDocNo'],
                                                        "FTNotDesc2"    => 'รหัสสาขา '.$aDataGetDataHD['raItems']['FTBchCode'].' ทำการอนุมัติเอกสาร',
                                                    ),
                                                    1 => array(
                                                        "FNNotID"       => $tNotiID,
                                                        "FNLngID"       => 2,
                                                        "FTNotDesc1"    => 'Adjust Stock Sum #'.$aDataGetDataHD['raItems']['FTAjhDocNo'],
    ...
    public function FSaCSMEventHQAppove(){
        ...
        $aStaApv = $this->mAdjustStockSum->FSvMAdjStkSumHDApprove($aDataUpdate); 
                ...
                "params"    => [
                                 ...
                                 "oaTCNTNoti_L" => array(
                                                    0 => array(
                                                        ...
                                                        "FNLngID"       => 1,
                                                        "FTNotDesc1"    => 'เอกสารใบตรวจนับรวม #'.$aDataGetDataHD['raItems']['FTAjhDocNo'],
                                                        "FTNotDesc2"    => 'รหัสสาขา '.$this->session->userdata("tUsrBchHQCode").' HQ ทำการอนุมัติเอกสาร',
                                                    ),
                                                    1 => array(
                                                        "FNNotID"       => $tNotiID,
                                                        "FNLngID"       => 2,
                                                        "FTNotDesc1"    => 'Adjust Stock Sum #'.$aDataGetDataHD['raItems']['FTAjhDocNo'],
                                                        "FTNotDesc2"    => 'Branch code '.$this->session->userdata("tUsrBchHQCode").' HQ Approve document',
                                                    )
                                ),
                                 "oaTCNTNotiAct" => array(
                                                     0 => array( 
                                                            "FNNotID"       => $tNotiID,
                                                            "FDNoaDateInsert" => date('Y-m-d H:i:s'),
                                                            "FTNoaDesc"       => 'รหัสสาขา '.$this->session->userdata("tUsrBchHQCode").' HQ ทำการอนุมัติเอกสาร',
                                                            "FTNoaDocRef"    => $aDataGetDataHD['raItems']['FTAjhDocNo'],
                                                            "FNNoaUrlType"   =>  1,
                                                            "FTNoaUrlRef"    => 'docSM/2/0',
                                                            ),

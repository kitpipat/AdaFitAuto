...
class Transferrequestbranch_controller extends MX_Controller {
    ...
    public function FSoCTRBAddPdtIntoDocDTTemp() {
        try {
            ...
            for ($nI = 0; $nI < FCNnHSizeOf($aDOPdtData); $nI++) {
                ...
                $this->Transferrequestbranch_model->FSaMTRBInsertPDTToTemp($aDataPdtMaster, $aDataPdtParams);
            }
    ...
    public function FSoCTRBEditEventDoc() {
        try {
            ...
            if($aDataDocument['ohdTRBStaApv'] == 1 || $aDataDocument['ohdTRBStaDoc'] == 3){ 
                ...
                $this->Transferrequestbranch_model->FSaMTRBUpdateRmk($aDataUpdate);

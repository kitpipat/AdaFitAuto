...
class cAdjustStockSub extends MX_Controller {
    ...
    public function FSaCAdjStkSubAddEvent(){
        try{
            ...
            if($this->input->post('oetAdjStkSubCountType') == "1"){
                $FDAjhDateFrm = NULL;
                $FDAjhDateTo = NULL;
            }else{
                $FDAjhDateFrm = $this->input->post('oetAdjStkSubDateFrm');
                $FDAjhDateTo = $this->input->post('oetAdjStkSubDateTo');
            }
            ...
            $aDataMaster = array(
                ...
                'FTAjhCountType'        => $this->input->post('oetAdjStkSubCountType'),
    ...
    public function FSaCASTApprove(){
        ...
        $aDataGetDataHD     =   $this->mAdjustStockSub->FSaMAdjStkSubGetHD(array(
            'FTAjhDocNo'    => $this->input->post('tXthDocNo'),
            ...
            "params"    => [
                             ...
                             "oaTCNTNoti_L" => array(
                                                0 => array(
                                                    "FNNotID"       => $tNotiID,
                                                    "FNLngID"       => 1,
                                                    "FTNotDesc1"    => 'เอกสารใบตรวจนับย่อย #'.$aDataGetDataHD['raItems']['FTAjhDocNo'],
                                                    "FTNotDesc2"    => 'รหัสสาขา '.$aDataGetDataHD['raItems']['FTBchCode'].' ทำการอนุมัติเอกสาร',
                                                ),
                                                1 => array(
                                                    "FNNotID"       => $tNotiID,
                                                    "FNLngID"       => 2,
                                                    "FTNotDesc1"    => 'Adjust Stock Sub #'.$aDataGetDataHD['raItems']['FTAjhDocNo'],

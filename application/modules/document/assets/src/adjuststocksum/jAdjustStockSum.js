...
//   JSvCallPageAdjStkSumList();
  ...
  switch(nStaAdjStkSumBrowseType){
    case '2':
        var tAgnCode = $('#oetAdjJumpAgnCode').val();
        var tBchCode = $('#oetAdjJumpBchCode').val();
        var tDocNo = $('#oetAdjJumpDocNo').val();
        JSvCallPageAdjStkSumEdit(tDocNo);
    break;
    default:
        JSvCallPageAdjStkSumList();
}
 ...
 * Return Type : -
 */
 function JSnAdjStkSumHQApprove(pbIsConfirm) {
    var nStaSession = JCNxFuncChkSessionExpired();
    if (typeof nStaSession !== "undefined" && nStaSession == 1) {
        try {
            if (pbIsConfirm) {
                $("#ohdCardShiftTopUpCardStaPrcDoc").val(2); // Set status for processing approve
                $("#odvAdjStkSumHDPopupApv").modal("hide");
               ...
               var tWahCode = $('#oetAdjStkSumWahCode').val();
                ...
                //console.log("StaApvDoc Call Modal");
                $("#odvAdjStkSumHDPopupApv").modal("show");
            }
        } catch (err) {
            console.log("JSnAdjStkSumApprove Error: ", err);
        }
...
function JSoAdjStkSumSubscribeMQ() {
    ...
    var tUsrApv = $("#ohdAdjStkSumProveUser").val();
...
function JSvCallPageAdjStkSumAdd() {
    ...
    function JCNxAdjStkSumControlObjAndBtn() {
        ...
        $("#obtAdjStkSumHQApprove").attr("disabled", false);
        // $('#obtAdjStkSumApprove').show();

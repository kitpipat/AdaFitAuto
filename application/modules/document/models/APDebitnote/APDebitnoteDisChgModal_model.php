...
class APDebitnoteDisChgModal_model extends CI_Model{
     ...
     * Return Type: Array
     */
    public function FSaMAPDGetDisChgHDList($paDataCondition){
     ...
     * Return Type: Array
     */
    public function FSaMAPDGetDisChgDTList($paDataCondition){
        $aRowLen = FCNaHCallLenData($paDataCondition['nRow'],$paDataCondition['nPage']);
        $nLngID = $paDataCondition['FNLngID'];
        $tDocNo = $paDataCondition['tDocNo'];
     ...
     * Return Type : array
     */
    public function FSaMAPDAddEditHDDisTemp($paParams, $paDisChgItems) {
     ...
     * Return Type : array
     */
    public function FSaMAPDDeleteHDDisTemp($paParams) {
        $tDocNo         = $paParams['tDocNo'];
        $tBchCode       = $paParams['tBchCode'];
        $tSessionID     = $paParams['tSessionID'];
        // ลบ ใน Temp
     ...
     * Return Type : array
     */
    public function FSaMAPDGetHDDisTemp($paParams) {
        $tDocNo     = $paParams['tDocNo'];
        $tBchCode   = $paParams['tBchCode'];
        $tSessionID = $paParams['tSessionID'];
        $tSQL = "   SELECT
     ...
     * Return Type : array
     */
    public function FSaMAPDUpdateHDDisTemp($paParams, $paDataUpd){
     ...
     * Return Type : array
     */
    public function FSaMAPDAddEditDTDisTemp($paParams, $paDisChgItems) {
        $tDocNo = $paParams['tDocNo'];
        $tBchCode = $paParams['tBchCode'];
        $tSessionID = $paParams['tSessionID'];
     ...
     * Return Type : array
     */
    public function FSaMAPDDeleteDTDisTemp($paParams) {
     ...
     * Return Type : array
     */
    public function FSaMAPDClearDisChgTxtDTTemp($paParams) {
     ...
     * Return Type : array
     */
    public function FSaMAPDGetDTDisTemp($paParams) {
    ...
    public function FSaMCENGetPriceAlwDiscount($paParams){
        $tSQL = "   SELECT SUM(FCXtdNet) AS Total FROM TCNTDocDTTmp 
                    WHERE TCNTDocDTTmp.FTSessionID    = '".$paParams['tSessionID']."'

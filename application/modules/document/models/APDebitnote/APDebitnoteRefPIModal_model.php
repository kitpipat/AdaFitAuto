...
class APDebitnoteRefPIModal_model extends CI_Model {
     ...
     * Return Type: Array
    */
    public function FSaMAPDGetPIHDList($paDataCondition){
    ...
    */
     ...
     * Return Type: Array
    */
    public function FSaMAPDGetPIDTList($paDataCondition){
        $aRowLen = FCNaHCallLenData($paDataCondition['nRow'],$paDataCondition['nPage']);
        $nLngID = $paDataCondition['FNLngID'];

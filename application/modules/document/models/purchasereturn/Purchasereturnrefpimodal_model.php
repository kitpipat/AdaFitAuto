...
class Purchasereturnrefpimodal_model extends CI_Model {
     ...
     * Return Type: Array
     */
    public function FSaMPNGetPIHDList($paDataCondition){
     ...
     * Return Type: Array
     */
    public function FSaMPNGetPIDTList($paDataCondition){
        $aRowLen = FCNaHCallLenData($paDataCondition['nRow'],$paDataCondition['nPage']);
        $nLngID = $paDataCondition['FNLngID'];

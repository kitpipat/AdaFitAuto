...
class Purchasereturndischgmodal_model extends CI_Model {
     ...
     * Return Type: Array
     */
    public function FSaMPNGetDisChgHDList($paDataCondition){
     ...
     * Return Type: Array
     */
    public function FSaMPNGetDisChgDTList($paDataCondition){
        $aRowLen = FCNaHCallLenData($paDataCondition['nRow'],$paDataCondition['nPage']);
        $nLngID = $paDataCondition['FNLngID'];
        $tDocNo = $paDataCondition['tDocNo'];
     ...
     * Return Type : array
     */
    public function FSaMPNAddEditHDDisTemp($paParams, $paDisChgItems) {
     ...
     * Return Type : array
     */
    public function FSaMPNDeleteHDDisTemp($paParams) {
     ...
     * Return Type : array
     */
    public function FSaMPNGetHDDisTemp($paParams) {
     ...
     * Return Type : array
     */
    public function FSaMPNUpdateHDDisTemp($paParams, $paDataUpd){
     ...
     * Return Type : array
     */
    public function FSaMPNAddEditDTDisTemp($paParams, $paDisChgItems) {
        $tDocNo = $paParams['tDocNo'];
        $tBchCode = $paParams['tBchCode'];
        $tSessionID = $paParams['tSessionID'];
     ...
     * Return Type : array
     */
    public function FSaMPNDeleteDTDisTemp($paParams) {
     ...
     * Return Type : array
     */
    public function FSaMPNClearDisChgTxtDTTemp($paParams) {
     ...
     * Return Type : array
     */
    public function FSaMPNGetDTDisTemp($paParams) {

...
class QuotationDiscount_model extends CI_Model {

    // Functionality    : Get Data HD Dis List
    // Parameters       : function parameters
    // Creator          : 02/07/2021 Supawat
    public function FSaMQTGetDisChgHDList($paDataCondition){
        ...
        if($oQuery->num_rows() > 0){
            ...
            $aDataCountAllRow   = $this->FSnMQTDisChgCountPageHDDocListAll($paDataCondition);
    ...
    // Parameters       : function parameters
    // Creator          : 02/07/2021 Supawat
    public function FSnMQTDisChgCountPageHDDocListAll($paDataCondition){
        $aRowLen        = FCNaHCallLenData($paDataCondition['nRow'],$paDataCondition['nPage']);
        $tDocNo         = $paDataCondition['tDocNo'];
        $tBchCode       = $paDataCondition['tBchCode'];
        $tSessionID     = $paDataCondition['tSessionID'];
    ...
    // Parameters       : function parameters
    // Creator          : 02/07/2021 Supawat
    public function FSaMQTGetDisChgDTList($paDataCondition){
        $aRowLen    = FCNaHCallLenData($paDataCondition['nRow'],$paDataCondition['nPage']);
        $tDocNo     = $paDataCondition['tDocNo'];
        ...
        if($oQuery->num_rows() > 0){
            $oDataList          = $oQuery->result_array();
            $aDataCountAllRow   = $this->FSnMQTDisChgCountPageDTDocListAll($paDataCondition);
            $nFoundRow          = ($aDataCountAllRow['rtCode'] == '1')? $aDataCountAllRow['rtCountData'] : 0;
            $nPageAll           = ceil($nFoundRow/$paDataCondition['nRow']);
            $aResult = array(
                'raItems'       => $oDataList,
    ...
    // Parameters       : function parameters
    // Creator          : 02/07/2021 Supawat
    public function FSnMQTDisChgCountPageDTDocListAll($paDataCondition){
        $tDocNo     = $paDataCondition['tDocNo'];
        $tBchCode   = $paDataCondition['tBchCode'];
        $tSessionID = $paDataCondition['tSessionID'];
    ...
    // Parameters       : function parameters
    // Creator          : 02/07/2021 Supawat
    public function FSaMQTAddEditDTDisTemp($paDataInsert){
    ...
    // Parameters       : function parameters
    // Creator          : 02/07/2021 Supawat
    public function FSaMQTUpdateDTDisInTemp($paDataInsert){
    ...
    // Parameters       : function parameters
    // Creator          : 02/07/2021 Supawat
    public function FSaMQTDeleteHDDisTemp($paParams){
        $tDocNo       = $paParams['tDocNo'];
        $tBchCode     = $paParams['tBchCode'];
        $tSessionID   = $paParams['tSessionID'];
    ...
    // Parameters       : function parameters
    // Creator          : 02/07/2021 Supawat
    public function FSaMQTAddEditHDDisTemp($paDataInsert){

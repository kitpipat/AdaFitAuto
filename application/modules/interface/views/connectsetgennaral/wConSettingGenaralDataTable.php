        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped" style="width:100%;">
                    <thead>
                        <tr>
                            <th nowrap class="xCNTextBold" style="width:2%;text-align:center;"><?php echo language('interface/conSettingGenaral/consettinggenaral', 'tGenaralGroup')?></th>
                            <th nowrap class="xCNTextBold" style="width:1%;text-align:center;"><?php echo language('interface/conSettingGenaral/consettinggenaral', 'tGenaralSeq')?></th>
                            <th nowrap class="xCNTextBold" style="width:1%;text-align:center;"><?php echo language('interface/conSettingGenaral/consettinggenaral', 'tGenaralType')?></th>
                            <th nowrap class="xCNTextBold" style="width:5%;text-align:center;"><?php echo language('interface/conSettingGenaral/consettinggenaral', 'tGenaralDetail')?></th>
                            <th nowrap class="xCNTextBold" style="width:13%;text-align:center;"><?php echo language('interface/conSettingGenaral/consettinggenaral', 'tGenaralAPIURL')?></th>
                            <th nowrap class="xCNTextBold" style="width:1%;text-align:center;"><?php echo language('interface/conSettingGenaral/consettinggenaral', 'tGenaralApiFormat')?></th>
                            <th nowrap class="xCNTextBold" style="width:4%;text-align:center;"><?php echo language('interface/conSettingGenaral/consettinggenaral', 'tGenaralName')?></th>
                            <th nowrap class="xCNTextBold" style="width:4%;text-align:center;"><?php echo language('interface/conSettingGenaral/consettinggenaral', 'tGenaralPassword')?></th>
                            <th nowrap class="xCNTextBold" style="width:2%;text-align:center;"><?php echo language('interface/conSettingGenaral/consettinggenaral', 'tGenaralSecurity')?></th>
                        ...
                        <?php if($aReslistApi['rtCode'] == 1):?>
                            <?php foreach($aReslistApi['raItems'] AS $key => $aValue) { ?>
                                <tr>
                                    ...
                                    <td style="text-align:left"><input style="text-align:left; min-width:75px;" type="text" name="oetApiURL[]" value="<?=$aValue['FTApiURL'];?>"></td>

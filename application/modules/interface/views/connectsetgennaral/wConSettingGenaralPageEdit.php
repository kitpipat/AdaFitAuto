...
<div class="row">
    <div class="col-xs-8 col-md-4 col-lg-4" style="padding:0px;margin-bottom:0px;padding-left:0px;margin-right:0px;">
        <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxCallGetConGeneral();" ><?php echo language('interface/conSettingGenaral/consettinggenaral','tConditionAPI')?></label>

				...
				<thead>
					<tr>
						<th nowrap class="text-center xCNTextBold" width="5%">  <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceIdT'); ?></th>
							<th nowrap class="text-center xCNTextBold" width="20%"> <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceProductGroupID2'); ?></th>
							<th nowrap class="text-center xCNTextBold" width="20%">  <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceProductGroupCode'); ?></th>
							<th nowrap class="text-center xCNTextBold" width="20%">  <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceProductGroupName'); ?></th>
							...
							<tbody>	
								...
								<?php 
									if ($aValue['ProductGroupCode'] == null){
										$tShowProductGroupCode  =  "-" ;
									}else{ 
										$tShowProductGroupCode = $aValue['ProductGroupCode'];
								}?>
									<td nowrap class="text-left"><?php echo $tShowProductGroupCode ?></td>	

								<?php 
									if ($aValue['ProductGroupName'] == null){
										$tShowProductGroupName  =  "-" ;
									}else{ 
										$tShowProductGroupName = $aValue['ProductGroupName'];
									}?>
									<td nowrap class="text-left"><?php echo $tShowProductGroupName ?></td>	
...
<script>
	function JSvCHkClickPage(ptPage) {
		...
		JCNxOpenLoading();
		JSvInterfaceImportProducts(nPageCurrent);  // ทำงาน JSvInterfaceImportProductGroup ส่ง paramiter ไป
		JCNxCloseLoading();
	}
</script>
				...
				<thead>
					<tr>
						<th nowrap class="text-center xCNTextBold" width="5%">  <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceIdT'); ?></th>
							<th nowrap class="text-center xCNTextBold" width="25%"> <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceProductPriceID'); ?></th>
							<th nowrap class="text-center xCNTextBold" width="25%">  <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceProductID'); ?></th>
							<th nowrap class="text-center xCNTextBold" width="25%">  <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceProductPrice'); ?></th>
							<th nowrap class="text-center xCNTextBold" width="20%">  <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceFDCreateOn'); ?></th>
					</tr>
				</thead>
					<tbody>	
						...
						<?php 
							if ($aValue['ProductPriceID'] == null){
								$tShowProductPriceID  =  "-" ;
							}else{ 
								$tShowProductPriceID = $aValue['ProductPriceID'];
						}?>
							<td nowrap class="text-left"><?php echo $tShowProductPriceID ?></td>
						...
						<?php 
							if ($aValue['ProductPrice'] == null){
								$tShowProductPrice  =  "-" ;
							}else{ 
								$tShowProductPrice= number_format($aValue['ProductPrice'], $nDecShow);
						}?>
								<td nowrap class="text-right"><?php echo $tShowProductPrice ?></td>					
...
function JSvCHkClickPage(ptPage) { // รับ paramiter หน้า 
		...
		JCNxOpenLoading();
		JSvInterfaceImportProducts(nPageCurrent);  // ทำงาน JSvInterfaceImportProductPrice ส่ง paramiter ไป
		JCNxCloseLoading();
}
</script>
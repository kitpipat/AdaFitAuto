			...
			<table id="otbInterfaceImport" class="table table-striped"> 
				<thead>
					<tr>
						...
						<th nowrap class="text-center xCNTextBold" width="20%"> <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceProductUnitSmallID'); ?></th>
						<th nowrap class="text-center xCNTextBold" width="20%">  <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceProductUnitSmallName'); ?></th>
						<th nowrap class="text-center xCNTextBold" width="15%">  <?php echo language('interface/interfacechkimport/interfacechkimport','tInterfaceFDCreateOn'); ?></th>
							...
							<tbody>	
								...
								<tr>
									...
									<?php 
										if ($aValue['UnitSmallName'] == null){
											$tShowUnitSmallName  =  "-" ;
										}else{ 
											$tShowUnitSmallName = $aValue['UnitSmallName'];
										}?>
										<td nowrap class="text-left"><?php echo $tShowUnitSmallName ?></td>	

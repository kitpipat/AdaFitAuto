<div class="panel-heading">
	<div class="row">
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-1">
            <div class="form-group">
                <label class="xCNLabelFrm"><?php echo language('report/report/report','สถานะ')?></label>
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-1">
            <div class="form-group">
                <label class="xCNLabelFrm"><?php echo language('report/report/report','ประเภท')?></label>
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-1">
            <div class="form-group">
                <label class="xCNLabelFrm"><?php echo language('report/report/report','รายการ')?></label>

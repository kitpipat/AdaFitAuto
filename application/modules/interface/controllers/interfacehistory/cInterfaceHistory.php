...
class cInterfaceHistory extends MX_Controller {
    ...
    */
    public function FSaCIFHGetDataTable(){
        ...
        $tPathFile_In   = $this->mInterfaceHistory->FStMIFHGetPathLoadFile($aData);
        $tPathFile_Out  = $this->mInterfaceHistory->FStMIFHGetPathLoadFileOutbound($aData);
        ...
        $aGenTable  = array(
            ...
            'aDataList'     => $aResList,
            'nPage'         => $nPage,
            'tPathFile_In'  => $tPathFile_In,
            'tPathFile_Out' => $tPathFile_Out
            // 'tSearchAll'    => $tSearchAll,
            // 'tStatusIFH'    => $tStatusIFH,
            // 'tSearchDocDateFromIFH'    => $tSearchDocDateFromIFH,
            // 'tSearchDocDateToIFH'    => $tSearchDocDateToIFH

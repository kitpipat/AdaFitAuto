                ...
                <tbody>
                        <?php if(!empty($aDataNotiNews)){
                            ...
                            <tr style="<?=$tStaRead?>">
                                ...
                                <td class='text-left xCNTextDetail2'><?=$aData['FTNotDesc2']?></td>
                                ...
                                <img class="xCNIconTable" style="width: 17px;" src="<?= base_url('application/modules/common/assets/images/icons/view2.png'); ?>"
                                 onclick="JCNxNFTReadNotID('<?=$aData['FTNotID']?>',2);JCNxNTFJumpDocPageEdit('<?=$aData['FTNotDocRef']?>','<?=$aData['FTNotUrlRef']?>','<?=$aData['FTAgnCode']?>','<?=$aData['FTNotBchRef']?>')">
                                 <?php }else if($aData['FNNotUrlType']==2){ ?>
                                    <img class="xCNIconTable" style="width: 17px;" src="<?= base_url('application/modules/common/assets/images/icons/view2.png'); ?>"
                                 onclick="JCNxNFTReadNotID('<?=$aData['FTNotID']?>',2);JCNxNTFOpenUrl('<?=$aData['FTNotUrlRef']?>')">
                                <?php }else if($aData['FNNotUrlType']==3){ ?>
                                    <img class="xCNIconTable" style="width: 17px;" src="<?= base_url('application/modules/common/assets/images/icons/view2.png'); ?>"
                                 onclick="JCNxNFTReadNotID('<?=$aData['FTNotID']?>',2);JCNxNTFPopUpNew(this)"

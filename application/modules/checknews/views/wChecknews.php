            ...
            <div class="col-xs-6 col-sm-8 col-md-8 col-lg-8">      
                <ol id="oliMenuNav" class="breadcrumb">
                    <li id="oliMNTTitle" class="xCNLinkClick xCNHederMenuWithoutFav" onclick="JSxMNTGetPageForm()" style="curMNTr:pointer">
                        <?php $tLangName = language('checknews/checknews','tChkDocTitle'); ?>
                        <?= $tLangName ?>
                    </li>
                    <!-- <li id="oliMNTTitleAdd" class="active"><a><?php echo language('checknews/checknews','tChkDocAddPage')?></a></li>
                    <li id="oliMNTTitleEdit" class="active"><a><?php echo language('checknews/checknews','tChkDocAddView')?></a></li> -->
                </ol>
            </div>
                            ...
                            <div class="demo-button xCNBtngroup" style="width:100%;">
                                <button id="obtMNTCallBackPage"  class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button"> <?php echo language('common/main/main','tBack');?></button>
                                    <div class="btn-group odvMNTBtnGrpSave">
                                        <button id="obtMntSendNoti" type="button" class="btn btn xCNBTNPrimery xCNBTNPrimery2Btn"> <?php echo language('checknews/checknews','tMntBtnSend');?></button>
...
<form class="contact100-form validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmChecknews">
...
<script src="<?php echo base_url('application/modules/checknews/assets/src/jChecknews.js')?>"></script>

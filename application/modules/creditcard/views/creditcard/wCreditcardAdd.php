            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-xs-8 col-sm-8">
                        ...
                        <div class="form-group">
                                <label class="xCNLabelFrm"><?php echo language('creditcard/creditcard/creditcard','tCDCFormat')?> (0.*)</label>
                                <input type="text" class="form-control xCNInpuCrdFmt" placeholder="<?php echo language('creditcard/creditcard/creditcard','tCDCFormat')?>" maxlength="18" id="oetCrdFmt" name="oetCrdFmt" value="<?php echo @$tCrdFmt;?>">
                        </div>

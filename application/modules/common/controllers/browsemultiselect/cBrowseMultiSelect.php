                    ...
                    if($tFilterSearch != ''){
                        ...
                        for ($fc = 0; $fc < FCNnHSizeOf($aOptionMultiBrowse['GrideView']['DataColumns']); $fc++){
                            ...
                            if ($tCheckField2 == 'FN') {
                                ...
                                $tWhereFilterSearch .= "  OR $tFilterCol LIKE '%$tFilterSearch%' ";
                            } else if($tCheckField2 == 'FC') {
                                $tWhereFilterSearch .= "  OR $tFilterCol LIKE '%$tFilterSearch%' ";
                            } else if($tCheckField2 == 'FD') {
                                $tWhereFilterSearch .= "  OR $tFilterCol LIKE '%$tFilterSearch%' ";
                            }else{
            ...
            if($oQuery->num_rows() > 0){
                ...
                foreach($aDataTableMulti as $nKey => $aValue){
                    ...
                    for($f = 0; $f < FCNnHSizeOf($aOptionMultiBrowse['GrideView']['DataColumns']); $f++){
                        ...
                        if(isset($aValue->FTXshDocNo)){
                            $tCheckDocVal = substr($aValue->FTXshDocNo, 0, 2);
                        }
                            ...
                            if (isset($aOptionMultiBrowse['GrideView']['DataColumnsFormat'][$f])){
                                ...
                                switch ($tFomatType){
                                    case '':
                                        ...
                                        if($tColumnVal == 'FDXshDocDate' && $tCheckDocVal == 'PB'){
                                            $tDataDisplay = explode(" ", $tDataDisplay);
                                            $tDataDisplay = $tDataDisplay[0];
                                        }
                                    // print_r($tDataDisplay);

...
class cRptAdjPrice extends MX_Controller
{
    ...
    public function FSoCCallRptRenderHedaerExcel()
    {
        ...
        if ((isset($this->aRptFilter['tDocDateFrom']) && !empty($this->aRptFilter['tDocDateFrom'])) && (isset($this->aRptFilter['tDocDateTo']) && !empty($this->aRptFilter['tDocDateTo']))) {
            $aCells = [
                ...
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(language('report/report/report', 'tRptTaxPointByCstDocDateFrom') . ' ' . date('d/m/Y', strtotime($this->aRptFilter['tDocDateFrom'])) . ' ' . language('report/report/report', 'tRptTaxPointByCstDocDateTo') . ' ' . date('d/m/Y', strtotime($this->aRptFilter['tDocDateTo']))),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
    ...
    public function FSoCCallRptRenderFooterExcel()
    {
        ...
        //จากวันที่มีผล - ถึงวันที่มมีผล
        if (isset($this->aRptFilter['tEffectiveDateFrom']) && !empty($this->aRptFilter['tEffectiveDateTo'])) {
            $aCells = [
                WriterEntityFactory::createCell(language('report/report/report', 'tRptEffectiveDateFrom') . ' : ' . date('d/m/Y', strtotime($this->aRptFilter['tEffectiveDateFrom'])) . '  ' .language('report/report/report', 'tRptEffectiveDateTo') . ' : ' . date('d/m/Y', strtotime($this->aRptFilter['tEffectiveDateTo']))),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
        ...
        //จากหน่วยสินค้า - ถึงหน่วยสินค้า
        if (isset($this->aRptFilter['tRptPdtUnitCodeFrom']) && !empty($this->aRptFilter['tRptPdtUnitCodeTo'])) {
            $aCells = [
                WriterEntityFactory::createCell(language('report/report/report', 'tRptPdtUnitFrom') . ' : ' . $this->aRptFilter['tRptPdtUnitNameFrom'] . '  ' .language('report/report/report', 'tRptPdtUnitTo') . ' : ' . $this->aRptFilter['tRptPdtUnitNameTo']),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
        ...
        //จากกลุ่มราคาที่มีผล - ถึงกลุ่มราคาที่มีผล
        if (isset($this->aRptFilter['tRptEffectivePriceGroupCodeFrom']) && !empty($this->aRptFilter['tRptEffectivePriceGroupCodeTo'])) {
            $aCells = [
                WriterEntityFactory::createCell(language('product/pdtcheckprice/pdtcheckprice', 'tPCPPplFrom') . ' : ' . $this->aRptFilter['tRptEffectivePriceGroupNameFrom'] . '  ' .language('product/pdtcheckprice/pdtcheckprice', 'tPCPPplTo') . ' : ' . $this->aRptFilter['tRptEffectivePriceGroupNameTo']),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),

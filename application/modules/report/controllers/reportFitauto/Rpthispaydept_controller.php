...
class Rpthispaydept_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rpthispaydept_model');
    ...
    {
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptHisPayDePtTitle'),
        ...
        $this->aRptFilter = [
            ...
            'tDocDateFrom'          => (empty($this->input->post('oetRptEffectiveDateFrom'))) ? '' : $this->input->post('oetRptEffectiveDateFrom'),
            'tDocDateTo'            => (empty($this->input->post('oetRptEffectiveDateTo'))) ? '' : $this->input->post('oetRptEffectiveDateTo'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            $this->Rpthispaydept_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->Rpthispaydept_model->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRpthispaydept', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rpthispaydept_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPayDePtCol2')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPayDePtCol3')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPayDePtCol4')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPayDePtCol5')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPayDePtCol6')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPayDePtCol7')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPayDePtCol8'))
        ];
        ...
        $aDataReport = $this->Rpthispaydept_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(date("d/m/Y", strtotime($aValue['FDXpdDueDate']))),
                    WriterEntityFactory::createCell(($aValue['FDXpdPayDate'] == '' ) ? '-' : date("d/m/Y", strtotime($aValue['FDXpdPayDate']))),
                    WriterEntityFactory::createCell(number_format($aValue['FCXphGrand'], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(number_format($aValue['FCXphPaid'], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(number_format($aValue['FCXphLeft'], $this->nOptDecimalShow))
                ];
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $FCXphGrand_Footer        = FCNnGetNumeric($aValue["FCXphGrand_Footer"]);
                    $FCXphPaid_Footer           = FCNnGetNumeric($aValue["FCXphPaid_Footer"]);
                    $FCXphLeft_Footer         = FCNnGetNumeric($aValue["FCXphLeft_Footer"]);

                    $values = [
                        WriterEntityFactory::createCell(language('report/report/report', 'tRptRentAmtForDetailSumText')),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                         WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($FCXphGrand_Footer, 2)),
                        WriterEntityFactory::createCell(number_format($FCXphPaid_Footer, 2)),
                        WriterEntityFactory::createCell(number_format($FCXphLeft_Footer, 2)),

...
class Rptpurhistorypdt_controller extends MX_Controller
{
    /**
     * ภาษา
     * @var array
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptpurhistorypdt_model');
        // Init Report
        $this->init();
    ...
    private function init()
    {
        $this->aText = [
            // Title
              ...
              'tTitleReport'                    => language('report/report/report', 'tRptpurhistorypdtTitle'),
            ...
            'tRptStaVa0'                        => language('report/report/report', 'tRptStaVa0'),
            ...
            'tRptOpenJobStaDoc'                 => language('report/report/report', 'tRptOpenJobStaDoc'),
            'tRptAll'                           => language('report/report/report', 'tRptAll'),
            'tRptPhStaApv0'                     => language('report/report/report', 'tRptPhStaApv0'),
            'tRptPhStaApv1'                     => language('report/report/report', 'tRptPhStaApv1'),
            'tRptStaCrd3'                       => language('report/report/report', 'tRptStaCrd3'),
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptpurhistorypdt_model->FSnMExecStoreReport($this->aRptFilter);
            // Count Rows
            $aCountRowParams = [
            ...
            $this->nRows = $this->Rptpurhistorypdt_model->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        try {
            ...
            $aDataReport = $this->Rptpurhistorypdt_model->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
            ...
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto/', 'wRptpursplbypdthis', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rptpurhistorypdt_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
        // print_r($aDataReport);
        // exit;

        // GetDataSumFootReport
        // $aDataSumFoot = $this->Rptpurhistorypdt_model->FSaMGetDataSumFootReport($aDataWhere, $aDataFilter);
        ...
        $tViewRenderKool = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto/', 'wRptpursplbypdthis', $aDataViewRptParams);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rptpurhistorypdt_model->FSnMCountRowInTemp($aDataCountData);
    ...
    public function  FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report','tbypdthisCol1')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tbypdthisCol2')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tbypdthisCol3')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tbypdthisCol4')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tbypdthisCol5')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tbypdthisCol6')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tbypdthisCol7')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report','tbypdthisCol8'))
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
              if($aValue['rtPartitionCST'] == 1){
                $tHeadtr = "ผู้จำหน่าย ".$aValue['FTSplName'];
                $values = [
              ...
              if($aValue['rtPartitionCST'] == $aValue['rtPartitionCountCST']){
                $values = [
                    WriterEntityFactory::createCell("รวม : ".$aValue['FTSplName']),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    ...
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXpdValue_SPL_Footer'])),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXpdDis_SPL_Footer'])),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXpdVat_SPL_Footer'])),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXpdNetAmt_SPL_Footer']))
                ];
                $aRow = WriterEntityFactory::createRow($values);
                $oWriter->addRow($aRow);
              }

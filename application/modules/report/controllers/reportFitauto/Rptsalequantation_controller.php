...
class Rptsalequantation_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptsalequantation_model');
    ...
    {
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptSaleQuantationTitle'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptsalequantation_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->Rptsalequantation_model->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptSaleQuantationHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rptsalequantation_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptSaleQuantationRefDocInt')),
            WriterEntityFactory::createCell(null),
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptSaleQuantationPrice')),
            WriterEntityFactory::createCell(null),
        ...
        $aDataReport = $this->Rptsalequantation_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(date("d/m/Y", strtotime($aValue['FDXshRefIntDate']))),
                    WriterEntityFactory::createCell(null),
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshCtrName']),
                    WriterEntityFactory::createCell(null),
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXshVat'], 2)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXshGrand'], 2)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell($tStaOdr),

...
class Rptdebtoroverdue_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptdebtoroverdue_model');
    ...
    {
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptdebtoroverdueTitle'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptdebtoroverdue_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->Rptdebtoroverdue_model->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptdeptrodue', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rptdebtoroverdue_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport = $this->Rptdebtoroverdue_model->FSaMGetDataReport($aDataReportParams);

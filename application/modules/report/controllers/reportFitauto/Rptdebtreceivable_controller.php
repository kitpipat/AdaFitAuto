...
class Rptdebtreceivable_controller extends MX_Controller
{
    // ภาษา
    public $aText = [];
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptdebtreceivable_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init()
    {
        // Array Text Label
        $this->aText    = [
            'tTitleReport'          => language('report/report/report', 'tRptdebtreceivable'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptdebtreceivable_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport    = $this->Rptdebtreceivable_model->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView   = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptDebtReceivable', $aDataViewRptParams);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport    = $this->Rptdebtreceivable_model->FSaMGetDataReport($aDataReportParams);

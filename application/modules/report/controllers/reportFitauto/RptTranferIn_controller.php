...
class RptTranferIn_controller extends MX_Controller
{
    // ภาษา
    public $aText = [];
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportFitauto/mRptTranferIn_model');
        $this->init();
        parent::__construct();
    }
    ...
    private function init(){
        // Array Text Label
        $this->aText    = [
            'tTitleReport'                  => language('report/report/report', 'รายงานตามใบรับเข้า'),
    ...
    public function FSvCCallRptExportFile(){
        ...
        $aDataReport        = $this->mRptTranferIn_model->FSaMGetDataReport($aDataReportParams);
        ...
        $values = [
            ...
            WriterEntityFactory::createCell('เลขที่เอกสาร',$oStyleColums),
            WriterEntityFactory::createCell('วันที่เอกสาร',$oStyleColums),
            ...
            WriterEntityFactory::createCell('หมายเหตุ',$oStyleColums),
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(($aValue['FDXthDocDate'] == '') ? '-' : date("Y-m-d", strtotime($aValue['FDXthDocDate']))),
                    ...
                    WriterEntityFactory::createCell(($aValue['FTXthRefExt'] == '') ? '-' : $aValue['FTXthRefExt']),
                    WriterEntityFactory::createCell(($aValue['FDXthRefExtDate'] == '') ? '-' : date("Y-m-d", strtotime($aValue['FDXthRefExtDate']))),
                    WriterEntityFactory::createCell(($aValue['FTPdtCode'] == '') ? '-' : $aValue['FTPdtCode']),
                    WriterEntityFactory::createCell(($aValue['FTXtdPdtName'] == '') ? '-' : $aValue['FTXtdPdtName']),
                    WriterEntityFactory::createCell(($aValue['FCXtdQtyAll'] == '') ? '-' : FCNnGetNumeric($aValue['FCXtdQtyAll'])),
                    WriterEntityFactory::createCell(($aValue['FTPunName'] == '') ? '-' : $aValue['FTPunName']),
                    WriterEntityFactory::createCell(($aValue['FTXthRmk'] == '') ? '-' : $aValue['FTXthRmk']),
                ];

...
class Rptsalebypaymenttype_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptsalebypaymenttype_model');
    ...
    {
        $this->aText = [
            'tTitleReport'                              => language('report/report/report', 'tRptSaleRCByBchTmpr'),
    ...
    public function index(){
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptsalebypaymenttype_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase){
        try {
            ...
            $aDataReport = $this->Rptsalebypaymenttype_model->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptSaleByPaymentTypeHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        $aDataReport = $this->Rptsalebypaymenttype_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase){
        try {
            ...
            $nDataCountPage = $this->Rptsalebypaymenttype_model->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptExportFile(){
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptSalePDTByDayType')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPC2TBCardType')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptCreditAndCouponType')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPoByBchByPdtDocDate')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptIncomeNotReturnCardPos')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptSBPBillNo')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptTaxSalePosByDateFullPayment')),
        ...
        $aDataReport = $this->Rptsalebypaymenttype_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    ...
                    WriterEntityFactory::createCell($aValue['FTFmtName']),
                    ...
                    WriterEntityFactory::createCell(number_format($aValue['FCXrcNet'], 2)),
                    WriterEntityFactory::createCell($aValue['FTTxnCrdCode']),
                    WriterEntityFactory::createCell(null),
                ];
                $aRow = WriterEntityFactory::createRow($values);
                $oWriter->addRow($aRow);

                // Sum Sub RCV By Branch
                $nFmtAllRow = $aValue['FNFmtAllRow'];
                $nFmtEndRow = $aValue['FNFmtEndRow'];
                if($nFmtAllRow == $nFmtEndRow){
                    $cSumSumRC  = FCNnGetNumeric($aValue['FCSumSumRC']);
                    $values     = [
                        WriterEntityFactory::createCell(language('report/report/report', 'tRptRentAmtForDetailSumText').':'),
                        WriterEntityFactory::createCell($aValue['FTBchName']),
                        WriterEntityFactory::createCell($aValue['FTRcvName'].' '.number_format($aValue['FNFmtEndRow'], 0).' '.language('report/report/report', 'tRPCTBFooterList')),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($cSumSumRC,2)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                    ];
                ...
                if($nFmtPageRow == $nFmtMaxPageRow){
                    $cSumSubFooter  = FCNnGetNumeric($aValue['SumSubFooter']);
                    $values = [
                        WriterEntityFactory::createCell(language('report/report/report', 'tRptRentAmtForDetailSumText').':'),
                        WriterEntityFactory::createCell($aValue['FTBchName']),
                        WriterEntityFactory::createCell(null),
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($cSumSubFooter,2)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                    ];
                    $aRow = WriterEntityFactory::createRow($values, $oStyleColums);

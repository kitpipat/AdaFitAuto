...
class Rptincreasedebtreceivable_controller extends MX_Controller
{
    // ภาษา
    public $aText = [];
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptincreasedebtreceivable_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init()
    {
        // Array Text Label
        $this->aText    = [
            'tTitleReport'          => language('report/report/report', 'tRptincreasedebtreceivable'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptincreasedebtreceivable_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport    = $this->Rptincreasedebtreceivable_model->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView   = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptIncreaseDebtReceivable', $aDataViewRptParams);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport    = $this->Rptincreasedebtreceivable_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                if ($aValue["FTCstCode"] == '') {
                    ...
                    $tName = $aValue["FTCstName"] . ' / ' . $aValue["FTCstCode"];
                }
                $values = [
                    WriterEntityFactory::createCell($tName),

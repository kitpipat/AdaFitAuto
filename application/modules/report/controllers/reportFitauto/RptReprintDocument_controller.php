...
class RptReprintDocument_controller extends MX_Controller{
    /**
     * ภาษา
     * @var array
    */
    ...
    */
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportFitauto/RptReprintDocument_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init(){
        $this->aText    = [
            // TitleReport
            'tTitleReport'              => language('report/report/report', 'tRptReprintDocument'),
            ...
            // Table Label
            'tRptReprintDocBchCode'     => language('report/report/report', 'tRptReprintDocBchCode'),
            'tRptReprintDocBchName'     => language('report/report/report', 'tRptReprintDocBchName'),
            'tRptReprintDocDocNo'       => language('report/report/report', 'tRptReprintDocDocNo'),
            'tRptReprintDocDocCreate'   => language('report/report/report', 'tRptReprintDocDocCreate'),
            'tRptReprintDocNumPrint'    => language('report/report/report', 'tRptReprintDocNumPrint'),
            'tRptReprintDocCashier'     => language('report/report/report', 'tRptReprintDocCashier'),
        ];
    ...
    public function index(){
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->RptReprintDocument_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    */
    public function FSvCCallRptViewBeforePrint(){
        ...
        $aDataReport    = $this->RptReprintDocument_model->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView       = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptReprintDocument', 'wRptReprintDocumentHtml', $aDataViewRpt);
    ...
    */
    public function FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReprintDocBchCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReprintDocBchName')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReprintDocDocNo')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReprintDocDocCreate')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReprintDocNumPrint')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReprintDocCashier')),
            WriterEntityFactory::createCell(null),
        ];
        ...
        $aDataReport    = $this->RptReprintDocument_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FDXthHisDateTime']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FNXthReprintNum'])),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXthUsrName']),
                ];
            }
        }

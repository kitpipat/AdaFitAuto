...
class Rptcreditordebtbyrcv_controller extends MX_Controller 
{
    // ภาษา
    public $aText = [];
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptcreditordebtbyrcv_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init()
    {
        // Array Text Label
        $this->aText    = [
            'tTitleReport'          => language('report/report/report', 'tRptcreditordebtbyrcv'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptcreditordebtbyrcv_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport    = $this->Rptcreditordebtbyrcv_model->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView   = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptCreditorDebtByRcv', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
     ...
     public function FSvCCallRptExportFile()
     {
         ...
         $aDataReport    = $this->Rptcreditordebtbyrcv_model->FSaMGetDataReport($aDataReportParams);
         ...
         $aCells = [
             WriterEntityFactory::createCell('ผู้จำหน่าย/เจ้าหนี้'),
             WriterEntityFactory::createCell('เลขที่เอกสาร'),
             WriterEntityFactory::createCell('วันที่เอกสาร'),
             WriterEntityFactory::createCell('เลขที่เอกสารอ้างอิง'),
             WriterEntityFactory::createCell('ยอดยกเว้นภาษี'),
             WriterEntityFactory::createCell('ยอดแยกภาษี'),
             WriterEntityFactory::createCell('ภาษี'),
             WriterEntityFactory::createCell('ยอดรวม'),
             WriterEntityFactory::createCell('พนักงานเพิ่มหนี้')
         ...
         if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
             foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                 $values = [
                     WriterEntityFactory::createCell($aValue["FTSplName"] . ' / ' . $aValue["FTSplCode"]),
                     ...
                     WriterEntityFactory::createCell(number_format($aValue["FCXphRemain"], $this->nOptDecimalShow)),
                     WriterEntityFactory::createCell(number_format($aValue["FCXphVat"], $this->nOptDecimalShow)),
             ...
             $values = [
                 ...
                 WriterEntityFactory::createCell(null),
                 WriterEntityFactory::createCell(null),
                 WriterEntityFactory::createCell(number_format(floatval($aValue['FCXphPaid_Footer']), $this->nOptDecimalShow)),
                 WriterEntityFactory::createCell(number_format(floatval($aValue['FCXphRemain_Footer']), $this->nOptDecimalShow)),
                 WriterEntityFactory::createCell(number_format(floatval($aValue['FCXphVat_Footer']), $this->nOptDecimalShow)),
                 WriterEntityFactory::createCell(number_format(floatval($aValue['FCXphGrand_Footer']), $this->nOptDecimalShow)),
                 WriterEntityFactory::createCell(null),
             ];

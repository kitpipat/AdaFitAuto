...
class RptPoForm_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/RptPoForm_model');
    ...
    private function init()
    {
        ...
        $this->aRptFilter = [
            ...
            //สถานะเอกสาร
            'tPdtRptStaApv' => !empty($this->input->post('ocmRptPhStaApv')) ? $this->input->post('ocmRptPhStaApv') : "",
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->RptPoForm_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->RptPoForm_model->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptPoFormHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->RptPoForm_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPoBch')),
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPoRefABB')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRefDate')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPoToCst')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
        ...
        $aDataReport = $this->RptPoForm_model->FSaMGetDataReport($aDataReportParams);
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                if ($aValue['FNTxnType'] == 1){
                    $values = [
                        ...
                        WriterEntityFactory::createCell(date('Y-m-d', strtotime($aValue['FDXshDocDate']))),
                        WriterEntityFactory::createCell($aValue['FTXshRefDocNo']),
                        WriterEntityFactory::createCell(date('Y-m-d', strtotime($aValue['FDXshRefDocDate']))),
                    ...
                    $values = [
                        ...
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXshDisChg'])),
                ...
                if ($aValue['rtPartitionDOC'] == $aValue['rtPartitionCountDOC']){
                    $values = [
                        WriterEntityFactory::createCell(language('report/report/report', 'tRptTotal').' : '.$aValue['FTXshDocNo']),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['rtSumQty'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXshTotalHD'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXshDisChgHD'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXshGrandHD'])),
                    ];

...
class Rptpurcroverdue_controller extends MX_Controller
{
    // ภาษา
    public $aText = [];
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptpurcroverdue_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init()
    {
        // Array Text Label
        $this->aText    = [
            'tTitleReport'          => language('report/report/report', 'tRptPurCrOverDue'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptpurcroverdue_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport    = $this->Rptpurcroverdue_model->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView   = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptPurCrOverDue', $aDataViewRptParams);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport    = $this->Rptpurcroverdue_model->FSaMGetDataReport($aDataReportParams);
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell('เลขที่ใบวางบิล'),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell('วันที่วางบิล'),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell('ยอดในบิล'),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell('ยอดชำระ'),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell('ยอดคงค้าง'),
            WriterEntityFactory::createCell(null),
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTXshRefDocDate']),
                    WriterEntityFactory::createCell(null),
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format(floatval($aValue['FCXphRemain']), $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(null),

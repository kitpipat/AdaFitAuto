...
class Rptcstfollowaft_controller extends MX_Controller
{
    /**
     * ภาษา
     * @var array
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptcstfollowaft_model');
        // Init Report
        $this->init();
    ...
    private function init()
    {
        $this->aText = [
            // Title
              ...
              'tTitleReport' => language('report/report/report', 'tRptCstFollowAftTitle'),
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptcstfollowaft_model->FSnMExecStoreReport($this->aRptFilter);
            // Count Rows
            $aCountRowParams = [
            ...
            $this->nRows = $this->Rptcstfollowaft_model->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        try {
            ...
            $aDataReport = $this->Rptcstfollowaft_model->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
            ...
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptCstFollowAftHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rptcstfollowaft_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
        // print_r($aDataReport);
        // exit;

        // GetDataSumFootReport
        // $aDataSumFoot = $this->Rptcstfollowaft_model->FSaMGetDataSumFootReport($aDataWhere, $aDataFilter);
        ...
        $tViewRenderKool = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptCstFollowAftHtml', $aDataViewRptParams);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rptcstfollowaft_model->FSnMCountRowInTemp($aDataCountData);

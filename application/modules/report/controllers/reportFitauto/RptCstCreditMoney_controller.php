...
class Rptcstcreditmoney_controller extends MX_Controller
{
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportFitauto/Rptcstcreditmoney_model');
    ...
    private function init(){
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptCstCreditMoney'),
    ...
    public function index(){
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptcstcreditmoney_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase){
        try {
            ...
            $aDataReport = $this->Rptcstcreditmoney_model->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptCstCreditMoney', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        $aDataReport = $this->Rptcstcreditmoney_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptExportFile(){
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(language('report/report/report','tRptLockerPaymentXsdDocDate')),
            ...
            WriterEntityFactory::createCell(language('report/report/report','tRptRPDCode')),
            WriterEntityFactory::createCell(language('report/report/report','tRptRPDNamePdt')),
            ...
            WriterEntityFactory::createCell(language('report/report/report','tRptPriceGrand')),
            WriterEntityFactory::createCell(language('report/report/report','tRptStaVat')),
        ...
        $aDataReport = $this->Rptcstcreditmoney_model->FSaMGetDataReport($aDataReportParams);

        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {

                if($aValue['FTCbaStaTax'] == 1){
                    $tTextCbaStaTax = language('report/report/report','tRptStaTax1');
                }else if($aValue['FTCbaStaTax'] == 2){
                    $tTextCbaStaTax = language('report/report/report','tRptStaTax2');
                }else{
                    $tTextCbaStaTax = "ไม่ระบุ";
                }
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(empty($aValue['FDXshDocDate']) ? '' : date("d/m/Y", strtotime($aValue['FDXshDocDate']))),
                    ...
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXsdSalePrice'])),
                    ...
                    WriterEntityFactory::createCell($tTextCbaStaTax),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXsdVat']))
                ];
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCXsdQtyAll_Total"])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCXsdAmtB4DisChg_Total"])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCXsdDis_Total"])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue["FCXsdNetAfHD_Total"])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                    ];

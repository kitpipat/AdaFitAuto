...
class RptTireDotBrand_controller extends MX_Controller{
    // ภาษา
    public $aText = [];
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportFitauto/RptTireDotBrand_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init(){
        // Array Text Label
        $this->aText    = [
            'tTitleReport'          => language('report/report/report', 'tRptTireDotByBrandTitle'),
    ...
    public function index(){
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->RptTireDotBrand_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        ...
        $aDataReport    = $this->RptTireDotBrand_model->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView   = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto','wRptTireDotBrandHtml',$aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        $aDataReport    = $this->RptTireDotBrand_model->FSaMGetDataReport($aDataWhereRpt);
        // Load View Advance Table
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPdtBrandCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPdtBrandName')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPdtModelCode')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptPdtModelName')),
            WriterEntityFactory::createCell(null),
        ...
        $aDataReport = $this->RptTireDotBrand_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    WriterEntityFactory::createCell(!empty($aValue['FTPbnCode']) ? $aValue['FTPbnCode'] : "-"),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(!empty($aValue['FTPbnName']) ? $aValue['FTPbnName'] : "-"),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(!empty($aValue['FTPmoCode']) ? $aValue['FTPmoCode'] : "-"),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(!empty($aValue['FTPmoName']) ? $aValue['FTPmoName'] : "-"),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTLotNo']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTLotBatchNo']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(!empty($aValue['FTLotYear']) ? $aValue['FTLotYear'] : "-"),
                    WriterEntityFactory::createCell(null),
                ];

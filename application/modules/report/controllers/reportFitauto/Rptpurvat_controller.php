...
class Rptpurvat_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptpurvat_model');
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        try {
            ...
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptpurvat', $aDataViewRptParams);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    WriterEntityFactory::createCell((substr($aValue['FDXphDocDate'], 0, 10) == "" ? "-" :    substr($aValue['FDXphDocDate'], 0, 10))),
                    WriterEntityFactory::createCell(null),
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell((FCNnGetNumeric($aValue['FCXphAmt']) == "" ? "-" : FCNnGetNumeric($aValue['FCXphAmt']))),
                    WriterEntityFactory::createCell((FCNnGetNumeric($aValue['FCXphVat']) == "" ? "-" : FCNnGetNumeric($aValue['FCXphVat']))),
                    WriterEntityFactory::createCell((FCNnGetNumeric($aValue['FCXphAmtNV']) == "" ? "-" : FCNnGetNumeric($aValue['FCXphAmtNV']))),
                    WriterEntityFactory::createCell((FCNnGetNumeric($aValue['FCXphGrandTotal']) == "" ? "-" : FCNnGetNumeric($aValue['FCXphGrandTotal']))),
                ];

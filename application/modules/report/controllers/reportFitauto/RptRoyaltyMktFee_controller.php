...
class RptRoyaltyMktFee_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/RptRoyaltyMktFee_model');
    ...
    {
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'รายงาน - ตรวจสอบข้อมูล Test File Royalty & Marketing Fee'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->RptRoyaltyMktFee_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->RptRoyaltyMktFee_model->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptRoyaltyMktFee', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->RptRoyaltyMktFee_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCCallRptRenderHedaerExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell($this->aText['tDatePrint'] . ' ' . date('d/m/Y') . ' ' . $this->aText['tTimePrint'] . ' ' . date('H:i:s'),$oStyle),
        ];
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'ยอดขาย'),$oStyle),
            WriterEntityFactory::createCell(language('report/report/report', 'ส่วนลด'),$oStyle),
            WriterEntityFactory::createCell(language('report/report/report', 'ยอดขายรวม'),$oStyle),
            WriterEntityFactory::createCell(language('report/report/report', 'มูลค่าแยกภาษี'),$oStyle),
            WriterEntityFactory::createCell(language('report/report/report', 'ภาษีมูลค่าเพิ่ม'),$oStyle),
            WriterEntityFactory::createCell(language('report/report/report', 'Royalty fee (%)'),$oStyle),
            WriterEntityFactory::createCell(language('report/report/report', 'Royalty fee before VAT'),$oStyle),
            WriterEntityFactory::createCell(language('report/report/report', 'Marketing fee'),$oStyle),
            WriterEntityFactory::createCell(language('report/report/report', 'Marketing fee before VAT'),$oStyle),
        ];
        ...
        $aDataReport = $this->RptRoyaltyMktFee_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    WriterEntityFactory::createCell($aValue['FTBchCodeTo']),
                    WriterEntityFactory::createCell($aValue['FTBchNameTo']),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXphTotal'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXphDicount'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXphGrand'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FTCphVatable'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXphVat'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRoyaltyfeePCRate'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRoyaltyfeeBFVAT'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCMarketingfeePCRate'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCMarketingfeeBFVAT'])),
                ];
            ...
            $values = [
                WriterEntityFactory::createCell(language('report/report/report', 'รวมทั้งสิ้น')),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(FCNnGetNumeric($aDataReport['aRptData'][0]['FCXphTotal_SUM'])),
                WriterEntityFactory::createCell(FCNnGetNumeric($aDataReport['aRptData'][0]['FCXphDicount_SUM'])),
                WriterEntityFactory::createCell(FCNnGetNumeric($aDataReport['aRptData'][0]['FCXphGrand_SUM'])),
                WriterEntityFactory::createCell(FCNnGetNumeric($aDataReport['aRptData'][0]['FTCphVatable_SUM'])),
                WriterEntityFactory::createCell(FCNnGetNumeric($aDataReport['aRptData'][0]['FCXphVat_SUM'])),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(FCNnGetNumeric($aDataReport['aRptData'][0]['FCRoyaltyfeeBFVAT_SUM'])),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(FCNnGetNumeric($aDataReport['aRptData'][0]['FCMarketingfeeBFVAT_SUM'])),
            ];

...
class Rptcreditordebt_controller extends MX_Controller
{
    // ภาษา
    public $aText = [];
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptcreditordebt_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init()
    {
        // Array Text Label
        $this->aText    = [
            'tTitleReport'          => language('report/report/report', 'tRptcreditordebt'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptcreditordebt_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport    = $this->Rptcreditordebt_model->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView   = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptCreditorDebt', $aDataViewRptParams);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport    = $this->Rptcreditordebt_model->FSaMGetDataReport($aDataReportParams);

...
class RptSalesByBills_controller extends MX_Controller{
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportFitauto/RptSalesByBills_model');
        $this->init();
        parent::__construct();
    }
    ...
    private function init(){
        $this->aText = [
            'tTitleReport'                      => 'รายงานยอดขายรวมตามจำนวนบิล',
    ...
    public function index(){
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            $this->RptSalesByBills_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        try {
            ...
            $aDataReport = $this->RptSalesByBills_model->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptSalesByBillsHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        $aDataReport = $this->RptSalesByBills_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptExportFile(){
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell('บิล'),
            WriterEntityFactory::createCell('บิลต่อวัน'),
            WriterEntityFactory::createCell('จำนวน'),
            WriterEntityFactory::createCell('ยอดรวมก่อนลด'),
            WriterEntityFactory::createCell('ส่วนลด'),
            WriterEntityFactory::createCell('ยอดรวมสุทธิ'),
            WriterEntityFactory::createCell('ยอดรวมแยกภาษี'),
            WriterEntityFactory::createCell('ยอดรวมภาษี')
        ];
        ...
        $aDataReport = $this->RptSalesByBills_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FNBillCount'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FNBillPerDay'])),
                    ...
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXshTotalVat']))
                ];
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FNBillCount_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FNBillPerDay_Footer'])),
                        ...
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXshVatable_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXshTotalVat_Footer']))
                    ];

...
class Rptcstforcastbycar_controller extends MX_Controller
{
    /**
     * ภาษา
     * @var array
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptcstforcastbycar_model');
        // Init Report
        $this->init();
    ...
    private function init()
    {
        $this->aText = [
            ...
            'tTitleReport' => language('report/report/report', 'tRptCstForcastByCar'),
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->Rptcstforcastbycar_model->FSnMExecStoreReport($this->aRptFilter);
            // Count Rows
            $aCountRowParams = [
            ...
            $this->nRows = $this->Rptcstforcastbycar_model->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        try {
            ...
            $aDataReport = $this->Rptcstforcastbycar_model->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
            ...
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptCstForcastByCarHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rptcstforcastbycar_model->FSaMGetDataReport($aDataWhere, $aDataFilter);
        // print_r($aDataReport);
        // exit;

        // GetDataSumFootReport
        // $aDataSumFoot = $this->Rptcstforcastbycar_model->FSaMGetDataSumFootReport($aDataWhere, $aDataFilter);
        ...
        $tViewRenderKool = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptCstForcastByCarHtml', $aDataViewRptParams);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->Rptcstforcastbycar_model->FSnMCountRowInTemp($aDataCountData);
    ...
    public function  FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRPCCstForCastNextCycle')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPCCstForCastName')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPCCstForCastTel')),
            WriterEntityFactory::createCell(NULL),
            ...
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPCCstForCastLastSer')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptCstLostContSatisfact')),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(language('report/report/report', 'tRPCCstForCastLastBch'))
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $tDocDateFor    = date("d/m/Y", strtotime($aValue['FDFlwDateForcast']));

                $values = [
                    WriterEntityFactory::createCell($tDocDateFor),
                    WriterEntityFactory::createCell(NULL),
                    ...
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(($aValue['FNXshScoreValue'] == '') ? '-' : $aValue['FNXshScoreValue']),
                    WriterEntityFactory::createCell(NULL),

...
class Rptcreditordis_controller extends MX_Controller 
{
    // ภาษา
    public $aText = [];
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptcreditordis_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init()
    {
        // Array Text Label
        $this->aText    = [
            'tTitleReport'          => language('report/report/report', 'tRptcreditordis'),
            ...
            'tRptUsrDisFrom' => language('report/report/report', 'tRptUsrDisCreditorForm'),
            'tRptUsrDisTo' => language('report/report/report', 'tRptUsrDisCreditorTo'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptcreditordis_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport    = $this->Rptcreditordis_model->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView   = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptCreditorDis', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport    = $this->Rptcreditordis_model->FSaMGetDataReport($aDataWhereRpt);
        // Load View Advance Table
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport    = $this->Rptcreditordis_model->FSaMGetDataReport($aDataReportParams);
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDocPdtTwiSrcTypeAgn').'/'.language('report/report/report', 'tRptCreditorName')),
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptVatNoPay')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptVatCalculate')),
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptUserDis')),
        ];
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    WriterEntityFactory::createCell($aValue['FTXphDocNo'].'/'.$aValue['FTSplName']),
                    ...
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXphRemain'])),
            ...
            $values = [
                ...
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(null),
                WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXphPaid_Footer'])),
                WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXphRemain_Footer'])),
                WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXphVat_Footer'])),
                WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCXphGrand_Footer'])),
                WriterEntityFactory::createCell(null),
            ];
            $aRow   = WriterEntityFactory::createRow($values);
            $oWriter->addRow($aRow);
    ...
    public function FSoCCallRptRenderFooterExcel()
    {
        ...
        if (!empty($this->aRptFilter['tCashierCodeFrom']) && !empty($this->aRptFilter['tCashierCodeTo'])) {
            $aCells = [
                WriterEntityFactory::createCell($this->aText['tRptUsrDisFrom'] . ' : ' . $this->aRptFilter['tCashierNameFrom'] . '     ' . $this->aText['tRptUsrDisTo'] . ' : ' . $this->aRptFilter['tCashierNameTo']),
            ];
            $aMulltiRow[] = WriterEntityFactory::createRow($aCells);
        }

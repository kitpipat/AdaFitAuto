...
class Rpttrackinghistory_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rpttrackinghistory_model');
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rpttrackinghistory_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->Rpttrackinghistory_model->FSaMGetDataReport($aDataWhere);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rpttrackinghistory_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->Rpttrackinghistory_model->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport = $this->Rpttrackinghistory_model->FSaMGetDataReport($aDataReportParams);

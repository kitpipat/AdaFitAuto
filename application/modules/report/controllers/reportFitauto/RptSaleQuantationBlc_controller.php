...
class RptSaleQuantationBlc_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/RptSaleQuantationBlc_model');
    ...
    {
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptSaleQuantationBlcTitle'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->RptSaleQuantationBlc_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->RptSaleQuantationBlc_model->FSaMGetDataReport($aDataWhere);
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptSaleQuantationBlcHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->RptSaleQuantationBlc_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRecorder')),
            WriterEntityFactory::createCell(null),
        ...
        $aDataReport = $this->RptSaleQuantationBlc_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTUsrRec']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($aValue['FTUsrAppName']),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCXsdCostEX'], 2)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCXsdNetSale'], 2)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCXsdDiff'], 2)),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(number_format($aValue['FCXsdPerDiff'], 2)),
                    WriterEntityFactory::createCell(null),
                ];
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXsdCostEX_Footer'], 2)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXsdNetSale_Footer'], 2)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXsdDiff_Footer'], 2)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXsdPerDiff_Footer'], 2)),
                        WriterEntityFactory::createCell(null),
                    ];

...
class RptTireDot_controller extends MX_Controller{
    // ภาษา
    public $aText = [];
    ...
    public function __construct(){
        ...
        $this->load->model('report/reportFitauto/RptTireDot_model');
        // Init Report
        $this->init();
        parent::__construct();
    }
    ...
    private function init(){
        // Array Text Label
        $this->aText    = [
            'tTitleReport'          => language('report/report/report', 'tRptTireDotTitle'),
    ...
    public function index(){
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->RptTireDot_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        ...
        $aDataReport    = $this->RptTireDot_model->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView   = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto','wRptTireDotHtml',$aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        $aDataReport    = $this->RptTireDot_model->FSaMGetDataReport($aDataWhereRpt);
        // Load View Advance Table
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport = $this->RptTireDot_model->FSaMGetDataReport($aDataReportParams);

...
class Rptsumdebtoroverdue_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptsumdebtoroverdue_model');
    ...
    {
        $this->aText = [
            'tTitleReport'          => language('report/report/report', 'tRptsumdebtoroverdueTitle'),
        ...
        $this->aRptFilter = [
            ...
            //ประเภทรายการค้าง
            'tStatype' => !empty($this->input->post('ocmtRptStatype')) ? $this->input->post('ocmtRptStatype') : "",
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptsumdebtoroverdue_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->Rptsumdebtoroverdue_model->FSaMGetDataReport($aDataWhere);
            // foreach ($aDataReport['aRptData'] as $key => $value) {
            //   print_r($aDataReport['aRptData'][$key]);
            //   echo "<hr />";
            // }
            // exit();
            ...
            // Load View Advance Table
            $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportFitauto', 'wRptsumdeptrodue', $aDataViewRptParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rptsumdebtoroverdue_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aCells = [
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report','tRptsumdeptrodueCol1')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report','tRptsumdeptrodueCol2')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report','tRptsumdeptrodueCol3')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report','tRptsumdeptrodueCol4')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report','tRptsumdeptrodueCol5')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report','tRptsumdeptrodueCol6')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report','tRptsumdeptrodueCol7')),
            WriterEntityFactory::createCell(null)
        ];
        ...
        $aDataReport = $this->Rptsumdebtoroverdue_model->FSaMGetDataReport($aDataReportParams);

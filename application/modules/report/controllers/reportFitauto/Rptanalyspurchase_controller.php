...
class Rptanalyspurchase_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportFitauto/Rptanalyspurchase_model');
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->Rptanalyspurchase_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase)
    {
        try {
            ...
            $aDataReport = $this->Rptanalyspurchase_model->FSaMGetDataReport($aDataWhere);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->Rptanalyspurchase_model->FSaMGetDataReport($aDataWhereRpt);
    ...
    public function FSvCCallRptExportFile()
    {
        ...
        $aDataReport = $this->Rptanalyspurchase_model->FSaMGetDataReport($aDataReportParams);

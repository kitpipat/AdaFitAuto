        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aSplName as $nKey => $aValue) {
              ...
              foreach ($aData[$nKey] as $key => $value) {
                ...
                $values = [
                    WriterEntityFactory::createCell($value['FTPdtCode']),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell($value['FTPdtName']),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell($value['FCXpdQty']),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell($value['FTPunName']),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(FCNnGetNumeric($value['FCXpdValue'])),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(FCNnGetNumeric($value['FCXpdDis'])),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(FCNnGetNumeric($value['FCXpdVat'])),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(FCNnGetNumeric($value['FCXpdNetAmt']))
                ];
                $aRow = WriterEntityFactory::createRow($values);
                $oWriter->addRow($aRow);
              ...
              $values = [
                  ...
                  WriterEntityFactory::createCell(NULL),
                  WriterEntityFactory::createCell(NULL),
                  WriterEntityFactory::createCell($nFCXpdValue),
                  WriterEntityFactory::createCell(NULL),
                  WriterEntityFactory::createCell($nFCXpdDis),
                  WriterEntityFactory::createCell(NULL),
                  WriterEntityFactory::createCell($nFCXpdVat),
                  WriterEntityFactory::createCell(NULL),
                  WriterEntityFactory::createCell($nFCXpdNetAmt)
              ];
              $aRow = WriterEntityFactory::createRow($values);
              $oWriter->addRow($aRow);
            }

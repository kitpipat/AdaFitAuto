...
class Rptentryproduct_controller extends MX_Controller
{
    ...
    public function  FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell('กุล่มราคา'),
            WriterEntityFactory::createCell(NULL),
            ...
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell('ต้นทุนมาตรฐาน'),
            WriterEntityFactory::createCell(NULL),
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $tFTPdtCatName1= $aValue["FTPdtCatName1"];
                $tFTPdtCatName2 = $aValue["FTPdtCatName2"];
                $tFCPdtCostStd = $aValue["FCPdtCostStd"];
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell($tFTPdtCatName1),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell($tFTPdtCatName2),
                    WriterEntityFactory::createCell(NULL),
                    ...
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(number_format(floatval($tFCPdtCostStd),2),$oStyle),
                    WriterEntityFactory::createCell(NULL),

...
class Rptpurbypdt_controller extends MX_Controller
{
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    ...
                    WriterEntityFactory::createCell(number_format($aValue['FCXpdQty'], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell($aValue['FTPunName']),
                    WriterEntityFactory::createCell(number_format($aValue["FCXpdValue"], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(number_format($aValue["FCXpdDis"], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(number_format($aValue["FCXpdVat"], $this->nOptDecimalShow)),
                    WriterEntityFactory::createCell(number_format($aValue["FCXpdNetAmt"], $this->nOptDecimalShow))
                ];
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    ...
                    $values = [
                        ...
                        WriterEntityFactory::createCell(NULL),
                        WriterEntityFactory::createCell(NULL),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXpdValue_Footer'], $this->nOptDecimalShow)),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXpdDis_Footer'], $this->nOptDecimalShow)),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXpdVat_Footer'], $this->nOptDecimalShow)),
                        WriterEntityFactory::createCell(number_format($aDataTotal['FCXpdNetAmt_Footer'], $this->nOptDecimalShow))
    ...
    public function FSoCCallRptRenderHedaerExcel()
    {
        ...
        if ((isset($this->aRptFilter['tRptDocDateFrom']) && !empty($this->aRptFilter['tRptDocDateFrom'])) && (isset($this->aRptFilter['tRptDocDateTo']) && !empty($this->aRptFilter['tRptDocDateTo']))) {
            $aCells = [
                ...
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(language('report/report/report', 'tRptTaxPointByCstDocDateFrom') . ' ' . date('d/m/Y', strtotime($this->aRptFilter['tRptDocDateFrom'])) . ' ' . language('report/report/report', 'tRptTaxPointByCstDocDateTo') . ' ' . date('d/m/Y', strtotime($this->aRptFilter['tRptDocDateTo']))),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
    ...
    public function FSoCCallRptRenderFooterExcel()
    {
        ...
        if (isset($this->aRptFilter['tPdtDateFrom']) && !empty($this->aRptFilter['tPdtDateFrom'])) {
            $aCells = [
                WriterEntityFactory::createCell($this->aText['tRptDateFrom'] . ' : ' . date('d/m/Y',strtotime($this->aRptFilter['tPdtDateFrom']))),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
                WriterEntityFactory::createCell(NULL),
        ...
        if ($this->aRptFilter['tPdtStaActive'] == 1) {
            $tRptPdtStaActive = $this->aText['tRptPdtMoving1'];
        }elseif ($this->aRptFilter['tPdtStaActive'] == 2){
            $tRptPdtStaActive = $this->aText['tRptPdtMoving2'];
        }else{
            $tRptPdtStaActive = $this->aText['tRptAll'];
        }

        $aCells = [
            WriterEntityFactory::createCell($this->aText['tRptTitlePdtMoving'] . ' : ' . $tRptPdtStaActive),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
        ...
        if ((isset($this->aRptFilter['tPdtSupplierCodeFrom']) && !empty($this->aRptFilter['tPdtSupplierCodeFrom'])) && (isset($this->aRptFilter['tPdtSupplierCodeTo']) && !empty($this->aRptFilter['tPdtSupplierCodeTo']))) {
            $aCells = [

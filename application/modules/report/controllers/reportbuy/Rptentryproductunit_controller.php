...
class Rptentryproductunit_controller extends MX_Controller
{
    ...
    public function  FSvCCallRptRenderExcel()
    {
        ...
        $oStyleColums = (new StyleBuilder())
            ...
            ->build();
        $aCells = [
            WriterEntityFactory::createCell($this->aText['tRptPunum']),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell($this->aText['tRptPunCode']),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell($this->aText['tRptPunName']),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell($this->aText['tRptAgnName']),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),
            WriterEntityFactory::createCell(NULL),

...
class cRptSalesMonthProduct extends MX_Controller
{
    ...
    public function FSvCCallRptRenderExcel(){
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell('หมวดหมู่สินค้าหลัก', $oStyleBold),
            WriterEntityFactory::createCell('หมวดหมู่สินค้าย่อย', $oStyleBold),
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    ...
                    $nSum01_Footer   = $aValue['FCXsdQty01_Footer'];
                    $nSum02_Footer   = $aValue['FCXsdQty02_Footer'];
                    $nSum03_Footer   = $aValue['FCXsdQty03_Footer'];
                    $nSum04_Footer   = $aValue['FCXsdQty04_Footer'];
                    $nSum05_Footer   = $aValue['FCXsdQty05_Footer'];
                    $nSum06_Footer   = $aValue['FCXsdQty06_Footer'];
                    $nSum07_Footer   = $aValue['FCXsdQty07_Footer'];
                    $nSum08_Footer   = $aValue['FCXsdQty08_Footer'];
                    $nSum09_Footer   = $aValue['FCXsdQty09_Footer'];
                    $nSum10_Footer   = $aValue['FCXsdQty10_Footer'];
                    $nSum11_Footer   = $aValue['FCXsdQty11_Footer'];
                    $nSum12_Footer   = $aValue['FCXsdQty12_Footer'];
                    ...
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum01_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum02_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum03_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum04_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum05_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum06_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum07_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum08_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum09_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum10_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum11_Footer)),
                        WriterEntityFactory::createCell(FCNnGetNumeric($nSum12_Footer)),

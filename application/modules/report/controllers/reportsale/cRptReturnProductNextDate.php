...
class cRptReturnProductNextDate extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/mRptReturnProductNextDate');
    ...
    private function init()
    {
        $this->aText = [
            ...
            // TitleReport
            'tTitleReport' => language('report/report/report', 'tRptRPDNextDateTitle'),
            ...
            'tRptRPDDate' => language('report/report/report', 'tRptRPDNextDateDate'),
            'tRptRPDSaleDate' => language('report/report/report', 'tRptRPDNextDateSaleDate'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptReturnProductNextDate->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->mRptReturnProductNextDate->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptReturnProductNextDate', 'wRptReturnProductNextDateHtml', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->mRptReturnProductNextDate->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRPDNextDateDate'),$oStyleBold),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptRPDNextDateSaleDate'),$oStyleBold),
        ...
        $aDataReport = $this->mRptReturnProductNextDate->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                $values = [
                    ...
                    WriterEntityFactory::createCell($aValue['FDXihSalDate']),

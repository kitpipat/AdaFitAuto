...
class cRptPdtSalePromotion extends MX_Controller
{
    ...
    private function init()
    {
        ...
        $this->aRptFilter  = [
            ...
            // 'tDocPromotionCodeTo'    => (empty($this->input->post('oetRptDocPromotionCodeTo'))) ? '' : $this->input->post('oetRptDocPromotionCodeTo'),
            // 'tDocPromotionNameTo'    => (empty($this->input->post('oetRptDocPromotionNameTo'))) ? '' : $this->input->post('oetRptDocPromotionNameTo')
    ...
    public function FSoCCallRptRenderFooterExcel()
    {
        ...
        if ((isset($this->aRptFilter['tSupplierCodeFrom']) && !empty($this->aRptFilter['tSupplierCodeFrom'])) && (isset($this->aRptFilter['tSupplierCodeTo']) && !empty($this->aRptFilter['tSupplierCodeTo']))) {
            ...
            $aMulltiRow[] = WriterEntityFactory::createRow($aCells);
             ...
             // เลขที่เอกสารโปรโมชั่น
             if ((isset($this->aRptFilter['tDocPromotionCodeFrom']) && !empty($this->aRptFilter['tDocPromotionCodeFrom']))) {
                $aCells = [
                    WriterEntityFactory::createCell($this->aText['tRptPmoDocNo'] . ' : ' . $this->aRptFilter['tDocPromotionCodeFrom']),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),
                    WriterEntityFactory::createCell(NULL),

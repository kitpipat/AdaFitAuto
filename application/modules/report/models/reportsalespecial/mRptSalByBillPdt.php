...
class mRptSalByBillPdt extends CI_Model{
    ...
    public function FSnMExecStoreReport($paData){
        ...
        unset($tBchCodeSelect,$tShpCodeSelect,$tPosCodeSelect,$tCallStore,$aDataStore);
        unset($oQuery,$paData);
        return $nDataReturn;
    }
    ...
    public function FSaMGetDataReport($paDataWhere){
        ...
        unset($tJoinFoooter,$tSQL,$oQuery);
        unset($aData,$aErrorList);
        return $aResualt;
    }
    ...
    private function FMaMRPTPagination($paDataWhere){
        ...
        unset($tComName,$tRptCode,$tUsrSession,$tSQL,$oQuery,$nRptAllRecord,$nPage);
        unset($nPerPage,$nPrevPage,$nNextPage,$nRowIDStart,$nTotalPage,$nRowIDEnd);

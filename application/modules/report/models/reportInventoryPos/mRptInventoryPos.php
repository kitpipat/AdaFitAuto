        ...
        if ($nPage == $nTotalPage) {
            $tJoinFoooter = "   
                SELECT 
                    ...
                    SUM(FCPdtCostStdTotal)  AS FCPdtCostStdTotal_Footer
        ...
        $tSQL = "   
            ...
            LEFT JOIN (
                SELECT
                    ...
                    SUM(FCPdtCostStd)     AS FCPdtCostStd_SUM,  
                    SUM(FCPdtCostStdTotal) AS FCPdtCostStdTotal_SUM
                FROM TRPTPdtStkBalTmp WITH(NOLOCK)
                WHERE 1=1
                AND FTComName       = '$tComName'
                AND FTRptCode       = '$tRptCode'

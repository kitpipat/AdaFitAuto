...
class mRptSaleDailyByPos extends CI_Model {
    ...
    public function FSnMExecStoreReport($paDataFilter){
        ...
        unset($nLangID,$tComName,$tRptCode,$tUserSession,$tFilterType,$tBchCodeSelect,$tShpCodeSelect,$tPosCodeSelect,$tCstCodeSelect);
    ...
    public function FSaMGetDataReport($paDataWhere){
        ...
        unset($aPagination,$nRowIDStart,$nRowIDEnd,$tComName,$tRptCode,$tUsrSession,$tSQL);
        unset($oQuery,$aErrorList,$paDataWhere);
        return $aResualt;
    }
    ...
    public function FMaMRPTPagination($paDataWhere){
        ...
        $tSQL           = "   
            ...
            WHERE SPCTMP.FTComName  = ".$this->db->escape($tComName)."
            AND SPCTMP.FTRptCode    = ".$this->db->escape($tRptCode)."
            AND SPCTMP.FTUsrSession = ".$this->db->escape($tUsrSession)."
        ";
        $oQuery         = $this->db->query($tSQL);
    ...
    public function FMxMRPTSetPriorityGroup($paDataWhere){
        ...
        ";
        $this->db->query($tSQL);
        unset($tComName,$tRptCode,$tUsrSession,$tSQL);
    }

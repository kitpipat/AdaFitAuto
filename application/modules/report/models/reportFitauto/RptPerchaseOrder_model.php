...
class RptPerchaseOrder_model extends CI_Model {
    ...
    public function FMaMRPTPagination($paDataWhere) {
        ...
        $tSQL = "   
            ...
            FROM TRPTPurPoTmp ADJSTK_TMP WITH(NOLOCK)
            WHERE 1=1
        ...
        $tSQL   = " SELECT
                    ...
                    FROM (
                        SELECT
                            ...
                            A.*
                        FROM TRPTPurPoTmp A WITH(NOLOCK)
    ...
    public function FSnMCountDataReportAll($paDataWhere) {
        ...
        $tSQL = "   
            ...
            FROM TRPTPurPoTmp AS DTTMP WITH(NOLOCK)
            WHERE 1 = 1

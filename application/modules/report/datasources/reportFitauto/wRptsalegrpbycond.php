        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:20%;" rowspan="2"><?php echo language('report/report/report', 'tRptCol1'); ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:center; width:60%;" rowspan="2"><?php echo language('report/report/report', 'tRptCol2'); ?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="vertical-align : middle;text-align:right; width:10%;" rowspan="2"><?php echo language('report/report/report', 'tRptCol3'); ?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="vertical-align : middle;text-align:right; width:10%;" rowspan="2"><?php echo language('report/report/report', 'tRptCol4'); ?></th>
                        </tr>
                    </thead>
                    <tbody>

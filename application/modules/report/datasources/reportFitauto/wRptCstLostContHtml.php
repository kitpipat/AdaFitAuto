...
<div id="odvRptAdjustStockVendingHtml">
    <div class="container-fluid xCNLayOutRptHtml">
        ...
        <div class="xCNContentReport">
                ...
                <table class="table">
                    <thead>
                        <tr style="border-bottom: 1px solid black !important">
                            ...
                            <th nowrap class="text-center xCNRptColumnHeader" style="width:10%;"><?php echo language('report/report/report', 'tRptCstLostContSatisfact'); ?></th>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                ...
                                <?php 
                                    if($aValue["FNRptRowSeq"] == 1){
                                        $dDate = date('d/m/Y', strtotime($aValue['FDFlwLastDate']));
                                ...
                                ?>
                                <tr style="<?=$tClassTop?>">
                                    <td class="text-center xCNRptDetail"><?php echo $dDate; ?></td>
                                    <td class="text-left xCNRptDetail"><?php echo $aValue["FTCstName"]; ?></td>
                                    <td class="text-left xCNRptDetail"><?php echo ($aValue["FTCstLastName"] == '' ) ? '-' : $aValue["FTCstLastName"]; ?></td>
                                    <td class="text-left xCNRptDetail"><?php echo $aValue["FTFlwDocRef"]; ?></td>
                                    <td class="text-left xCNRptDetail"><?php echo $aValue["FTCarRegNo"]; ?></td>
                                    <td class="text-center xCNRptDetail"><?php echo ($aValue["FNXshScoreValue"] == '' ) ? '0' : $aValue["FNXshScoreValue"] ; ?></td>
            ...
            <?php if( (isset($aDataFilter['tLostContNum']) && !empty($aDataFilter['tLostContNum']))) { ?>
                <!-- ===== ฟิวเตอร์ข้อมูล ลูกค้าขาดการติดต่อ =================================== -->
                <div class="xCNRptFilterBox">
                    <div class="text-left xCNRptFilter">
                        <label class="xCNRptLabel xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptLostCon'].' : </span>'.$aDataFilter['tLostContNum'];?></label>
                    </div>
                </div>
            <?php } ;?>

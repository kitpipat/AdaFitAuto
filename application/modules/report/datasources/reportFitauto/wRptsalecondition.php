        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:5%;" rowspan="2"><?php echo "รหัสสินค้า" ?></th>
                            <th nowrap class="text-center xCNRptColumnHeader" style="vertical-align : middle;text-align:center; width:5%;" rowspan="2"><?php echo "ชื่อสินค้า"; ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:5%;" rowspan="2"><?php echo "ยอดขาย" ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:5%;" rowspan="2"><?php echo "% ยอดขายรวม" ?></th>
                        </tr>

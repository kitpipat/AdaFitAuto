                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                ...
                                <?php if ($aValue['FNFmtAllRow'] == 1) { ?>
                                    <?php if ($aValue['FTCstCode'] == '') { ?>
                                        <tr>
                                            <td nowrap class="xCNRptDetail" colspan="12"><strong>ลูกหนี้ : ไม่ระบุชื่อ </strong></td>
                                        </tr>
                                    <?php } else { ?>
                                        <tr>
                                            <td nowrap class="xCNRptDetail" colspan="12"><strong>ลูกหนี้ : <?php echo $aValue["FTCstName"] . ' / ' . $aValue["FTCstCode"]; ?></strong></td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
                                ...
                                date_format($date,"Y/m/d H:i:s"); -->
                                    ...
                                    <td nowrap class="text-right   xCNRptDetail"><?php echo number_format($aValue["FCXshAmtNV"], $nOptDecimalShow); ?></td>
                                    <td nowrap class="text-right   xCNRptDetail"><?php echo number_format($aValue["FCXshVatable"], $nOptDecimalShow); ?></td>
                                    <td nowrap class="text-right   xCNRptDetail"><?php echo number_format($aValue["FCXshVat"], $nOptDecimalShow); ?></td>
                                ...
                                <?php if ($aValue['FNFmtAllRow'] == $aValue['FNFmtEndRow']) { ?>
                                    ...
                                    <tr>
                                        <td nowrap class="xCNRptDetail" colspan="3"><strong>รวม : <?php echo $aValue["FTCstName"] . ' / ' . $aValue["FTCstCode"] . ' ' . $aValue['FNFmtEndRow'] . ' ' . 'รายการ'; ?></strong></td>
                                        <td nowrap class="text-right   xCNRptDetail"><?php echo number_format($aValue["FCXshAmtNV_SubTotal"], $nOptDecimalShow); ?></td>
                                        <td nowrap class="text-right   xCNRptDetail"><?php echo number_format($aValue["FCXshVatable_SubTotal"], $nOptDecimalShow); ?></td>
                                        <td nowrap class="text-right   xCNRptDetail"><?php echo number_format($aValue["FCXshVat_SubTotal"], $nOptDecimalShow); ?></td>
                                        <td nowrap class="text-right   xCNRptDetail"><?php echo number_format($aValue["FCXshGrand_SubTotal"], $nOptDecimalShow); ?></td>

...
?>
<style type="text/css">
    .table thead th, .table>thead>tr>th, .table tbody tr, .table>tbody>tr>td{ border: 0px transparent !important;} .table>thead:first-child>tr:first-child>td, .table>thead:first-child>tr:first-child>th{ border-top: 1px solid black !important; border-bottom: dashed 1px #333 !important;} @media print{ @page{ size: landscape}}
</style>
        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo language('report/report/report', 'tRptBarchCode'); ?></th>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo language('report/report/report', 'tRPC15TBBchName'); ?></th>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo language('report/report/report', 'tRptXshDocNo'); ?></th>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo language('report/report/report', 'tRptSRCDate'); ?></th>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo language('report/report/report', 'tRptOpenJobStaDoc'); ?></th>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo language('report/report/report', 'tRptCstLostContLicense'); ?></th>
                            ...
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo language('report/report/report', 'tRptTotalSub2'); ?></th>
                            <th nowrap class="text-center xCNRptColumnHeader"><?php echo language('report/report/report', 'tRptValue'); ?></th>
                        ...
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) : ?>
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                <tr style="border-top: 1px solid #ddd !important;">
                                    <td class='xCNRptDetail text-center'><?=$aValue['FTBchCode']?></td>
                                    <td class='xCNRptDetail text-left'><?=$aValue['FTBchName']?></td>
                                    <td class='xCNRptDetail text-center'><?=$aValue['FTXshDocNo']?></td>
                                    ...
                                    <td class='xCNRptDetail text-left'><?=$aValue['FTCarRegNo']?></td>
                                    ...
                                    <td class='xCNRptDetail text-right'><?=number_format($aValue['FCXshDiscount'], $nOptDecimalShow)?></td>
                            ...
                            if ($nPageNo == $nTotalPage) { ?>
                                <tr class='xCNTrFooter'>
                                    ...
                                    <td class='xCNRptSumFooter text-right'><?php echo number_format($aDataTotal['FCXshTotal_Footer'], $nOptDecimalShow)?></td>
                                    <td class='xCNRptSumFooter text-right'><?php echo number_format($aDataTotal['FCXshDiscount_Footer'], $nOptDecimalShow)?></td>
                                    <td class='xCNRptSumFooter text-right'><?php echo number_format($aDataTotal['FCXshGrand_Footer'], $nOptDecimalShow)?></td>
                                    <td class='xCNRptSumFooter text-right'><?php echo number_format($aDataTotal['FCXshVatable_Footer'], $nOptDecimalShow)?></td>
            ...
            <?php
                $tStaOdr = '';
                if ($aDataFilter['tStaOdr'] == 1) {
                    $tStaOdr = language('report/report/report', 'tRptPhStaOdr1');
                }elseif ($aDataFilter['tStaOdr'] == 2) {
                    $tStaOdr = language('report/report/report', 'tRptPhStaOdr2');
                }elseif ($aDataFilter['tStaOdr'] == 3) {
                    $tStaOdr = language('report/report/report', 'tRptPhStaOdr3');
                }else{
                    $tStaOdr = language('report/report/report', 'tRptAll');
                }
            ?>
            <?php if (isset($aDataFilter['tStaOdr']) && !empty($aDataFilter['tStaOdr'])) { ?>
                <div class="xCNRptFilterBox">
                    <div class="xCNRptFilter">

        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-center   xCNRptColumnHeader" style="width:10%;">วันที่</th>
                            <th nowrap class="text-center   xCNRptColumnHeader" style="width:10%;">สาขา</th>
                            <th nowrap class="text-center   xCNRptColumnHeader" style="width:10%;">เลขที่เอกสาร</th>
                            <th nowrap class="text-center   xCNRptColumnHeader" style="width:10%;">เลขที่ใบวางบิล</th>
                            <th nowrap class="text-center   xCNRptColumnHeader" style="width:10%;">วันที่วางบิล</th>
                            <th nowrap class="text-right   xCNRptColumnHeader" style="width:10%;">ยอดในบิล</th>
                            <th nowrap class="text-right   xCNRptColumnHeader" style="width:10%;">ยอดชำระ</th>
                            <th nowrap class="text-right   xCNRptColumnHeader" style="width:10%;">ยอดคงค้าง</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) : ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                ...
                                date_format($date,"Y/m/d H:i:s"); -->
                                    <td nowrap class="text-center   xCNRptDetail"><?php echo  date("d/m/Y", strtotime($aValue["FDXphDocDate"])); ?></td>

                                    <td nowrap class="text-center   xCNRptDetail"><?php echo $aValue["FTBchName"]; ?></td>
                                    <td nowrap class="text-center   xCNRptDetail"><?php echo $aValue["FTXphDocNo"]; ?></td>
                                    <td nowrap class="text-center   xCNRptDetail"><?php echo $aValue["FTXshRefDocNo"]; ?></td>
                                    <td nowrap class="text-center   xCNRptDetail"><?php echo $aValue["FTXshRefDocDate"]; ?></td>
                                ...
                                <?php if ($aValue['FNFmtAllRow'] == $aValue['FNFmtEndRow']) { ?>
                                    ...
                                    <tr>
                                        <td nowrap class="xCNRptDetail" colspan="5"><strong>รวมเจ้าหนี้ : <?php echo $aValue["FTSplName"] . ' / ' . $aValue["FTSplCode"] . ' ' . $aValue['FNFmtEndRow'] . ' ' . 'รายการ'; ?></strong></td>

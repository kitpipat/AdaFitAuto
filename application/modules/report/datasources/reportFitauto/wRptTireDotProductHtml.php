                        ...
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) : ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                ...
                                ?>
                                    ...
                                    <?php if($tKeepPdtNo != $aValue['FTPdtCode'] ) { ?>
                                        <td class='xCNRptDetail text-left' <?=$nRowspan?>><?=$aValue['FTPdtCode']?></td>
                                        <td class='xCNRptDetail text-left' <?=$nRowspan?>><?=$aValue['FTPdtName']?></td>
                                    <?php } ?>
                                        ...
                                        <td class='xCNRptDetail text-center'><?php echo language('report/report/report', 'tRptDotStaUse'.$aValue['FTLotStaUse'].''); ?></td>
                                </tr>
                            <?php $tKeepPdtNo = $aValue['FTPdtCode']; ?>
                            <?php endforeach; ?>
                            <?php

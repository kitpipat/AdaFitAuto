                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th nowrap class="text-left   xCNRptColumnHeader" style="width:10%;">สาขา</th>
                            ...
                            <th nowrap class="text-left   xCNRptColumnHeader" style="width:10%;">อ้างอิงใบเสร็จรับเงิน</th>
                    ...
                    <tbody>
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) : ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                ...
                                <tr>
                                    <td class="text-left xCNRptDetail"><?=(!empty($aValue['FTCstName']))? $aValue['FTCstName'] : '-' ?></td>
                                ...
                                <?php if($aValue['PARTTITIONBYCST'] == $aValue['PARTTITIONBYCST_COUNT']){ ?>
                                    <tr class="xCNRptSumFooterTrTop">
                                        <? if($aValue["FTCstName"] != '') {?>
                                        <td class="xCNRptSumFooter" colspan="6">ยอดรวม : <?=$aValue["FTCstName"]; ?></td>
                            ...
                            if ($nPageNo == $nTotalPage) { ?>
                                <tr>
                                    ...
                                    <td nowrap class="xCNRptDetail" colspan="5"></td>

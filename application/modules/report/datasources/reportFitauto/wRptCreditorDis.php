        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left   xCNRptColumnHeader" style="width:10%;"><?=language('report/report/report', 'tRptDocPdtTwiSrcTypeAgn')?>/<?=language('report/report/report', 'tRptCreditorName')?></th>
                            <th nowrap class="text-left   xCNRptColumnHeader" style="width:10%;"><?=language('report/report/report', 'tRptXshDocNo')?></th>
                            <th nowrap class="text-left   xCNRptColumnHeader" style="width:10%;"><?=language('report/report/report', 'tRptDateDocument')?></th>
                            <th nowrap class="text-left   xCNRptColumnHeader" style="width:10%;"><?=language('report/report/report', 'tRPC1TBCardTxnDocNoRef')?></th>
                            <th nowrap class="text-right   xCNRptColumnHeader" style="width:10%;"><?=language('report/report/report', 'tRptVatNoPay')?></th>
                            <th nowrap class="text-right   xCNRptColumnHeader" style="width:10%;"><?=language('report/report/report', 'tRptVatCalculate')?></th>
                            <th nowrap class="text-right   xCNRptColumnHeader" style="width:10%;"><?=language('report/report/report', 'tRptWhtVat')?></th>
                            <th nowrap class="text-right   xCNRptColumnHeader" style="width:10%;"><?=language('report/report/report', 'tRptWhtGrand')?></th>
                            <th nowrap class="text-center   xCNRptColumnHeader" style="width:10%;"><?=language('report/report/report', 'tRptUserDis')?></th>
            ...
            <?php if ((isset($aDataFilter['tPdtSupplierCodeFrom']) && !empty($aDataFilter['tPdtSupplierCodeFrom'])) && (isset($aDataFilter['tPdtSupplierCodeTo']) && !empty($aDataFilter['tPdtSupplierCodeTo']))) { ?>
                ...
                <div class="xCNRptFilterBox">
                    <div class="text-left xCNRptFilter">
                        <label class="xCNRptLabel xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptUsrDisFrom'] . ' : </span>' . $aDataFilter['tPdtSupplierNameFrom']; ?></label>
                        <label class="xCNRptLabel xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptUsrDisTo'] . ' : </span>' . $aDataFilter['tPdtSupplierNameTo']; ?></label>
                    </div>
                </div>
            <?php }; ?>
            ...
            <?php if ((isset($aDataFilter['tCashierCodeFrom']) && !empty($aDataFilter['tCashierCodeFrom'])) && (isset($aDataFilter['tCashierCodeTo']) && !empty($aDataFilter['tCashierCodeTo']))) { ?>
                ...
                <div class="xCNRptFilterBox">
                    <div class="text-left xCNRptFilter">
                        <label class="xCNRptLabel xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptSplFrom'] . ' : </span>' . $aDataFilter['tCashierNameFrom']; ?></label>
                        <label class="xCNRptLabel xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptSplTo'] . ' : </span>' . $aDataFilter['tCashierNameTo']; ?></label>
                    </div>
                </div>
            <?php }; ?>

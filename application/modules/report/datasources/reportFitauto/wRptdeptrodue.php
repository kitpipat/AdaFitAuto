        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:5%;" rowspan="2"><?php echo language('report/report/report','tRptdeptrodueCol1');?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:10%;" rowspan="2"><?php echo language('report/report/report','tRptdeptrodueCol2'); ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:10%;" rowspan="2"><?php echo language('report/report/report','tRptdeptrodueCol3');?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="vertical-align : middle;text-align:right; width:5%;" rowspan="2"><?php echo language('report/report/report','tRptdeptrodueCol4');?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="vertical-align : middle;text-align:right; width:5%;" rowspan="2"><?php echo language('report/report/report','tRptdeptrodueCol5');?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="vertical-align : middle;text-align:right; width:5%;" rowspan="2"><?php echo language('report/report/report','tRptdeptrodueCol6');?></th>
                        </tr>
                    </thead>
                    <tbody>
                      <?php
                      ...
                      <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) { ?>
                          <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                            ...
                            if($aValue['rtPartitionCST'] == 1){  ?>
                              <tr>
                                 <td colspan="6" class="text-left xCNRptGrouPing">ลูกหนี้ (<?php echo  $aValue['FTCstCode'];?>) <?php echo $aValue['FTCstName']; ?></td>
                               </tr>
                            <?php } ?>
                            <tr>
                            ...
                            <?php if($aValue['rtPartitionCST'] == $aValue['rtPartitionCountCST']){ ?>
                              <tr>
                                 <td colspan="3" style='border-top: dashed 1px #333 !important;border-bottom: solid 1px #333 !important;' class="text-left xCNRptGrouPing" style="text-indent:22px;">รวมลูกหนี้ (<?php echo  $aValue['FTCstCode_CST_Footer'];?>) <?php echo $aValue['FTCstName']; ?></td>
                                 <td style='border-top: dashed 1px #333 !important;border-bottom: solid 1px #333 !important;' class="text-right xCNRptGrouPing"><?php echo number_format($aValue['FCXshGrand_CST_Footer'],$nOptDecimalShow); ?></td>
                                 <td style='border-top: dashed 1px #333 !important;border-bottom: solid 1px #333 !important;' class="text-right xCNRptGrouPing"><?php echo number_format($aValue['FCXshPaid_CST_Footer'],$nOptDecimalShow); ?></td>
                                 <td style='border-top: dashed 1px #333 !important;border-bottom: solid 1px #333 !important;' class="text-right xCNRptGrouPing"><?php echo number_format($aValue['FCXshLeft_CST_Footer'],$nOptDecimalShow); ?></td>
                               </tr>
                             <?php }
                           }
                       ...
                       <tr>
                          <td colspan="3" style='border-top: dashed 1px #333 !important;border-bottom: solid 1px #333 !important;' class="text-left xCNRptGrouPing" style="text-indent:22px;">รวม</td>

        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:10%;" rowspan="2"><?php echo $aDataTextRef['tRptPdtCode']; ?></th>
                            ...
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:20%;" rowspan="2"><?php echo $aDataTextRef['tRptCat1']; ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="vertical-align : middle;text-align:left; width:20%;" rowspan="2"><?php echo $aDataTextRef['tRptCat2']; ?></th>
                            <th nowrap class="text-center xCNRptColumnHeader" colspan="5" style='border-bottom: dashed 1px #333 !important;'><?php echo $aDataTextRef['tRptPdtInven'];?></th>
                        </tr>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) { ?>
                                ...
                                <?php
                                    ...
                                    if($tChainCodeName != $tChainCode ){
                                        ...
                                        for ($i = 0; $i < FCNnHSizeOf($aGroupChain); $i++) {
                                            if ($aGroupChain[$i] !== 'N') {
                                                ...
                                                echo "<td class='xCNRptGrouPing  text-left' style='padding: 5px;' colspan='7'>".$tNmaeLang." : " . $tGrounp . "</td>";
                                            } else {
                                                echo "<td></td>";
                                            }
                                        }
                                    ...
                                    if($tPDTCodeOld == $tPDTCodeOnly){
                                        ...
                                        //ทุนรวมเฉลี่ย
                                        $nFCPdtCostTotal_SUM = $aValue["FCPdtCostTotal_SUM"];

                                        //ต้นทุนมาตราฐาน
                                        $nFCPdtCostStd_SUM = $aValue["FCPdtCostStd"];

                                        //ทุนรวมมาตราฐาน
                                        $nFCPdtCostStdTotal_SUM = $aValue["FCPdtCostStdTotal_SUM"];
                                ...
                                <tr>
                                    ...
                                    <td nowrap class="text-left xCNRptDetail" style="padding-left: 50px !important;" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp; <?=$tWAHCode?></td>

...
<div id="odvRptSaleVatInvoiceByBillHtml">
    <div class="container-fluid xCNLayOutRptHtml">
        ...
        <div class="xCNContentReport">
            ...
            <?php if(isset($aDataFilter['aDataFilter']['tCate1From']) && !empty($aDataFilter['aDataFilter']['tCate1From'])) { ?>
                <div class="xCNRptFilterBox">
                    <div class="text-left xCNRptFilter">
                        <label class="xCNRptLabel xCNRptDisplayBlock"><span class="xCNRptFilterHead">หมวดหมู่สินค้าหลัก : </span><?=$aDataFilter['aDataFilter']['tCate1FromName'];?></label>
                    </div>
                </div>
            <?php } ;?>

            <!-- ============================ ฟิวเตอร์ข้อมูล หมวดหมู่สินค้าย่อย ============================ -->
            <?php if(isset($aDataFilter['aDataFilter']['tCate2From'])  && !empty($aDataFilter['aDataFilter']['tCate2From'])){ ?>
                <div class="xCNRptFilterBox">
                    <div class="text-left xCNRptFilter">
                        <label class="xCNRptDisplayBlock" ><span class="xCNRptFilterHead">หมวดหมู่สินค้าย่อย : </span><?=$aDataFilter['aDataFilter']['tCate2FromName'];?></label>
                    </div>
                </div>
            <?php } ?>

                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:15%;"><?php echo $aDataTextRef['tRptCat1'];?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:15%;"><?php echo $aDataTextRef['tRptCat2'];?></th>
                            ...
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptinventoryCostSTD'];?></th>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td class="xCNRptDetail"><?php if($aValue["FTPdtCatName1"]==""){ echo "-"; }else{  echo $aValue["FTPdtCatName1"]; } ?></td>
                                  <td class="xCNRptDetail"><?php if($aValue["FTPdtCatName2"]==""){ echo "-"; }else{  echo $aValue["FTPdtCatName2"]; } ?></td>
                                  ...
                                  <td class="xCNRptDetail text-right"><?php echo number_format($aValue["FCPdtCostStd"],$nOptDecimalShow); ?></td>

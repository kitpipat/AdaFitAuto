        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left xCNRptColumnHeader" >คูปอง</th>
                            <th nowrap class="text-left xCNRptColumnHeader"></th>
                            <th nowrap class="text-left xCNRptColumnHeader"></th>
                            <th nowrap class="text-left xCNRptColumnHeader"></th>
                            <th nowrap class="text-right xCNRptColumnHeader">รูปแบบคูปอง</th>
                            <th nowrap class="text-left xCNRptColumnHeader"></th>
                            <th nowrap class="text-left xCNRptColumnHeader"></th>
                            <th nowrap class="text-left xCNRptColumnHeader"></th>
                            <th nowrap class="text-left xCNRptColumnHeader"></th>
                        ...
                        <tr style="border-bottom: 1px solid black !important">
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:15%;">&nbsp;&nbsp;สาขา</th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptPmoDocNo']; ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptPmoDate']; ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:10%;">รหัสสินค้า</th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:20%;"><?php echo $aDataTextRef['tRptPmoProduct']; ?></th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:10%;">หมวดหมู่สินค้าหลัก</th>
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:10%;">หมวดหมู่สินค้าย่อย</th>
                            ...
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:10%;"><?php echo $aDataTextRef['tRptPricePromotion']; ?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:10%;">รหัสคูปอง</th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:10%;">ประเภทการชำระเงิน</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) : ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                ...
                                <?php
                                $aGrouppingData = array($tPmhDocNo, "N", "N", $tGetTypePmh, "N", $tQtyPer, "N", $nFCXsdNet, $nFCXpdDis, $nFCXsdNetPmt);
                                if ($nRowPartID == 1) {
                                    ...
                                    for ($i = 0; $i < FCNnHSizeOf($aGrouppingData); $i++) {
                                        ...
                                        if (strval($aGrouppingData[$i]) != "N") {
                                            if($i == 0){
                                                echo "<td colspan='3' class='xCNRptGrouPing " . $tTextStyle . "' style='padding: 5px; " . $tTextInden . " " . $tWidth . " '>" . $aGrouppingData[$i] . "</td>";
                                            }else{
                                ...
                                <tr>
                                    ...
                                    <td class="text-left xCNRptDetail" ><?=($aValue['FTPdtCatName1'] == '') ? '-' : $aValue['FTPdtCatName1']?></td>
                                    <td class="text-left xCNRptDetail" ><?=($aValue['FTPdtCatName2'] == '') ? '-' : $aValue['FTPdtCatName2']?></td>
                                    ...
                                    <td class="text-right xCNRptDetail"><?php echo number_format($aValue["FCXsdNetPmt"], $nOptDecimalShow); ?></td>
                                    <td class="text-right xCNRptDetail"><?php echo $aValue["FTXddRefCode"]; ?></td>
                                    <td class="text-right xCNRptDetail"><?=($aValue['FTRcvName'] == '') ? '-' : $aValue['FTRcvName']?></td>
                                </tr>

                                <?php
                                    // Step 5 เตรียม Parameter สำหรับ SumFooter
                                    $nFCXsdQty_Footer    = intval($aValue["FCXsdQty_Footer"]);
                                    $nFCXsdNet_Footer    = $aValue["FCXsdNet_Footer"];
                                    $nFCXpdDis_Footer    = $aValue["FCXpdDis_Footer"];
                                    $nFCXsdNetPmt_Footer = $aValue["FCXsdNetPmt_Footer"];
                                    $aFooterSumData      = array($aDataTextRef['tRptAdjStkVDTotalFooter'], 'N' , 'N', 'N', 'N', 'N', 'N', number_format($nFCXsdQty_Footer, $nOptDecimalShow), "N", number_format($nFCXsdNet_Footer, $nOptDecimalShow), number_format($nFCXpdDis_Footer, $nOptDecimalShow), number_format($nFCXsdNetPmt_Footer, $nOptDecimalShow),'N','N');
                                ?>
            ...
            <?php if (isset($aDataFilter['tCouponCodeFrom']) && !empty($aDataFilter['tCouponCodeFrom'])) : ?>
                <div class="xCNRptFilterBox">
                    <div class="xCNRptFilter">
                        <label class="xCNRptLabel xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptPmoCoupon'] . ' : </span>' . $aDataFilter['tCouponCodeFrom']; ?></label>
                    </div>
                </div>
            <?php endif; ?>

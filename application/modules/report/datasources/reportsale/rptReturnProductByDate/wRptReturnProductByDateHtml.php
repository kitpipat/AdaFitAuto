                ...
                <table class="table" >
                    <thead>
                        <tr>
                            ...
                            <th class="text-left xCNRptColumnHeader" width="10%" rowspan="2" style="vertical-align: middle;"><?php echo language('report/report/report', 'tRptSalByBranchBchName') ?></th>
                        </tr>
                        <tr>
                            ...
                            <?php foreach($aDataReport['aRptData'] as $aData){ ?>
                                ...
                                <?php
                                    if($nRowPartID == 0 && $aData["FTXthTnsType"] == "1") { // Grouping Data
                                        $aGrouppingData = array($tXihDocNo,$tRefIn,$tDocDate,"N","N", $cXshRnd, $cXtdAmount, $tRsnName, $tUsrName, $tXshApvName,$tBchName);

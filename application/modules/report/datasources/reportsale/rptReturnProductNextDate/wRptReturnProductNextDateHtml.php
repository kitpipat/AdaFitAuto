                ...
                <table class="table" >
                    <thead>
                        <tr>
                            ...
                            <th class="text-left xCNRptColumnHeader" style="border-bottom: 1px dashed black !important;"><?php echo language('report/report/report', 'tRptSalByBranchBchName') ?></th>
                            ...
                            <?php foreach($aDataReport['aRptData'] as $aData){ ?>
                                ...
                                <?php
                                    if($nRowPartID == 0 && $aData["FTXthTnsType"] == "1") { // Grouping Data
                                        ...
                                        $aGrouppingData = array($tXihDocNo,$tRefIn,$tDocDate,$tSalDate, $cXshRnd, $cXtdAmount, $tRsnName,$tUsrName,$tBchName);

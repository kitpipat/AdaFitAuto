...
<div id="odvRptPdtSalePromotionPerDocHtml">
    <div class="container-fluid xCNLayOutRptHtml">
        ...
        <div class="xCNContentReport">
                ...
                <table class="table">
                    <thead>
                        ...
                        <tr style="border-bottom: 1px solid black !important">
                            ...
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:13%;">รหัสสินค้า</th>
                            ...
                            <th nowrap class="text-left xCNRptColumnHeader" style="width:20%;"><?php echo $aDataTextRef['tRptPmoSup'];?></th>
                            ...
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:20%;">ประเภทการชำระเงิน</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) : ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) : ?>
                                ...
                                <?php
                                $aGrouppingData = array($tPmhDocNo, "N", "N", "N", "N", $tGetTypePmh, "N", $tQtyPer, "N", $nFCXsdNet, $nFCXpdDis, $nFCXsdNetPmt);
                                if ($nRowPartID == 1) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-left xCNRptDetail" ><?=($aValue['FTSplName'] == '') ? '-' : $aValue['FTSplName']?></td>
                                ...
                                <?php
                                    ...
                                    $aFooterSumData      = array($aDataTextRef['tRptAdjStkVDTotalFooter'], 'N','N', 'N' , 'N', 'N', 'N', 'N', 'N', number_format($nFCXsdQty_Footer, $nOptDecimalShow), "N", number_format($nFCXsdNet_Footer, $nOptDecimalShow), number_format($nFCXpdDis_Footer, $nOptDecimalShow), number_format($nFCXsdNetPmt_Footer, $nOptDecimalShow));
                                ?>
            ...
            <!-- ============================ ฟิวเตอร์ข้อมูล เลขที่เอกสารโปรโมชั่น ============================ -->
            <?php if (isset($aDataFilter['tDocPromotionCodeFrom']) && !empty($aDataFilter['tDocPromotionCodeFrom'])) : ?>
                <div class="xCNRptFilterBox">
                    <div class="xCNRptFilter">
                        <label class="xCNRptLabel xCNRptDisplayBlock"><span class="xCNRptFilterHead"><?php echo $aDataTextRef['tRptPmoDocNo'] . ' : </span>' . $aDataFilter['tDocPromotionCodeFrom']; ?></label>
                    </div>
                </div>
            <?php endif; ?>

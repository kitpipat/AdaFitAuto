...
<div class="col-lg-6 col-md-6 col-xs-12 ">
    ...
    <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="$('#obtGpShopCancel').click()"><?php echo language('company/shopgpbyshp/shopgpbyshp','tSGPSTitle')?></label>
    <label class="xCNLabelFrm">
...
<!--ปุ่มยกเลิก กับ ปุ่มบันทึก-->
 <div class="col-lg-6 col-md-6 col-xs-12   text-right">
    ...
    <?php if($aAlwEventShopGpByShp['tAutStaFull'] == 1 || ($aAlwEventShopGpByShp['tAutStaAdd'] == 1 || $aAlwEventShopGpByShp['tAutStaEdit'] == 1)) : ?>
            <button type="submit" class="btn xCNBTNSubSave" id="obtGpShopBySHPSave" onclick="JSoAddShopGpBySHP('','<?= $tRoute?>')"> <?php echo  language('common/main/main', 'tSave')?></button>
    <?php endif; ?>
</div>

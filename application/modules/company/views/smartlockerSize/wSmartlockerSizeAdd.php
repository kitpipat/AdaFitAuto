...
<form class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddSms">
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxGetSHPContentSmartLockerSize();" ><?php echo language('company/smartlockerSize/smartlockerSize','tSMSSize')?></label>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
            ...
            <?php if($aAlwEventSmartlockerSize['tAutStaFull'] == 1 || ($aAlwEventSmartlockerSize['tAutStaAdd'] == 1 || $aAlwEventSmartlockerSize['tAutStaEdit'] == 1)) : ?>
                    <button type="submit" class="btn xCNBTNSubSave" id="obtGpShopBySHPSave" onclick="JSvSMSAddEdit('<?= $tRoute?>')"> <?php echo  language('common/main/main', 'tSave')?></button>
            <?php endif; ?>
            </div>
        </div>
    </div>

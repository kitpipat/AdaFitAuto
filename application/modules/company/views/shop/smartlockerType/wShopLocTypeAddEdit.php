...
<div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxGetSHPContentSmartLockerType();"><?=language('company/shop/shop','tNameTabSmartLockerLayout')?></label>
   ...
   <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
        ...
        <?php 
            if($tStatus == 'pageadd'){ ?>
                <button type="submit" class="btn xCNBTNSubSave" onclick="JSvSmartLockertTypeEventAdd()"> 
                    <?=language('common/main/main', 'tSave')?>
                </button>
            <?php }else{ ?>
                <button type="submit" class="btn xCNBTNSubSave" onclick="JSvSmartLockertTypeEventEdit('<?=$tBchCodeSend?>','<?=$tShpCode?>')"> 
                    <?=language('common/main/main', 'tSave')?>
                </button>
            <?php } ?>
    </div>

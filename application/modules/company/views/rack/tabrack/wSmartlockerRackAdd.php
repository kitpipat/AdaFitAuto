...
<form class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddRac">
	<div class="row">
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
			<label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxGetSHPContentRack();" ><?php echo language('company/rack/rack','tRckTitle')?></label>
		...
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
			...
			<button type="submit" class="btn xCNBTNSubSave" id="obtGpShopBySHPSave" onclick="JSnAddEditRack('<?= $tRoute?>')"> <?php echo  language('common/main/main', 'tSave')?></button>
		</div>
	</div>
	<div class="row">

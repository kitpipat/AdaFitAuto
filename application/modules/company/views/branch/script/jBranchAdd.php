<script type="text/javascript">
    ...
    var oBchBrowseWah = {
        ...
        Where :{
            Condition : ["AND TCNMWaHouse.FTWahStaType IN ('1','2') AND TCNMWaHouse.FTBchCode = '"+tBchCode+"' "]
        },
        GrideView:{
    ...
    $(document).ready(function(){
        ...
        $('#obtBchBrowseAgency').click(function(){
            ...
            if ($('#ocmBchType').val() == "2") { //ตัวแทนขาย
                tWhereAgn = " AND TCNMAgency.FTAgnType ='1' ";
            }else if($('#ocmBchType').val()== "4") { //แฟรนด์ไซส์
                tWhereAgn = " AND TCNMAgency.FTAgnType ='2' ";
            }
            oBchBrowseAgency = {
    ...
    //โหลดข้อมูล คลังสินค้า
    function JCNvCallWAHContent(){
        var ptBchCode       = '<?php echo $tBchCode;?>';

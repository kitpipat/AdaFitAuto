                    ...
                    <?php foreach($aDataList['raItems'] AS $key=>$aValue){ ?>
                        ...
                        <tr class="text-center xCNTextDetail2 otrDistrict" id="otrBranch<?php echo $key?>" data-code="<?php echo $aValue['rtBchCode']?>" data-name="<?php echo $aValue['rtBchName']?>">
                            ...
                            <td class="text-center">
                                <label class="fancy-checkbox">
                                    <input id="ocbListItem<?php echo $key?>" type="checkbox" class="ocbListItem"
                                    data-checkrow="<?php echo $tDisabledcheckrow; ?>"
                                    data-checkrowid="<?php echo $aValue['rtBchCode']?>" checked="false"
                                    name="ocbListItem[]" <?=$tDisabledItem ;?>>
                            ...
                            <?php if($BchCode == '' || $BchCode == null) : ?>
                                <?php if($aAlwEventBranch['tAutStaFull'] == 1 || $aAlwEventBranch['tAutStaDelete'] == 1 ) : ?>
                                    <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtBchCode']?>">
                                        <img id="oimDel<?php echo $aValue['rtBchCode']; ?>"  class="xCNIconTable <?php echo $tDisableImg; ?>"
                                         src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                                          onClick="JSnBranchDel('<?php echo $nCurrentPage?>','<?php echo $aValue['rtBchCode']?>','<?php echo $aValue['rtBchName']?>','<?php echo language('common/main/main', 'tBCHYesOnNo')?>')">
                                    </td>
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if($aAlwEventBranch['tAutStaFull'] == 1 || ($aAlwEventBranch['tAutStaEdit'] == 1 || $aAlwEventBranch['tAutStaRead'] == 1)) : ?>

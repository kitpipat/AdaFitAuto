...
<form class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddEditBchSettingConnect">
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxBranchSetingConnection();" ><?php echo language('company/settingconnection/settingconnection','tDetailSettingConnect')?></label>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
            <button type="button" onclick="JSxBranchSetingConnection();" class="btn" style="background-color: #D4D4D4; color: #000000;">
                ...
                <?php if($aAlwEventBchSettingCon['tAutStaFull'] == 1 || ($aAlwEventBchSettingCon['tAutStaAdd'] == 1 || $aAlwEventBchSettingCon['tAutStaEdit'] == 1)) : ?>
                    ...
                    <button type="submit" class="btn xCNBTNSubSave" id="obtBchSettingConnectSave" onclick="JSxBchSettingConnectSaveAddEdit('<?=$tRoute?>')"> <?php echo  language('common/main/main', 'tSave')?></button>
                <?php endif;?>
            </div>
        </div>

...
<form class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddEditCompSettingConnect">
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxCompSettingConnect();" ><?php echo language('company/compsettingconnect/compsettingconnect','tDetailSettingConnect')?></label>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
            ...
            <?php if($aAlwEventCompSettingCon['tAutStaFull'] == 1 || ($aAlwEventCompSettingCon['tAutStaAdd'] == 1 || $aAlwEventCompSettingCon['tAutStaEdit'] == 1)) : ?>
                ...
                <button type="submit" class="btn xCNBTNSubSave" id="obtBchSettingConnectSave" onclick="JSxCompSettingConnectSaveAddEdit('<?=$tRoute?>')"> <?php echo  language('common/main/main', 'tSave')?></button>
            <?php endif;?>
            </div>
        </div>

                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            type="text"
                                            class="form-control xCNInputNumeric"
                                            id="oetCmpTel"
                                            name="oetCmpTel"
                                            maxlength="50"
                                            value="<?php echo $tCmpTel;?>"
                                        >
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control xCNInputNumeric" id="oetCmpFax" name="oetCmpFax" maxlength="50" value="<?php echo $tCmpFax;?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">

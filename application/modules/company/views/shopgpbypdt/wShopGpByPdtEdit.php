...
<div class="col-xs-12 col-md-9 col-lg-9">
    <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="$('#obtGpShopCancel').click()"><?php echo language('company/shopgpbypdt/shopgpbypdt','tSGPPTitle')?></label>

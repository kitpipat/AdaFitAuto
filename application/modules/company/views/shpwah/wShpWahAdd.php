...
<form class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" id="ofmAddEditShpWah">
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxShpWahGetContent();" ><?php echo language('company/shop/shop','tShpWahTitle')?></label>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
            <button type="button" onclick="JSxShpWahGetContent();" class="btn" style="background-color: #D4D4D4; color: #000000;">
                ...
                <button type="submit" class="btn xCNBTNSubSave" id="obtUsrloginSave" onclick="JSxShpWahSaveAddEdit('<?=$tRoute?>')"> <?php echo  language('common/main/main', 'tSave')?></button>
            </div>
        </div>

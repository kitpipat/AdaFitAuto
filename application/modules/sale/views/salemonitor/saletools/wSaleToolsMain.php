                                ...
                                <div class="col-xs-12 col-md-2 col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control xWPointerEventNone" placeholder="<?=language('sale/salemonitor/salemonitor', 'tSMTBchName')?>" id="oetSMTSALFilterBchNameTool" name="oetSMTSALFilterBchNameTool" readonly>
                                ...
                                <div class="col-xs-12 col-md-2 col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control xWPointerEventNone" placeholder="<?=language('sale/salemonitor/salemonitor', 'tSMTPos')?>" id="oetSMTSALFilterPosNameTool" name="oetSMTSALFilterPosNameTool" readonly>
                                            <span class="input-group-btn">

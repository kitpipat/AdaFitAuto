...
<div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSxCMLGetContent();" ><?php echo language('courier/courier/courier','tDetailLogin')?></label>
    ...
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6  text-right">
        <button type="button" onclick="JSxCMLGetContent();" class="btn" style="background-color: #D4D4D4; color: #000000;">
            ...
            <?php if($aAlwEventCURL['tAutStaFull'] == 1 || ($aAlwEventCURL['tAutStaAdd'] == 1 || $aAlwEventCURL['tAutStaEdit'] == 1)) : ?>
                <button type="submit" class="btn xCNBTNSubSave" id="obtGpShopBySHPSave" onclick="JSxCMLSaveAddEdit('<?=$tRoute?>')"> <?php echo  language('common/main/main', 'tSave')?></button>
            <?php endif; ?>
        </div>
    </div>
    </div>

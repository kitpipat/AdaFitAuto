    ...
    public function FSaMCstGrpList($ptAPIReq, $ptMethodReq, $paData){
        ...
        $tSQL       = "SELECT c.* FROM(
                       ...
                       (SELECT DISTINCT
                                ...
                                CstGrp.FTCgpCode   AS rtCstGrpCode,
                                CstGrp.FTAgnCode   AS rtCstAgnCode,
                                CstGrpL.FTCgpName  AS rtCstGrpName,
                                CstGrp.FDCreateOn
                        FROM [TCNMCstGrp] CstGrp
                        LEFT JOIN [TCNMCstGrp_L] CstGrpL ON CstGrpL.FTCgpCode = CstGrp.FTCgpCode AND CstGrpL.FNLngID = ".$this->db->escape($nLngID)."
                        --LEFT JOIN [TCNMCst] CstM ON CstM.FTCgpCode = CstGrp.FTCgpCode
        ...
        if ($tSearchList != ''){
            ...
            $tSQL .= " AND CstGrp.FTCgpCode COLLATE THAI_BIN LIKE '%".$this->db->escape_like_str($tSearchList)."%'  OR CstGrpL.FTCgpName COLLATE THAI_BIN LIKE '%".$this->db->escape_like_str($tSearchList)."%'";
        }
        if ($tSesAgnCode != '') {

<?php 
    ...
    $tCstCrBuffer           = empty($aResult['raCredit']['rtCstCrBuffer']) ? "" : $aResult['raCredit']['rtCstCrBuffer'];
    if(!empty($tCstCrLimit) && !empty($tCstCrBuffer)){
        $tCstCrBufferCal    = (floatval($tCstCrLimit) * floatval($tCstCrBuffer) ) / 100;
    }else{
        $tCstCrBufferCal    = 0;
    }
    $tCstCrBalExt           = empty($aResult['raCredit']['rtCstCrBalExt']) ? "" : $aResult['raCredit']['rtCstCrBalExt'];
?>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="row">
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="form-group xMemBorderPoint" align="center">
                            <label class="xCNLabelFrm">
                                <?php echo language('customer/customer/customer','tCSTCreditLimit');?>
                            </label>
                            <br>
                            <?=@number_format($tCstCrLimit,2);?>
                            <br>
                            <label class="xCNLabelFrm"><?php echo language('customer/customer/customer','tCstBath');?></label>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="form-group xMemBorderPoint" align="center">
                            <label class="xCNLabelFrm">
                                <?php echo language('customer/customer/customer','tCstCrBuffer1').' % '.language('customer/customer/customer','tCstCrBuffer2');?>
                            </label>
                            <br>
                            <?=@number_format($tCstCrBuffer,2);?>
                            <br>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="form-group xMemBorderPoint" align="center">
                            <label class="xCNLabelFrm">
                                <?php echo language('customer/customer/customer','tCstCrBufferCalc');?>
                            </label>
                            <br>
                            <?=@number_format($tCstCrBufferCal,2);?>
                            <br>
                            <label class="xCNLabelFrm"><?php echo language('customer/customer/customer','tCstBath');?></label>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="form-group xMemBorderPoint" align="center">
                            <label class="xCNLabelFrm">
                                <?php echo language('customer/customer/customer','tCstCrBalExt');?>
                            </label>
                            <br>
                            <?=@number_format($tCstCrBalExt,2);?>
                            <br>
                            <label class="xCNLabelFrm"><?php echo language('customer/customer/customer','tCstBath');?></label>
                        </div>
                    </div>

                ...
                <div class="row">
                    ...
                    <div  class="form-group">
                        <label class="xCNLabelFrm"><?php echo language('customer/customer/customer','tCstAddV2Desc1')?></label>
                            <div class="form-group">
                            <textarea class="form-control " rows="4" maxlength="255" id="oetCstAddAddress1" name="oetCstAddAddress1"><?php echo $tFTAddV2Desc1; ?></textarea>
                        </div>
                    </div>
                    <!-- end Address1 -->
                    ...
                    <div  class="form-group">
                        ...
                        <div class="form-group">
                        <textarea class="form-control " rows="4" maxlength="255" id="oetCstAddAddress2" name="oetCstAddAddress2"><?php echo $tFTAddV2Desc2; ; ?></textarea>
                        </div>
                    </div>
                    <!-- end Address2 -->
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <!-- end GrpType -->
                            ...
                            <div class="form-group">
                                <label class="xCNLabelFrm"><span hidden style = "color:red">*</span> <?php echo language('customer/customer/customer','tCSTAreCode');?></label>
                            ...
                            <div class="form-group">
                                <label class="xCNLabelFrm"><span hidden style = "color:red">*</span> <?php echo language('customer/customer/customer','tCSTZneCode');?></label>
                                <div class="input-group">

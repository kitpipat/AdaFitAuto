                        ...
                        <div class="demo-button xCNBtngroup" style="width:100%;">
                            ...
                            <div id="odvBtnAddEdit">
                                ...
                                <div class="btn-group xWBtnSave">
                                    <button type="submit" class="btn xWBtnGrpSaveLeft" onclick="JSxCheckCustomerValidateForm()"> <?= language('common/main/main', 'tSave') ?></button>
                                    <?= $vBtnSave ?>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
                <div id="odvCstBtnGroup" class="demo-button xCNBtngroup" style="width:100%;">
                    ...
                    <button type="button" class="btn xCNBTNPrimery xWBtnGrpSaveLeft" onclick="JSxCheckCustomerValidateForm()"><?php echo language('common/main/main', 'tSave') ?></button>
                </div>
            </div>
        </div>
    </div>

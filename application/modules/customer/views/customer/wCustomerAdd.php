        ...
        <div class="col-xl-12 col-lg-12 col-md-12" id="odvContentContainer">
            ...
            <div class="row xWActionSubMenu hidden">
                <div id="odvActionSubMenu" class="col-xl-12 col-lg-12">
                    <button class="btn pull-right xCNBTNSubSave" id="obtSubSave" type="button"><?php echo language('common/main/main','tSave')?></button>
...
<script type="text/javascript">
    ...
    //Event Click Tab Main Or Sub Contril Button Add

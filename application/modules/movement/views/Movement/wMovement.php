	...
	<div class="xCNMrgNavMenu">
		<div class="row xCNavRow" style="width:inherit;">
			...
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right p-r-10">
				<button type="button" id="obtSubmitMmtExpExcel" class="btn xCNBTNDefult xCNBTNDefult2Btn" onclick="JSvMevementExpExcel()">
					<?= language('movement/movement/movement', 'tMMTExportExcel') ?>
				</button>
			</div>
		</div>
	</div>

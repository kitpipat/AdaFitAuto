<?php
    $tBchBrowseInputClass = 'col-lg-3 col-sm-3 col-md-3 col-xs-12';
    $tInvBrowseInputClass = 'col-lg-3 col-sm-3 col-md-3 col-xs-12';
    $tWahBrowseInputClass = 'col-lg-3 col-sm-3 col-md-3 col-xs-12';
?>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-7" >
                                    <div class="row">
                                        ...
                                        <div class="<?= $tInvBrowseInputClass ?>">
                                            <div class="form-group">
                                                <label class="xCNLabelFrm"><?= language('movement/movement/movement', 'tINVStockBooking') ?></label>
                                                <select class="selectpicker form-control" id="ocmMMTStaBooking" name="ocmMMTStaBooking" maxlength="1">
                                                    <option value="1" selected><?=language('movement/movement/movement', 'tMMTMovementBookingAll')?></option>
                                                    <option value="2"><?=language('movement/movement/movement', 'tMMTMovementHaveBooking')?></option>
                                                </select>
                                            </div>
                                        </div>

                        ...
                        <?php  if($aDataList['rtCode'] == 1 ):?>
                            <?php foreach($aDataList['raItems'] AS $key=>$aValue){ 
                                ...
                                <tr class="xCNTextDetail2 otrReason" >
                                    ...
                                    <td nowrap class="text-left" style="<?=$tClassLineBottom?>border-left: hidden !important;"><?=$aDataColSiz['FTSeaChainName']?></td>
                                ...
                                <?php 
                                    ...
                                    if($aValue['LastBchRowID']==$aValue['RowNumber']){ ?>
                                        <tr class="xCNTextDetail2 otrReason"  >
                                        <td nowrap class="text-left" style="border-top: 1px solid #dee2e6 !important;border-bottom: 1px solid #dee2e6 !important" colspan="3"><?=language('movement/movement/movement','tINVInventoryTotal')?></td>
                                        <td nowrap class="text-right" style="border-top: 1px solid #dee2e6 !important;border-bottom: 1px solid #dee2e6 !important"  colspan="2"><?php echo number_format($aValue['SumQtyBal'], $nOptDecimalShow);?></td>
                                        <td nowrap class="text-right" style="border-left: hidden !important;border-top: 1px solid #dee2e6 !important;border-bottom: 1px solid #dee2e6 !important"><?php echo number_format($aValue['SumStBalIntPdt'], $nOptDecimalShow);?></td>
                                        <td nowrap class="text-right" style="border-left: hidden !important;border-top: 1px solid #dee2e6 !important;border-bottom: 1px solid #dee2e6 !important"><?php echo number_format($aValue['SumQtyPdtBal'], $nOptDecimalShow);?></td>
                                    </tr>
                                 <?php   }
                                    ?>

					...
					?>
						...
						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-6"  >
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control xCNDatePicker xCNInputMaskDate" placeholder="YYYY-MM-DD" id="oetMNTDocDateFrom" name="oetMNTDocDateFrom" value="" data-validate-required="<?= language('document/quotation/quotation', 'tTQPlsEnterDocDate'); ?>">
									<span class="input-group-btn">
						...
						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-6"  >
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control xCNDatePicker xCNInputMaskDate"  placeholder="YYYY-MM-DD" id="oetMNTDocDateTo" name="oetMNTDocDateTo" value="" data-validate-required="<?= language('document/quotation/quotation', 'tTQPlsEnterDocDate'); ?>">
									<span class="input-group-btn">
						...
						<div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
							<!-- ประเภทการแจ้งเตือน -->
							<div class="form-group">
								<label class="xCNLabelFrm"><?= language('checkdocument/checkdocument', 'ประเภทการแจ้งเตือน'); ?></label>
								<select class="selectpicker form-control" id="ocmMNTTypeNoti" name="ocmMNTTypeNoti" maxlength="1" >
									<option value="" ><?= language('checkdocument/checkdocument', 'tChkDocTypeAll'); ?></option>
									<option value="2" ><?= language('checkdocument/checkdocument', 'อนุมัติแล้ว'); ?></option>
									<option value="1" ><?= language('checkdocument/checkdocument', 'ค้างอนุมัติ'); ?></option>
								</select>
							</div>
						</div>
						<div class="col-lg-2 col-xs-12 col-sm-6 col-md-3 xPaddingTop25" >
							<button class="btn xCNBTNDefult xCNBTNDefult2Btn" style="width:45%" type="button" onclick="JSxMNTClearConditionAll()"> <?= language('checkdocument/checkdocument','tChkDocBtnClear')?></button>
							<button id="obtMainAdjustProductFilter" type="button"  style="width:45%" class="btn btn xCNBTNPrimery xCNBTNPrimery2Btn"> <?= language('checkdocument/checkdocument','tChkDocBtnSubmit')?></button>
						</div>
					</div>

...
if($aResult['rtCode'] == "1"){
    ...
    $tAgnCstCode        = $aResult['raItems']['FTCstCode'];
    $tAgnCstName        = $aResult['raItems']['FTCstName'];
    ...
    $tAgnFranchise  =   $aResult['raItems']['FTAgnType'];
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label class="xCNLabelFrm"><?php echo language('company/company/company','tCMPAgnFranchise');?></label>
                                            <div class="dropdown bootstrap-select form-control xCNComboSelect">
                                                <select class="selectpicker form-control xCNComboSelect" id="ocmCmpAgnFra" name="ocmCmpAgnFra" tabindex="-98">
                                                    <option value="1" <?=($tAgnFranchise == '1')?'selected':''?>><?=language('company/company/company', 'tCMPAgnOption');?> </option>
                                                    <option value="2" <?=($tAgnFranchise == '2')?'selected':''?> ><?=language('company/company/company', 'tCMPFranchiseOption');?> </option>
                                                </select>
                                            </div>
                                        </div>

                                        <div class="form-group" id="odvCstBrowse">
                                            <label class="xCNLabelFrm"><span style="color:red">*</span><?php echo  language('document/saleorder/saleorder','tSOCstCCName'); ?></label>
                                            <div class="input-group">
                                                <input type="hidden" class="form-control xCNHide" id="ohdAgnFrmCstCodeOld" name="ohdAgnFrmCstCodeOld" value="<?php echo $tAgnCstCode ?>">
                                                <input type="text" class="form-control xCNHide" id="oetAgnFrmCstCode" name="oetAgnFrmCstCode" value="<?php echo $tAgnCstCode ?>">
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    id="oetAgnFrmCstName"
                                                    name="oetAgnFrmCstName"
                                                    value="<?php echo $tAgnCstName ?>"
                                                    placeholder="<?php echo language('document/saleorder/saleorder','tSOCstCode') ?>"
                                                    readonly
                                                >
                                                <span class="input-group-btn">
                                                    <button id="obtAgnBrowseCustomer" type="button" class="btn xCNBtnBrowseAddOn">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control xCNHide" id="oetAGNPplRetCode" name="oetAGNPplRetCode" placeholder="<?=language('customer/customer/customer','tCSTPplRet');?>" value="<?php echo $tAgnPplCode; ?>">
                                                <input type="text" class="form-control xWPointerEventNone" id="oetAGNPplRetName" name="oetAGNPplRetName" placeholder="<?=language('customer/customer/customer','tCSTPplRet');?>" value="<?php echo $tAgnPplName; ?>" readonly>
                                                <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control xCNHide" id="oetAgnChanelCode" name="oetAgnChanelCode" placeholder="<?=language('pos/poschannel/poschannel', 'tCHNLabelTitle');?>" value="<?php echo $tChnCode; ?>">
                                                <input type="text" class="form-control xWPointerEventNone" id="oetAgnChanelName" name="oetAgnChanelName" placeholder="<?=language('pos/poschannel/poschannel', 'tCHNLabelTitle');?>" value="<?php echo $tChnName; ?>" readonly>
                                                <span class="input-group-btn">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="<?=language('company/company/company','tCMPVatRate');?>"
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            type="text"
                                                            placeholder="<?=language('company/company/company','tCMPCurrency');?>"
                                                            class="form-control xWPointerEventNone"
...
<script type="text/javascript">
    ...
    // BrowseCustomer
    $('#obtAgnBrowseCustomer').click(function(e) {
        e.preventDefault();
        var nStaSession = JCNxFuncChkSessionExpired();
        if (typeof(nStaSession) !== 'undefined' && nStaSession == 1) {
            JSxCheckPinMenuClose();
            window.oPdtBrowseAgencyOption = oBrowseCst({
                'tReturnInputCode': 'oetAgnFrmCstCode',
                'tReturnInputName': 'oetAgnFrmCstName',
            });
    ...
    //Option Customer
    var oBrowseCst  = function(poReturnInput) {
        var tInputReturnCode = poReturnInput.tReturnInputCode;
        var tInputReturnName = poReturnInput.tReturnInputName;
        var oOptionReturn = {
            Title: ['document/saleorder/saleorder', 'tSOCstCode'],
            Table: {
                Master: 'TCNMCst',
                PK: 'FTCstCode'
            },
            ...
            // Where: {
            //     Condition: [
            //         "AND ISNULL(TCNMCst.FTCstStaFC,'') != 1"
            //     ]
            // },
            GrideView: {
                ColumnPathLang: 'document/saleorder/saleorder',
                ColumnKeyLang: ['tSOLabelFrmCstHNNumber', 'tSOLabelFrmCstName'],
                ColumnsSize: ['15%', '85%'],
                WidthModal: 50,
                DataColumns: ['TCNMCst.FTCstCode', 'TCNMCst_L.FTCstName', 'TCNMCst.FTCstStaFC'],
                DataColumnsFormat: ['', '', ''],
                DisabledColumns: [2],
                Perpage: 10,
    ...
    $("#odvCstBrowse").hide();
    var nAgnFra     = $("#ocmCmpAgnFra option:selected").val();
    var nAgnFraVal  = nAgnFra;
    ...
    $("#ocmCmpAgnFra").change(function(){
        var nAgnFraVal = $(this).val();
        if(nAgnFraVal == "1"){
            $("#odvCstBrowse").hide();
        }else{
            $("#odvCstBrowse").show();

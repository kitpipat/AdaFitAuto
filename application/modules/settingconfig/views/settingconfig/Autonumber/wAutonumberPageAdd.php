    ...
    <div class="col-lg-12" style="margin-bottom: 15px;">
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <label class="xCNLabelFrm" style="color: #1866ae !important; cursor:pointer;" onclick="JSvSettingNumberLoadViewSearch();">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="text-right">
                    ...
                    <button type="submit" class="btn xCNBTNSubSave" onclick="JSoEventSaveAutoNumber()">

...
class mSettingconfig extends CI_Model {
    ...
    public function FSaMSETConfigDataTableByType($paData,$ptType){
        ...
        if( $paData['tTypePage'] == "Agency" ){
            ...
            $tWhereTCNTConfigSpc .= " LEFT JOIN TCNTConfigSpc CSPC WITH(NOLOCK) ON 
                                        COM.FTSysCode = CSPC.FTSysCode AND 
                                        COM.FTSysSeq = CSPC.FTSysSeq AND 
                                        COM.FTSysApp = CSPC.FTSysApp  AND 
                                        COM.FTSysKey = CSPC.FTSysKey AND 
                                        COM.FTSysStaDataType = CSPC.FTSysStaDataType AND 
                                        CSPC.FTAgnCode = '$tAgnCode' ";
        }else{
            $tSelectFiled = "
    ...
    //อนุญาตให้จัดรูปแบบจากอะไรบ้างข้อมูล DT

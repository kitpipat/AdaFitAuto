                            ...
                            <tr class="text-center xCNTextDetail2 otrPdtPmo" id="otrPdtPmo<?=$nKey?>" data-code="<?=$aValue['rtPmoCode']?>" data-name="<?=$aValue['rtPmoName']?>">
                                ...
                                <td class="text-center">
                                  <label class="fancy-checkbox">
                                    ...
                                    data-checkrowid="<?php echo $aValue['rtPmoCode'].$aValue['rtAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                                ...
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtPmoCode'].$aValue['rtAgnCode']?>">
                                    <img id="oimDel<?php echo $aValue['rtPmoCode'].$aValue['rtAgnCode']; ?>" class="xCNIconTable <?php echo $tDisableImg; ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                                    onClick="JSoPdtPmoDel('<?=$nCurrentPage?>','<?=$aValue['rtPmoName']?>','<?php echo $aValue['rtPmoCode']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')" title="<?php echo language('pos/slipMessage/slipmessage', 'tSMGTBDelete'); ?>">
                                </td>
                                <?php endif; ?>
                                <?php if($aAlwEventPdtModel['tAutStaFull'] == 1 || ($aAlwEventPdtModel['tAutStaEdit'] == 1 || $aAlwEventPdtModel['tAutStaRead'] == 1)) : ?>
                                <td>

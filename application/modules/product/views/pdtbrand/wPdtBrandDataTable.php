                            ...
                            <tr class="text-center xCNTextDetail2 otrPdtPbn" id="otrPdtPbn<?=$nKey?>" data-code="<?=$aValue['rtPbnCode']?>" data-name="<?=$aValue['rtPbnName']?>">
                                ...
                                <td class="text-center">
                                  <label class="fancy-checkbox">
                                    ...
                                    data-checkrowid="<?php echo $aValue['rtPbnCode'].$aValue['rtAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                                ...
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtPbnCode'].$aValue['rtAgnCode']?>">
                                    <img id="oimDel<?php echo $aValue['rtPbnCode'].$aValue['rtAgnCode']; ?>" class="xCNIconTable <?php echo $tDisableImg; ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSoPdtPbnDel('<?= $nCurrentPage?>','<?=$aValue['rtPbnName']?>','<?= $aValue['rtPbnCode']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')" title="<?php echo language('pos/slipMessage/slipmessage', 'tSMGTBDelete'); ?>">
                                </td>
                                <?php endif; ?>
                                <?php if($aAlwEventPdtBrand['tAutStaFull'] == 1 || ($aAlwEventPdtBrand['tAutStaEdit'] == 1 || $aAlwEventPdtBrand['tAutStaRead'] == 1)) : ?>
                                <td>

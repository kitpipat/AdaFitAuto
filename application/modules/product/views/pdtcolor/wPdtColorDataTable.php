                            ...
                            <tr class="text-center xCNTextDetail2 otrPdtClr" id="otrPdtClr<?=$nKey?>" data-code="<?=$aValue['rtClrCode']?>" data-name="<?=$aValue['rtClrName']?>">
                                ...
                                <td class="text-center">
                                  <label class="fancy-checkbox">
                                    ...
                                    data-checkrowid="<?php echo $aValue['rtClrCode'].$aValue['rtAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                                ...
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtClrCode'].$aValue['rtAgnCode']?>">
                                    <img id="oimDel<?php echo $aValue['rtClrCode'].$aValue['rtAgnCode']; ?>"
                                    class="xCNIconTable <?php echo $tDisableImg; ?>"
                                     src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                                     onClick="JSoPdtClrDel('<?=$nCurrentPage?>','<?=$aValue['rtClrName']?>','<?php echo $aValue['rtClrCode']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')"

                    ...
                    <?php if($aDataList['rtCode'] == 1 ): ?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            ...
                            >
                                    ...
                                    <td class="text-center">
                                      <label class="fancy-checkbox">
                                        <input id="ocbListItem<?php echo $nKey; ?>" type="checkbox"
                                          ...
                                          data-checkrowid="<?php echo $aValue['FTTcgCode'].$aValue['FTAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                                ...
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['FTTcgCode'].$aValue['FTAgnCode']?>">
                                  <img id="oimDel<?php echo $aValue['FTTcgCode'].$aValue['FTAgnCode']; ?>"

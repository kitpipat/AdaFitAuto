                            ...
                            <tr class="text-center xCNTextDetail2 otrPdtPsz" id="otrPdtPsz<?=$nKey?>" data-code="<?=$aValue['rtPszCode']?>" data-name="<?=$aValue['rtPszName']?>">
                                ...
                                <td class="text-center">
                                  <label class="fancy-checkbox">
                                    ...
                                    data-checkrowid="<?php echo $aValue['rtPszCode'].$aValue['rtAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                                ...
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtPszCode'].$aValue['rtAgnCode']?>">
                                    <img id="oimDel<?php echo $aValue['rtPszCode'].$aValue['rtAgnCode']; ?>"
                                    class="xCNIconTable <?php echo $tDisableImg; ?>"
                                     src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                                     onClick="JSoPdtPszDel('<?=$nCurrentPage?>','<?=$aValue['rtPszName']?>','<?php echo $aValue['rtPszCode']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')"

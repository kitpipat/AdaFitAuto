                            ...
                            <tr class="text-center xCNTextDetail2 otrPdtType" id="otrPdtType<?=$nKey?>" data-code="<?=$aValue['rtPtyCode']?>" data-name="<?=$aValue['rtPtyName']?>">
                                ...
                                <td class="text-center">
                                  <label class="fancy-checkbox">
                                    ...
                                    data-checkrowid="<?php echo $aValue['rtPtyCode'].$aValue['rtAgnCode']?>" checked="false"  class="ocbListItem" name="ocbListItem[]">
                                ...
                                <td class="<?=$tDisableTD?>" id="otdDel<?php echo $aValue['rtPtyCode'].$aValue['rtAgnCode']?>">
                                    <img id="oimDel<?php echo $aValue['rtPtyCode'].$aValue['rtAgnCode']; ?>" class="xCNIconTable <?php echo $tDisableImg; ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>"
                                    onClick="JSoPdtTypeDel('<?=$nCurrentPage?>','<?php echo $aValue['rtPtyName']?>','<?php echo $aValue['rtPtyCode']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')" title="<?php echo language('pos/slipMessage/slipmessage', 'tSMGTBDelete'); ?>">
                                </td>
                                <?php endif; ?>
                                <?php if($aAlwEventPdtType['tAutStaFull'] == 1 || ($aAlwEventPdtType['tAutStaEdit'] == 1 || $aAlwEventPdtType['tAutStaRead'] == 1)) : ?>
                                <td>

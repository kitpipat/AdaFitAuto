        ...
        try{
            ...
            $tSQL       = "SELECT c.* FROM(
                                SELECT  ROW_NUMBER() OVER(ORDER BY FDCreateOn DESC , rtPtyCode DESC) AS rtRowID,* FROM
                                    ...
                                    LEFT JOIN [TCNMPdtType_L]  PTY_L ON PTY.FTPtyCode = PTY_L.FTPtyCode AND PTY_L.FNLngID = ".$this->db->escape($nLngID)."
            ...
            if(isset($tSearchList) && !empty($tSearchList)){
                $tSQL .= " AND (PTY.FTPtyCode COLLATE THAI_BIN LIKE '%".$this->db->escape_like_str($tSearchList)."%'";
                $tSQL .= " OR PTY_L.FTPtyName  COLLATE THAI_BIN LIKE '%".$this->db->escape_like_str($tSearchList)."%')";
            }

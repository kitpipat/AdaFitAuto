    ...
    public function FSaCPFHAddEditEvent(){
        try{
            ...
            $aDataMaster  = array(
                ...
                'FTDepCode'             => ($this->input->post('oetFhnPdtDepartCode') == '') ? '' : $this->input->post('oetFhnPdtDepartCode'),
                'FTClsCode'             => ($this->input->post('oetFhnPdtClassCode')  == '') ? '' : $this->input->post('oetFhnPdtClassCode'),
